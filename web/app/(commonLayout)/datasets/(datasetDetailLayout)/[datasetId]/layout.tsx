        ...
        <Tooltip
          ...
          popupContent={
            <div className="p-4 w-[240px] bg-components-panel-bg-blur border-[0.5px] border-components-panel-border rounded-xl">
              ...
              <div className="text-xs text-text-tertiary my-2">
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes) document.title = `${datasetRes.name || "Dataset"} - IDX`;
  }, [datasetRes]);
  ...
  return (
    <div className="grow flex overflow-hidden">
      ...
      >
        <div className="bg-background-default-subtle grow overflow-hidden">
          {children}
        </div>
      </DatasetDetailContext.Provider>
    </div>
