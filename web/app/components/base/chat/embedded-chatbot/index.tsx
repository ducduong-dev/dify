...
const Chatbot = () => {
  ...
  useEffect(() => {
    ...
    if (site) {
      ...
      else document.title = `${site.title} - Powered by IDX`;
    }
      ...
      <>
        ...
        {isMobile && (
          <div className={cn("relative")}>
            <div
              className={cn(
                "flex flex-col h-[calc(100vh_-_60px)] border-[0.5px] border-components-panel-border rounded-2xl shadow-xs"
              )}
            >
              <Loading type="app" />
            </div>
      ...
      >
        ...
        <div
          className={cn(
            ...
            isMobile && "!h-[calc(100vh_-_3rem)] bg-chatbot-bg rounded-2xl"
          )}
        >
      ...
      {isMobile && (
        <div className="shrink-0 h-[60px] pl-2 flex items-center">
          {!appData?.custom_config?.remove_webapp_brand && (
            <div className={cn("shrink-0 px-2 flex items-center gap-1.5")}>
