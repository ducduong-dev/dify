...
const NewFeaturePanel = ({
  ...
  return (
    <DialogWrapper show={show} onClose={onClose} inWorkflow={inWorkflow}>
      <div className="grow flex flex-col h-full">
        ...
        <div className="shrink-0 flex justify-between p-4 pb-3">
          ...
          <div className="w-8 h-8 p-2 cursor-pointer" onClick={onClose}>
          ...
          {showFileUpload && (
            <div className="relative mb-1 p-2 rounded-xl border border-components-panel-border shadow-xs">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(92deg, rgba(11, 165, 236, 0.25) 18.12%, rgba(255, 255, 255, 0.00) 167.31%)",
                }}
              ></div>
              <div className="relative flex items-start w-full h-full">
                ...
                <div className="p-1 text-text-primary system-xs-medium">
                  <span>
                    {isChatMode
                      ? t("workflow.common.fileUploadTip")
                      : t("workflow.common.ImageUploadLegacyTip")}
                  </span>
                  <a
                    className="text-text-accent"
                    href={`https://idx-solutions.com/${
                      locale === LanguagesSupported[1] ? "v/zh-hans/" : ""
                    }guides/workflow/bulletin`}
                    target="_blank"
