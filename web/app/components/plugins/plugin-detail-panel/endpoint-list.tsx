...
import { RiAddLine, RiApps2AddLine, RiBookOpenLine } from "@remixicon/react";
...
const EndpointList = ({ detail }: Props) => {
  ...
  const [
    isShowEndpointModal,
    { setTrue: showEndpointModal, setFalse: hideEndpointModal },
  ] = useBoolean(false);
  ...
  return (
    <div
      className={cn(
        "px-4 py-2 border-divider-subtle",
    ...
    >
          ...
          <Tooltip
            ...
            popupContent={
              <div className="flex flex-col gap-2">
                ...
                <a
                  href={`https://idx-solutions.com/${
                    locale === LanguagesSupported[1] ? "v/zh-hans/" : ""
                  }plugins/schema-definition/endpoint`}
                  target="_blank"
      ...
      {data.endpoints.length === 0 && (
        <div className="mb-1 p-3 flex justify-center rounded-[10px] bg-background-section text-text-tertiary system-xs-regular">
