      ...
      popupContent={
        <>
          <div className="flex items-center gap-1 self-stretch">
            <span className="flex flex-col justify-center items-start grow shrink-0 basis-0 text-text-secondary system-sm-semibold">
              {t(`${i18nPrefix}.title`)}
            </span>
            <a
              href="https://idx-solutions.com/plugins/quick-start/develop-plugins/debug-plugin"
              target="_blank"
              className="flex items-center gap-0.5 text-text-accent-light-mode-only cursor-pointer"
            >
