...
const PluginPage = ({ plugins, marketplace }: PluginPageProps) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
      className={cn(
        "grow relative flex flex-col overflow-y-auto border-t border-divider-subtle",
        activeTab === "plugins"
    ...
    >
      <div
        className={cn(
          "sticky top-0 flex min-h-[60px] px-12 pt-4 pb-2 items-center self-stretch gap-1 z-10 bg-components-panel-bg",
      ...
      {activeTab === "plugins" && (
        <>
          ...
          <div
            className={`flex py-4 justify-center items-center gap-2 ${
