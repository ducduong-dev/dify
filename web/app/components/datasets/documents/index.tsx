      ...
      <div className="flex flex-col justify-center gap-1 px-6 pt-4">
        ...
        <div className="flex items-center text-sm font-normal text-text-tertiary space-x-0.5">
          ...
          <a
            ...
            target="_blank"
            href="https://idx-solutions.com/guides/knowledge-base/integrate-knowledge-within-application"
          >
          ...
          <div className="flex gap-2 justify-center items-center !h-8">
            ...
            {embeddingAvailable && (
              ...
              >
                ...
                {(!dataset?.data_source_type || isDataSourceFile) &&
                  t("datasetDocuments.list.addFile")}
              </Button>
            )}
          </div>
