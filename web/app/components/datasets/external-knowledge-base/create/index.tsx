...
const ExternalKnowledgeBaseCreate: React.FC<
  ExternalKnowledgeBaseCreateProps
> = ({ onConnect, loading }) => {
        ...
        <div className="flex w-full max-w-[960px] px-14 py-0 flex-col items-center">
          <div className="flex w-full max-w-[640px] pt-6 pb-8 flex-col grow items-center gap-4">
            <div className="relative flex flex-col py-2 items-center gap-[2px] self-stretch">
              <div className="flex-grow text-text-primary system-xl-semibold self-stretch">
              ...
              <p className="text-text-tertiary system-sm-regular">
                ...
                <a
                  ...
                  href="https://idx-solutions.com/guides/knowledge-base/connect-external-knowledge"
                  target="_blank"
            ...
            <RetrievalSettings
              ...
              scoreThresholdEnabled={
                formData.external_retrieval_model.score_threshold_enabled
              }
              onChange={(data) =>
                handleFormChange({
                  ...formData,
            ...
            <div className="flex py-2 justify-end items-center gap-2 self-stretch">
              <Button variant="secondary" onClick={navBackHandle}>
                <div className="text-components-button-secondary-text system-sm-medium">
                  {t("dataset.externalKnowledgeForm.cancel")}
                </div>
              </Button>
              <Button
                variant="primary"
                ...
                loading={loading}
              >
                <div className="text-components-button-primary-text system-sm-medium">
