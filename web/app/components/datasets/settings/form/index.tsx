...
const Form = () => {
  ...
  const { modelList: rerankModelList } =
  ...
  const handleSave = async () => {
    ...
    if (retrievalConfig.weights) {
      retrievalConfig.weights.vector_setting.embedding_provider_name =
        currentDataset?.embedding_model_provider || "";
      retrievalConfig.weights.vector_setting.embedding_model_name =
        currentDataset?.embedding_model || "";
    }
    try {
      setLoading(true);
