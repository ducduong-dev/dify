...
const ChatVariablePanel = () => {
  ...
  const varList = useStore(
    (s) => s.conversationVariables
  ) as ConversationVariable[];
  ...
  const handleSave = useCallback(
    async (chatVar: ConversationVariable) => {
      ...
      // edit chatVar
      const newList = varList.map((v) =>
        v.id === currentVar.id ? chatVar : v
      );
      updateChatVarList(newList);
      ...
      {showTip && (
        <div className="shrink-0 px-3 pt-2.5 pb-2">
          <div className="relative p-3 radius-2xl bg-background-section-burn">
            <div className="inline-block py-[3px] px-[5px] rounded-[5px] border border-divider-deep text-text-tertiary system-2xs-medium-uppercase">
              TIPS
            </div>
              ...
              <a
                ...
                href={
                  locale !== LanguagesSupported[1]
                    ? "https://idx-solutions.com/guides/workflow/variables#conversation-variables"
                    : `https://idx-solutions.com/${locale.toLowerCase()}/guides/workflow/variables#hui-hua-bian-liang`
                }
              >
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col p-3 pb-4 bg-workflow-block-bg radius-lg border border-workflow-block-border shadow-md">
                ...
                <div className="text-text-secondary system-xs-semibold">
                  conversation_var
                </div>
              ...
              <div className="grow">
                <div className="mb-2 flex items-center gap-2 py-1">
                  <div className="shrink-0 flex items-center gap-1 w-16 h-3 px-1">
                    ...
                    <div className="shrink-0 text-text-tertiary system-2xs-medium">
                      WRITE
                    </div>
                  </div>
                  <BlockIcon className="shrink-0" type={BlockEnum.Assigner} />
                  <div className="grow text-text-secondary system-xs-semibold truncate">
