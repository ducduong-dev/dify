    ...
    >
      <div className="w-full mt-4 px-6 py-5 border-components-panel-border rounded-lg border-[0.5px]">
        <Tag
          bordered={true}
          hideBg={true}
          className="text-text-accent-secondary border-text-accent-secondary uppercase"
        >
        ...
        <div className="flex py-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-text-tertiary text-xs mt-1 mb-2">
            ...
            >
              <Button>
                <GithubIcon className="text-text-secondary mr-2" />
        ...
        <div className="flex py-4">
          ...
          <div className="flex flex-col w-full overflow-hidden">
            ...
            <pre className="overflow-x-scroll box-border py-3 px-4 bg-background-section text-xs font-medium rounded-lg select-text text-text-secondary border-[0.5px] border-components-panel-border">
              ...
              NEXT_PUBLIC_APP_KEY={"'<Web API Key From IDX>'"} <br />
            ...
            window.open(
              `https://idx-solutions.com/${
                locale !== LanguagesSupported[1]
                  ? "user-guide/launching-IDX-apps/developing-with-apis"
