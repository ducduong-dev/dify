      ...
      >
        ...
        <div className="pl-6 pt-5 pr-5 pb-3">
          <div className="flex items-center gap-1">
            <div className="grow text-text-primary title-2xl-semi-bold">
            ...
            <Link
              href={`${
                locale === LanguagesSupported[1]
                  ? "https://idx-solutions.com/zh-hans/guides/application-publishing/launch-your-webapp-quickly#she-zhi-ni-de-ai-zhan-dian"
                  : "https://idx-solutions.com/guides/application-publishing/launch-your-webapp-quickly#setting-up-your-ai-site"
              }`}
              target="_blank"
        ...
        <div className="px-6 py-3 space-y-5">
          ...
          <div className="flex gap-4">
            <div className="grow">
              <div
                className={cn(
                  "mb-1 py-1 text-text-secondary system-sm-semibold"
                )}
              >
            ...
            <AppIcon
              ...
              background={
                appIcon.type === "image" ? undefined : appIcon.background
              }
          ...
          <div className="relative">
            <div className={cn("py-1 text-text-secondary system-sm-semibold")}>
          ...
          {isChat && (
            <div className="w-full">
              <div className="flex justify-between items-center">
                <div
                  className={cn("py-1 text-text-secondary system-sm-semibold")}
                >
              ...
              <p className="pb-0.5 text-text-tertiary body-xs-regular">
          ...
          <div className="flex items-center">
            <div
              className={cn("grow py-1 text-text-secondary system-sm-semibold")}
            >
          ...
          <div className="w-full">
            <div className="flex justify-between items-center">
              ...
              <Switch
                disabled={
                  !(
                    appInfo.mode === "workflow" ||
                    appInfo.mode === "advanced-chat"
                  )
                }
          ...
          {systemFeatures.enable_web_sso_switch_component && (
            <>
              <Divider className="h-px my-0" />
              <div className="w-full">
                <p className="mb-1 system-xs-medium-uppercase text-text-tertiary">
                  {t(`${prefixSettings}.sso.label`)}
                </p>
                <div className="flex justify-between items-center">
                  <div
                    className={cn(
                      "py-1 text-text-secondary system-sm-semibold"
                    )}
                  >
                  ...
                  >
                    <Switch
                      disabled={
                        !systemFeatures.sso_enforced_for_web ||
                        !isCurrentWorkspaceEditor
                      }
                      defaultValue={
                        systemFeatures.sso_enforced_for_web &&
                        inputInfo.enable_sso
                      }
                      onChange={(v) =>
              ...
              <div className="w-full">
                <div className="flex items-center">
                  <div className="grow flex items-center">
                    <div
                      className={cn(
                        "mr-1 py-1 text-text-secondary system-sm-semibold"
                      )}
                    >
                ...
                <p className="pb-0.5 text-text-tertiary body-xs-regular">
                  {t(`${prefixSettings}.more.copyrightTip`)}
                </p>
                {inputInfo.copyrightSwitchValue && (
                  <Input
                    className="mt-2 h-10"
                  ...
                  <Trans
                    ...
                    components={{
                      privacyPolicyLink: (
                        <Link
                          href={
                            "https://idx-solutions.com/user-agreement/privacy-policy"
                          }
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-text-accent"
