  ...
  const onCreate = useCallback(async () => {
    ...
    try {
      const app = await createApp({
        ...
        icon_background:
          appIcon.type === "emoji" ? appIcon.background : undefined,
        mode: appMode,
      });
      ...
      <div className="flex justify-center h-full overflow-y-auto overflow-x-hidden">
        <div className="flex-1 shrink-0 flex justify-end">
          <div className="px-10">
            ...
            <div className="flex flex-col w-[660px] gap-4">
              <div>
                ...
                <div className="flex flex-row gap-2">
                  <AppTypeCard
                    ...
                    icon={
                      <div className="w-6 h-6 bg-components-icon-bg-blue-solid rounded-md flex items-center justify-center">
                  ...
                  <AppTypeCard
                    ...
                    icon={
                      <div className="w-6 h-6 bg-components-icon-bg-violet-solid rounded-md flex items-center justify-center">
                  ...
                  <AppTypeCard
                    ...
                    icon={
                      <div className="w-6 h-6 bg-components-icon-bg-teal-solid rounded-md flex items-center justify-center">
              ...
              <div>
                ...
                <div className="flex flex-row gap-2">
                  <AppTypeCard
                    ...
                    icon={
                      <div className="w-6 h-6 bg-components-icon-bg-blue-light-solid rounded-md flex items-center justify-center">
                  ...
                  <AppTypeCard
                    ...
                    icon={
                      <div className="w-6 h-6 bg-components-icon-bg-indigo-solid rounded-md flex items-center justify-center">
              ...
              <div className="flex space-x-3 items-center">
                ...
                <AppIcon
                  ...
                  icon={
                    appIcon.type === "emoji" ? appIcon.icon : appIcon.fileId
                  }
                  background={
                    appIcon.type === "emoji" ? appIcon.background : undefined
                  }
              ...
              <div>
                <div className="h-6 flex items-center mb-1">
                  ...
                  <span className="system-xs-regular text-text-tertiary ml-1">
            ...
            <div className="pt-5 pb-10 flex justify-between items-center">
              <div
                className="flex gap-1 items-center system-xs-regular text-text-tertiary cursor-pointer"
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <div className="flex gap-0.5">
                    <RiCommandLine
                      size={14}
                      className="p-0.5 system-kbd bg-components-kbd-bg-white rounded-sm"
                    />
                    <RiCornerDownLeftLine
                      size={14}
                      className="p-0.5 system-kbd bg-components-kbd-bg-white rounded-sm"
        ...
        <div className="flex-1 shrink h-full flex justify-start relative overflow-hidden">
          ...
          <div className="max-w-[760px] border-x border-x-divider-subtle">
            ...
            <div
              className="w-[664px] h-[448px] flex items-center justify-center"
              style={{
                background:
            ...
            >
              ...
              <AppScreenShot
                show={appMode === "advanced-chat"}
                mode="advanced-chat"
              />
              <AppScreenShot
                show={appMode === "agent-chat"}
                mode="agent-chat"
              />
              <AppScreenShot
                show={appMode === "completion"}
                mode="completion"
              />
...
const CreateAppModal = ({
  ...
  return (
    <FullScreenModal overflowVisible closable open={show} onClose={onClose}>
      <CreateApp
        onClose={onClose}
        onSuccess={onSuccess}
...
function AppTypeCard({
  ...
  return (
    <div
      className={cn(
        `w-[191px] h-[84px] p-3 border-[0.5px] relative box-content
      rounded-xl border-components-option-card-option-border
      bg-components-panel-on-panel-item-bg shadow-xs cursor-pointer hover:shadow-md`,
        active
    ...
    >
      ...
      border border-divider-deep system-2xs-medium-uppercase text-text-tertiary"
        >
          {t("common.menus.status")}
        </div>
      )}
      {icon}
      <div className="system-sm-semibold text-text-secondary mt-2 mb-0.5">
        {title}
      </div>
...
function AppPreview({ mode }: { mode: AppMode }) {
  ...
  const modeToPreviewInfoMap = {
    chat: {
      ...
      link: "https://idx-solutions.com/guides/application-orchestrate/conversation-application?fallback=true",
    },
    "advanced-chat": {
      title: t("app.types.advanced"),
      description: t("app.newApp.advancedUserDescription"),
      link: "https://idx-solutions.com/guides/workflow",
    },
    "agent-chat": {
      title: t("app.types.agent"),
      description: t("app.newApp.agentUserDescription"),
      link: "https://idx-solutions.com/guides/application-orchestrate/agent",
    },
    completion: {
      title: t("app.newApp.completeApp"),
    ...
    <div className="px-8 py-4">
      ...
      <div className="mt-1 system-xs-regular text-text-tertiary max-w-96 min-h-8">
        ...
        {previewInfo.link && (
          <Link
            target="_blank"
            href={previewInfo.link}
            className="text-text-accent ml-1"
          >
            {t("app.newApp.learnMore")}
          </Link>
        )}
      </div>
    </div>
...
function AppScreenShot({ mode, show }: { mode: AppMode; show: boolean }) {
  ...
  return (
    <picture>
      <source
        media="(resolution: 1x)"
        srcSet={`/screenshots/${theme}/${modeToImageMap[mode]}.png`}
      />
      <source
        media="(resolution: 2x)"
        srcSet={`/screenshots/${theme}/${modeToImageMap[mode]}@2x.png`}
      />
      <source
        media="(resolution: 3x)"
        srcSet={`/screenshots/${theme}/${modeToImageMap[mode]}@3x.png`}
      />
      <Image
