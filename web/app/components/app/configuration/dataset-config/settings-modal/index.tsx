...
const SettingsModal: FC<SettingsModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-6 pt-5 border-b border-divider-regular overflow-y-auto pb-[68px]">
        ...
        <div className={cn(rowClass)}>
          ...
          <div className="w-full">
            ...
            />
            <a
              className="mt-2 flex items-center h-[18px] px-3 text-xs text-text-tertiary"
        ...
        <div className={rowClass}>
          ...
          <div className="w-full">
            <PermissionSelector
              disabled={
                !localeCurrentDataset?.embedding_available ||
      ...
      {isRetrievalChanged && !isHideChangedTip && (
        <div className="absolute z-10 left-[30px] right-[30px] bottom-[76px] flex h-10 items-center px-3 rounded-lg border border-[#FEF0C7] bg-[#FFFAEB] shadow-lg justify-between">
          <div className="flex items-center">
            ...
            <div className="leading-[18px] text-xs font-medium text-gray-700">
      ...
      <div className="sticky z-[5] bottom-0 w-full flex justify-end py-4 px-6 border-t border-divider-regular bg-background-section">
