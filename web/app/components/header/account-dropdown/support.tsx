    ...
    <Menu as="div" className="relative w-full h-full">
      {({ open }) => (
        <>
          <Menu.Button
            className={cn(
              "flex items-center pl-3 pr-2 py-2 h-9 w-full group hover:bg-state-base-hover rounded-lg gap-1",
              open && "bg-state-base-hover"
            )}
          >
            <RiQuestionLine className="flex-shrink-0 size-4 text-text-tertiary" />
            <div className="flex-grow text-left system-md-regular text-text-secondary px-1">
                  ...
                  <Menu.Item>
                    {({ active }) => (
                      ...
                      >
                        ...
                        <div className="flex-grow system-md-regular text-text-secondary px-1">
