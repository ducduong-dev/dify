          ...
          <div className="pt-12 px-8 pb-7 flex flex-col items-center">
            ...
            <div className="system-sm-regular text-text-secondary">
              ...
              <span className="text-gradient font-semibold">
                {t("billing.plansCommon.freeTrialTip")}
              </span>
                ...
                options={[
                    ...
                    text: (
                      <div
                        className={classNames(
                          "inline-flex items-center system-md-semibold-uppercase text-text-secondary",
                          currentPlan === "cloud" &&
                            "text-text-accent-light-mode-only"
                        )}
                      >
                        <RiCloudFill className="size-4 mr-2" />
                  ...
                  },
                  {
                    ...
                    text: (
                      ...
                      >
                        <RiTerminalBoxFill className="size-4 mr-2" />
