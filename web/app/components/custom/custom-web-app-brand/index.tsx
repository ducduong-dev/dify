...
const CustomWebAppBrand = () => {
  ...
  return (
    <div className="py-4">
      ...
      <div
        className={cn(
          "flex items-center justify-between h-14 px-4 rounded-xl bg-background-section-burn",
        ...
        <div className="grow basis-1/2 h-[320px] flex bg-background-default-burn rounded-2xl border-[0.5px] border-components-panel-border-subtle overflow-hidden">
          <div className="shrink-0 h-full w-[232px] p-1 pr-0 flex flex-col">
            <div className="p-3 pr-2 flex items-center gap-3">
              <div
                className={cn(
                  "w-8 h-8 inline-flex items-center justify-center rounded-lg border border-divider-regular",
                  "bg-components-icon-bg-blue-light-solid"
                )}
              >
                <BubbleTextMod className="w-4 h-4 text-components-avatar-shape-fill-stop-100" />
              </div>
              <div className="grow system-md-semibold text-text-secondary">
                Chatflow App
              </div>
              <div className="p-1.5">
          ...
          <div className="grow flex flex-col justify-between w-[138px] p-2 pr-0">
            <div className="grow pt-16 pl-[22px] pb-4 flex flex-col justify-between bg-chatbot-bg rounded-l-2xl border-[0.5px] border-r-0 border-components-panel-border-subtle">
              <div className="w-[720px] px-4 py-3 bg-chat-bubble-bg rounded-2xl border border-divider-subtle">
                <div className="mb-1 text-text-primary body-md-regular">
              ...
              <div className="w-[578px] h-[52px] flex items-center pl-3.5 rounded-xl bg-components-panel-bg-blur backdrop-blur-sm border border-components-chat-input-border shadow-md text-text-placeholder body-lg-regular">
                Talk to IDX
              </div>
            </div>
          </div>
        ...
        <div className="grow basis-1/2 h-[320px] flex flex-col bg-background-default-burn rounded-2xl border-[0.5px] border-components-panel-border-subtle overflow-hidden">
          <div className="w-full p-4 pb-0 border-b-[0.5px] border-divider-subtle">
            ...
            <div className="flex items-center gap-4">
              <div className="shrink-0 h-10 flex items-center border-b-2 border-components-tab-active text-text-primary system-md-semibold-uppercase">
                RUN ONCE
              </div>
              <div className="grow h-10 flex items-center border-b-2 border-transparent text-text-tertiary system-md-semibold-uppercase">
                RUN BATCH
              </div>
            </div>
          </div>
