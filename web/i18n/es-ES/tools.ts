const translation = {
  ...
  customToolTip: "Aprende más sobre las herramientas personalizadas de IDX",
  type: {
    all: "Todas",
  ...
  contribute: {
    ...
    line2: "contribuir herramientas a IDX.",
  ...
  createTool: {
    ...
    nameForToolCallPlaceHolder:
      "Utilizado para el reconocimiento automático, como getCurrentWeather, list_pets",
    nameForToolCallTip: "Solo soporta números, letras y guiones bajos.",
    description: "Descripción",
    descriptionPlaceholder:
      "Breve descripción del propósito de la herramienta, por ejemplo, obtener la temperatura de una ubicación específica.",
    schema: "Esquema",
    ...
    authMethod: {
      ...
      keyTooltip:
        'Clave del encabezado HTTP, puedes dejarla como "Authorization" si no tienes idea de qué es o configurarla con un valor personalizado',
      types: {
        none: "Ninguno",
        api_key: "Clave API",
    ...
    toolInput: {
      ...
      methodSettingTip:
        "El usuario completa la configuración de la herramienta",
    ...
    customDisclaimerPlaceholder:
      "Por favor, ingresa el descargo de responsabilidad personalizado",
    ...
    deleteToolConfirmContent:
      "Eliminar la herramienta es irreversible. Los usuarios ya no podrán acceder a tu herramienta.",
  },
  test: {
    title: "Probar",
  ...
  noCustomTool: {
    ...
    content:
      "Agrega y administra tus herramientas personalizadas aquí para construir aplicaciones de inteligencia artificial.",
  ...
  toolNameUsageTip:
    "Nombre de llamada de la herramienta para razonamiento y promoción de agentes",
