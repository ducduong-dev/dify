const translation = {
  list: {
    title: "Documentos",
    desc: "Aquí se muestran todos los archivos del Conocimiento, y todo el Conocimiento se puede vincular a citas de IDX o indexarse a través del complemento de Chat.",
    ...
    empty: {
      ...
      sync: {
        tip: "IDX descargará periódicamente archivos desde tu Notion y completará el procesamiento.",
      },
    },
    delete: {
  ...
  embedding: {
    ...
    previewTip:
      "La vista previa del párrafo estará disponible después de que se complete la incrustación",
    pause: "Pausa",
    childMaxTokens: "Niño",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "La regeneración de fragmentos secundarios sobrescribirá los fragmentos secundarios actuales, incluidos los fragmentos editados y los fragmentos recién agregados. La regeneración no se puede deshacer.",
