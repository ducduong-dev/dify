const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Tu configuración de tokens máximos es alta, lo que puede limitar el espacio para indicaciones, consultas y datos. Considera configurarlo por debajo de 2/3.",
      setToCurrentModelMaxTokenTip:
        "Tokens máximos actualizados al 80% del máximo de tokens del modelo actual {{maxToken}}.",
      stop_sequences: "Secuencias de parada",
      stop_sequencesTip:
        "Hasta cuatro secuencias donde la API dejará de generar más tokens. El texto devuelto no contendrá la secuencia de parada.",
  ...
  menus: {
    ...
    plugins: "Plugins",
    pluginsTips:
      "Integrar plugins de terceros o crear Plugins AI compatibles con ChatGPT.",
    datasets: "Conocimiento",
    datasetsTips:
      "PRÓXIMAMENTE: Importa tus propios datos de texto o escribe datos en tiempo real a través de Webhook para la mejora del contexto LLM.",
    newApp: "Nueva App",
  ...
  account: {
    ...
    password: "Contraseña",
    passwordTip:
      "Puedes establecer una contraseña permanente si no deseas usar códigos de inicio de sesión temporales",
    ...
    langGeniusAccount: "Cuenta IDX",
    langGeniusAccountTip: "Tu cuenta IDX y los datos de usuario asociados.",
    editName: "Editar Nombre",
    showAppLength: "Mostrar {{length}} apps",
    delete: "Eliminar cuenta",
    deleteTip:
      "Eliminar tu cuenta borrará permanentemente todos tus datos y no se podrán recuperar.",
    deleteConfirmTip:
      "Para confirmar, por favor envía lo siguiente desde tu correo electrónico registrado a ",
    account: "Cuenta",
    myAccount: "Mi Cuenta",
    studio: "Estudio IDX",
    deletePrivacyLinkTip:
      "Para obtener más información sobre cómo manejamos sus datos, consulte nuestra",
    deletePrivacyLink: "Política de privacidad.",
    deleteSuccessTip:
      "Su cuenta necesita tiempo para terminar de eliminarse. Te enviaremos un correo electrónico cuando todo esté listo.",
  ...
  members: {
    ...
    admin: "Administrador",
    adminTip:
      "Puede crear aplicaciones y administrar configuraciones del equipo",
    normal: "Normal",
    ...
    inviteTeamMemberTip:
      "Pueden acceder a tus datos del equipo directamente después de iniciar sesión.",
    emailNotSetup:
      "El servidor de correo no está configurado, por lo que no se pueden enviar correos de invitación. En su lugar, notifique a los usuarios el enlace de invitación que se emitirá después de la invitación.",
    email: "Correo electrónico",
    ...
    invitationSentTip:
      "Invitación enviada, y pueden iniciar sesión en IDX para acceder a tus datos del equipo.",
    invitationLink: "Enlace de invitación",
    failedInvitationEmails:
      "Los siguientes usuarios no fueron invitados exitosamente",
    ok: "OK",
  ...
  provider: {
    ...
    azure: {
      apiBase: "Base API",
      apiBasePlaceholder:
        "La URL base de la API de tu Endpoint de Azure OpenAI.",
      apiKey: "Clave API",
    ...
    openaiHosted: {
      ...
      desc: "El servicio de hospedaje OpenAI proporcionado por IDX te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.",
    ...
    anthropicHosted: {
      ...
      close: "Cerrar",
      trialQuotaTip:
        "Su cuota de prueba antrópica caducará el 11/03/2025 y ya no estará disponible a partir de entonces. Por favor, aprovéchelo a tiempo.",
    },
    anthropic: {
      using: "La capacidad de incrustación está usando",
      enableTip:
        "Para habilitar el modelo de Anthropíc, primero necesitas vincularte al Servicio OpenAI o Azure OpenAI.",
  ...
  modelProvider: {
    notConfigured:
      "El modelo del sistema aún no ha sido completamente configurado, y algunas funciones pueden no estar disponibles.",
    systemModelSettings: "Configuraciones del Modelo del Sistema",
    systemModelSettingsLink:
      "¿Por qué es necesario configurar un modelo del sistema?",
    ...
    item: {
      deleteDesc:
        "{{modelName}} se está utilizando como modelo de razonamiento del sistema. Algunas funciones no estarán disponibles después de la eliminación. Por favor confirma.",
    ...
    loadBalancingDescription:
      "Reduce la presión con múltiples conjuntos de credenciales.",
    ...
    providerManagedDescription:
      "Usa el único conjunto de credenciales proporcionado por el proveedor del modelo.",
    defaultConfig: "Configuración Predeterminada",
    apiKeyStatusNormal: "El estado de la CLAVE API es normal",
    apiKeyRateLimit:
      "Se alcanzó el límite de velocidad, disponible después de {{seconds}}s",
    addConfig: "Agregar Configuración",
    editConfig: "Editar Configuración",
    loadBalancingLeastKeyWarning:
      "Para habilitar el balanceo de carga se deben habilitar al menos 2 claves.",
    loadBalancingInfo:
      "Por defecto, el balanceo de carga usa la estrategia Round-robin. Si se activa el límite de velocidad, se aplicará un período de enfriamiento de 1 minuto.",
    upgradeForLoadBalancing:
      "Actualiza tu plan para habilitar el Balanceo de Carga.",
    configureTip:
      "Configurar la clave de API o agregar el modelo que se va a usar",
  ...
  plugin: {
    serpapi: {
      ...
      keyFrom:
        "Obtén tu clave API de SerpAPI en la página de cuenta de SerpAPI",
    },
  },
  apiBasedExtension: {
    title:
      "Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de IDX.",
    link: "Aprende cómo desarrollar tu propia Extensión API.",
    linkUrl: "https://idx-solutions.com/features/extension/api_based_extension",
    ...
    modal: {
      ...
      apiKey: {
        ...
        lengthError:
          "La longitud de la clave API no puede ser menor a 5 caracteres",
      },
    },
    type: "Tipo",
  },
  about: {
    ...
    nowAvailable: "IDX {{version}} ya está disponible.",
    latestAvailable: "IDX {{version}} es la última versión disponible.",
  },
  appMenus: {
    overview: "Monitoreo",
    promptEng: "Orquestar",
  ...
  datasetMenus: {
    ...
    settings: "Configuraciones",
    emptyTip:
      "El Conocimiento no ha sido asociado, por favor ve a la aplicación o plugin para completar la asociación.",
  ...
  chat: {
    ...
    conversationNamePlaceholder:
      "Por favor ingresa el nombre de la conversación",
  ...
  promptEditor: {
    placeholder:
      "Escribe tu palabra de indicación aquí, ingresa '{' para insertar una variable, ingresa '/' para insertar un bloque de contenido de indicación",
    context: {
      item: {
        title: "Contexto",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Lectura de imagen fallida, por favor intenta nuevamente.",
    uploadFromComputerUploadError:
      "Carga de imagen fallida, por favor carga nuevamente.",
    uploadFromComputerLimit:
      "Las imágenes cargadas no pueden exceder {{size}} MB",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "Error en la lectura del archivo, inténtelo de nuevo.",
    uploadFromComputerUploadError:
      "Error en la carga del archivo, vuelva a cargarlo.",
