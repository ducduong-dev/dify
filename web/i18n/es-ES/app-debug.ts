const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "Has cambiado a Modo Experto, y una vez que modifiques la INDICACIÓN, NO PODRÁS regresar al modo básico.",
    ...
    contextMissing:
      "Componente de contexto faltante, la efectividad de la indicación puede no ser buena.",
  },
  operation: {
  ...
  notSetAPIKey: {
    ...
    description:
      "La clave del proveedor LLM no se ha establecido, y debe configurarse antes de depurar.",
  ...
  feature: {
    groupChat: {
      title: "Mejorar chat",
      description:
        "Agregar configuraciones previas a la conversación en aplicaciones puede mejorar la experiencia del usuario.",
    },
    groupExperience: {
    ...
    conversationOpener: {
      ...
      description:
        "En una aplicación de chat, la primera oración que la IA dice al usuario suele usarse como bienvenida.",
    },
    suggestedQuestionsAfterAnswer: {
      title: "Seguimiento",
      description:
        "Configurar sugerencias de próximas preguntas puede proporcionar una mejor conversación.",
    ...
    moreLikeThis: {
      title: "Más como esto",
      description:
        "Genera múltiples textos a la vez, luego edítalos y continúa generando",
    ...
    citation: {
      ...
      description:
        "Una vez habilitado, muestra el documento fuente y la sección atribuida del contenido generado.",
      resDes: "Citas y Atribuciones habilitadas",
    },
    annotation: {
      title: "Respuesta de Anotación",
      description:
        "Puedes agregar manualmente una respuesta de alta calidad a la caché para una coincidencia prioritaria con preguntas similares de los usuarios.",
      resDes: "Respuesta de Anotación habilitada",
      scoreThreshold: {
        title: "Umbral de Puntuación",
        description:
          "Usado para establecer el umbral de similitud para la respuesta de anotación.",
    ...
    dataSet: {
      ...
      queryVariable: {
        ...
        unableToQueryDataSetTip:
          "No se puede consultar el Conocimiento con éxito, por favor elige una variable de consulta de contexto en la sección de contexto.",
        ok: "OK",
        contextVarNotEmpty:
          "La variable de consulta de contexto no puede estar vacía",
        deleteContextVarTitle: '¿Eliminar variable "{{varName}}"?',
        deleteContextVarTip:
          "Esta variable ha sido establecida como una variable de consulta de contexto, y eliminarla afectará el uso normal del Conocimiento. Si aún necesitas eliminarla, por favor vuelve a seleccionarla en la sección de contexto.",
      },
    },
    tools: {
      title: "Herramientas",
    ...
    conversationHistory: {
      ...
      description:
        "Establecer nombres de prefijo para los roles de conversación",
    ...
    moderation: {
      ...
      description:
        "Asegura la salida del modelo utilizando API de moderación o manteniendo una lista de palabras sensibles.",
      ...
      modal: {
        ...
        provider: {
          ...
          openaiTip: {
            prefix:
              "La Moderación de OpenAI requiere una clave API de OpenAI configurada en la ",
            suffix: ".",
          },
        ...
        content: {
          ...
          condition:
            "Moderar Contenido de ENTRADA y SALIDA habilitado al menos uno",
  ...
  automatic: {
    ...
    description:
      "Describe tu escenario, IDX orquestará una aplicación para ti.",
    ...
    solveProblemPlaceHolder:
      "p.ej. Extraer ideas y resumir información de informes y artículos largos",
    generate: "Generar",
    ...
    noData:
      "Describe tu caso de uso a la izquierda, la vista previa de la orquestación se mostrará aquí.",
    loading: "Orquestando la aplicación para ti...",
    overwriteTitle: "¿Sobrescribir configuración existente?",
    overwriteMessage:
      "Aplicar esta orquestación sobrescribirá la configuración existente.",
  },
  resetConfig: {
    title: "¿Confirmar restablecimiento?",
    message:
      "Restablecer descarta cambios, restaurando la última configuración publicada.",
  },
  errorMessage: {
    ...
    waitForResponse:
      "Por favor espera la respuesta al mensaje anterior para completar.",
    waitForBatchResponse:
      "Por favor espera la respuesta a la tarea por lotes para completar.",
  ...
  promptTip:
    "Las indicaciones guían las respuestas de la IA con instrucciones y restricciones. Inserta variables como {{input}}. Esta indicación no será visible para los usuarios.",
  formattingChangedTitle: "Formato cambiado",
  formattingChangedText:
    "Modificar el formato restablecerá el área de depuración, ¿estás seguro?",
  variableTitle: "Variables",
  variableTip:
    "Los usuarios completan las variables en un formulario, reemplazando automáticamente las variables en la indicación.",
  notSetVar:
    'Las variables permiten a los usuarios introducir palabras de indicación u observaciones de apertura al completar formularios. Puedes intentar ingresar "{{input}}" en las palabras de indicación.',
  autoAddVar:
    "Variables no definidas referenciadas en la pre-indicación, ¿quieres agregarlas en el formulario de entrada del usuario?",
  variableTable: {
  ...
  varKeyError: {
    ...
    notValid:
      "{{key}} no es válida. Solo puede contener letras, números y guiones bajos",
  ...
  otherError: {
    ...
    historyNoBeEmpty:
      "El historial de conversaciones debe establecerse en la indicación",
  ...
  variableConfig: {
    ...
    number: "Número",
    notSet:
      "No configurado, intenta escribir {{input}} en la indicación de prefijo",
  ...
  vision: {
    name: "Visión",
    description:
      "Habilitar Visión permitirá al modelo recibir imágenes y responder preguntas sobre ellas.",
  ...
  openingStatement: {
    ...
    placeholder:
      "Escribe tu mensaje de apertura aquí, puedes usar variables, intenta escribir {{variable}}.",
    openingQuestion: "Preguntas de Apertura",
    noDataPlaceHolder:
      "Iniciar la conversación con el usuario puede ayudar a la IA a establecer una conexión más cercana con ellos en aplicaciones de conversación.",
    varTip: "Puedes usar variables, intenta escribir {{variable}}",
    tooShort:
      "Se requieren al menos 20 palabras en la indicación inicial para generar una apertura de conversación.",
    notIncludeKey:
      "La indicación inicial no incluye la variable: {{key}}. Por favor agrégala a la indicación inicial.",
  },
  modelConfig: {
    model: "Modelo",
  ...
  inputs: {
    ...
    noPrompt:
      "Intenta escribir alguna indicación en la entrada de pre-indicación",
    userInputField: "Campo de Entrada del Usuario",
    noVar:
      "Completa el valor de la variable, que se reemplazará automáticamente en la palabra de indicación cada vez que se inicie una nueva sesión.",
    chatVarTip:
      "Completa el valor de la variable, que se reemplazará automáticamente en la palabra de indicación cada vez que se inicie una nueva sesión",
    completionVarTip:
      "Completa el valor de la variable, que se reemplazará automáticamente en las palabras de indicación cada vez que se envíe una pregunta.",
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description:
        "Basado en la intención del usuario y las descripciones de Conocimiento, el Agente selecciona autónomamente el mejor Conocimiento para consultar. Ideal para aplicaciones con Conocimiento limitado y distintivo.",
    },
    retrieveMultiWay: {
      title: "Recuperación Multi-camino",
      description:
        "Basado en la intención del usuario, consulta a través de todo el Conocimiento, recupera texto relevante de múltiples fuentes y selecciona los mejores resultados que coinciden con la consulta del usuario después de reordenar. Se requiere configuración de la API del modelo de Reordenar.",
    },
    rerankModelRequired: "Se requiere modelo de Reordenar",
    params: "Parámetros",
    top_k: "Top K",
    top_kTip:
      "Usado para filtrar fragmentos que son más similares a las preguntas del usuario. El sistema también ajustará dinámicamente el valor de Top K, de acuerdo con los max_tokens del modelo seleccionado.",
    score_threshold: "Umbral de Puntuación",
    score_thresholdTip:
      "Usado para establecer el umbral de similitud para la filtración de fragmentos.",
    retrieveChangeTip:
      "Modificar el modo de índice y el modo de recuperación puede afectar las aplicaciones asociadas con este Conocimiento.",
  },
  ...
  assistantType: {
    ...
    chatAssistant: {
      ...
      description:
        "Construye un asistente basado en chat usando un Modelo de Lenguaje Grande",
    },
    agentAssistant: {
      name: "Asistente Agente",
      description:
        "Construye un Agente inteligente que puede elegir herramientas autónomamente para completar tareas",
    },
  },
  agent: {
    ...
    setting: {
      ...
      description:
        "Las configuraciones del Asistente Agente permiten establecer el modo del agente y funciones avanzadas como indicaciones integradas, disponibles solo en el tipo Agente.",
      maximumIterations: {
        name: "Iteraciones Máximas",
        description:
          "Limitar el número de iteraciones que un asistente agente puede ejecutar",
      },
    },
    ...
    tools: {
      name: "Herramientas",
      description:
        "El uso de herramientas puede extender las capacidades del LLM, como buscar en internet o realizar cálculos científicos",
      enabled: "Habilitado",
    },
  },
};
