const translation = {
  ...
  createDatasetIntro:
    "Importa tus propios datos de texto o escribe datos en tiempo real a través de Webhook para mejorar el contexto de LLM.",
  ...
  datasetUsedByApp:
    "El conocimiento está siendo utilizado por algunas aplicaciones. Las aplicaciones ya no podrán utilizar este Conocimiento y todas las configuraciones y registros de las sugerencias se eliminarán permanentemente.",
  datasetDeleted: "Conocimiento eliminado",
  datasetDeleteFailed: "Error al eliminar el Conocimiento",
  didYouKnow: "¿Sabías?",
  intro1: "El Conocimiento se puede integrar en la aplicación IDX ",
  ...
  unavailableTip:
    "El modelo de incrustación no está disponible, es necesario configurar el modelo de incrustación predeterminado",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "Genera incrustaciones de consulta y busca el fragmento de texto más similar a su representación vectorial.",
    },
    full_text_search: {
      title: "Búsqueda de Texto Completo",
      description:
        "Indexa todos los términos del documento, lo que permite a los usuarios buscar cualquier término y recuperar el fragmento de texto relevante que contiene esos términos.",
    },
    hybrid_search: {
      title: "Búsqueda Híbrida",
      description:
        "Ejecuta búsquedas de texto completo y búsquedas vectoriales simultáneamente, reordena para seleccionar la mejor coincidencia para la consulta del usuario. Es necesaria la configuración de las API del modelo de reordenamiento.",
      recommend: "Recomendar",
    },
    invertedIndex: {
      title: "Índice Invertido",
      description:
        "El Índice Invertido es una estructura utilizada para la recuperación eficiente. Organizado por términos, cada término apunta a documentos o páginas web que lo contienen.",
    },
    change: "Cambiar",
  ...
  mixtureHighQualityAndEconomicTip:
    "Se requiere el modelo de reclasificación para la mezcla de bases de conocimiento de alta calidad y económicas.",
  inconsistentEmbeddingModelTip:
    "Se requiere el modelo de reclasificación si los modelos de incrustación de las bases de conocimiento seleccionadas son inconsistentes.",
  retrievalSettings: "Configuración de recuperación",
  rerankSettings: "Configuración de reclasificación",
  weightedScore: {
    title: "Puntuación ponderada",
    description:
      "Al ajustar los pesos asignados, esta estrategia de reclasificación determina si se debe priorizar la coincidencia semántica o de palabras clave.",
  ...
  nTo1RetrievalLegacy:
    "La recuperación N-a-1 será oficialmente obsoleta a partir de septiembre. Se recomienda utilizar la última recuperación de múltiples rutas para obtener mejores resultados.",
  nTo1RetrievalLegacyLink: "Más información",
  nTo1RetrievalLegacyLinkText:
    "La recuperación N-a-1 será oficialmente obsoleta en septiembre.",
  defaultRetrievalTip:
    "De forma predeterminada, se utiliza la recuperación de varias rutas. El conocimiento se recupera de múltiples bases de conocimiento y luego se vuelve a clasificar.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "Para conectarse a una base de conocimientos externa, primero debe crear una API externa. Por favor, lea atentamente y consulte",
  ...
  connectHelper: {
    ...
    helper1:
      "Conéctese a bases de conocimiento externas a través de la API y el ID de la base de conocimiento. Actualmente,",
  ...
  externalKnowledgeDescriptionPlaceholder:
    "Describa lo que hay en esta base de conocimientos (opcional)",
  externalKnowledgeNamePlaceholder:
    "Introduzca el nombre de la base de conocimientos",
  noExternalKnowledge:
  ...
  allExternalTip:
    "Al usar solo conocimiento externo, el usuario puede elegir si desea habilitar el modelo Rerank. Si no se habilita, los fragmentos recuperados se ordenarán en función de las puntuaciones. Cuando las estrategias de recuperación de diferentes bases de conocimiento son inconsistentes, serán inexactas.",
  ...
  externalAPIPanelDescription:
    "La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de IDX y recuperar conocimiento de esa base de conocimiento.",
  ...
  learnHowToWriteGoodKnowledgeDescription:
    "Aprende a escribir una buena descripción del conocimiento",
  externalAPIPanelDocumentation:
    "Más información sobre cómo crear una API de conocimiento externo",
  mixtureInternalAndExternalTip:
    "El modelo de Rerank es necesario para la mezcla de conocimiento interno y externo.",
  chunkingMode: {
  ...
  enable: "Habilitar",
  documentsDisabled:
    "{{num}} Documentos desactivados - inactivos durante más de 30 días",
  preprocessDocument: "{{num}} Documentos de preprocesamiento",
  localDocs: "Documentos locales",
  allKnowledgeDescription:
    "Seleccione esta opción para mostrar todos los conocimientos de este espacio de trabajo. Solo el propietario del espacio de trabajo puede administrar todo el conocimiento.",
