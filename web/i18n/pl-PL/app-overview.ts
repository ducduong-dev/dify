const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "Lub wypróbuj wersję chmurową IDX z darmowym limitem",
  },
  overview: {
    title: "Przegląd",
    appInfo: {
      ...
      settings: {
        ...
        workflow: {
          ...
          showDesc:
            "Pokazywanie lub ukrywanie szczegółów przepływu pracy w aplikacji internetowej",
        },
        ...
        more: {
          ...
          customDisclaimerPlaceholder:
            "Wprowadź oświadczenie o ochronie danych",
          customDisclaimerTip:
            "Niestandardowy tekst oświadczenia będzie wyświetlany po stronie klienta, dostarczając dodatkowych informacji o aplikacji.",
          copyrightTip:
            "Wyświetlanie informacji o prawach autorskich w aplikacji internetowej",
          copyrightTooltip: "Uaktualnij do planu Professional lub wyższego",
        },
        sso: {
          tooltip:
            "Skontaktuj się z administratorem, aby włączyć logowanie jednokrotne w aplikacji internetowej",
          title: "Logowanie jednokrotne w aplikacji internetowej",
          label: "Uwierzytelnianie logowania jednokrotnego",
          description:
            "Wszyscy użytkownicy muszą zalogować się za pomocą logowania jednokrotnego przed użyciem aplikacji internetowej",
        },
      ...
      embedded: {
        ...
        chromePlugin: "Zainstaluj rozszerzenie Chrome IDX Chatbot",
        copied: "Skopiowane",
        copy: "Kopiuj",
      },
      qrcode: {
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Liczba dziennych rozmów z AI; inżynieria/debugowanie promptów wykluczone.",
    },
    activeUsers: {
