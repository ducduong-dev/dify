const translation = {
  ...
  account: {
    ...
    langGeniusAccountTip: "Twoje konto IDX i powiązane dane użytkownika.",
    ...
    deletePrivacyLinkTip:
      "Aby uzyskać więcej informacji o tym, jak postępujemy z Twoimi danymi, zapoznaj się z naszą",
    deletePrivacyLink: "Polityka prywatności.",
    deleteSuccessTip:
      "Twoje konto potrzebuje czasu na dokończenie usuwania. Wyślemy Ci wiadomość e-mail, gdy wszystko będzie gotowe.",
  ...
  members: {
    ...
    emailNotSetup:
      "Serwer poczty nie jest skonfigurowany, więc nie można wysyłać zaproszeń e-mail. Proszę powiadomić użytkowników o linku do zaproszenia, który zostanie wydany po zaproszeniu.",
    email: "Email",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Usługa hostowania OpenAI dostarczana przez IDX pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.",
    ...
    anthropicHosted: {
      ...
      close: "Zamknij",
      trialQuotaTip:
        "Twój limit próbny Anthropic wygaśnie w dniu 11.03.2025 i nie będzie już dostępny po tym czasie. Prosimy o skorzystanie z niego w odpowiednim czasie.",
    },
    anthropic: {
  ...
  modelProvider: {
    ...
    providerManagedDescription:
      "Użyj pojedynczego zestawu poświadczeń dostarczonych przez dostawcę modelu.",
    loadBalancingHeadline: "Równoważenie obciążenia",
    modelHasBeenDeprecated: "Ten model jest przestarzały",
    loadBalancingDescription:
      "Zmniejsz presję dzięki wielu zestawom poświadczeń.",
    providerManaged: "Zarządzany przez dostawcę",
    upgradeForLoadBalancing:
      "Uaktualnij swój plan, aby włączyć równoważenie obciążenia.",
    apiKeyStatusNormal: "Stan APIKey jest normalny",
    loadBalancingLeastKeyWarning:
      "Aby włączyć równoważenie obciążenia, muszą być włączone co najmniej 2 klucze.",
    loadBalancingInfo:
      "Domyślnie równoważenie obciążenia używa strategii działania okrężnego. Jeśli zostanie uruchomione ograniczenie szybkości, zostanie zastosowany 1-minutowy okres odnowienia.",
    ...
    configureTip:
      "Konfigurowanie klucza interfejsu API lub dodawanie modelu do użycia",
  ...
  dataSource: {
    ...
    website: {
      ...
      description:
        "Importuj zawartość ze stron internetowych za pomocą robota indeksującego.",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "Odczyt pliku nie powiódł się, spróbuj ponownie.",
