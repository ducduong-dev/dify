const translation = {
  ...
  forgotPasswordDesc:
    "Proszę podać swój adres e-mail, aby zresetować hasło. Wyślemy Ci e-mail z instrukcjami, jak zresetować hasło.",
  checkEmailForResetLink:
    "Proszę sprawdzić swój e-mail w poszukiwaniu linku do resetowania hasła. Jeśli nie pojawi się w ciągu kilku minut, sprawdź folder spam.",
  ...
  error: {
    ...
    registrationNotAllowed:
      "Nie znaleziono konta. Skontaktuj się z administratorem systemu, aby się zarejestrować.",
  },
  license: {
  ...
  resetPasswordDesc:
    "Wpisz adres e-mail, którego użyłeś do rejestracji w Dify, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.",
  or: "LUB",
  noLoginMethodTip:
    "Skontaktuj się z administratorem systemu, aby dodać metodę uwierzytelniania.",
  ...
  licenseExpiredTip:
    "Licencja IDX Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Dify.",
  licenseLostTip:
    "Nie udało się nawiązać połączenia z serwerem licencji Dify. Skontaktuj się z administratorem, aby kontynuować korzystanie z Dify.",
  licenseInactiveTip:
    "Licencja IDX Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Dify.",
};
