const translation = {
  ...
  form: {
    ...
    descPlaceholder:
      "Opisz, co znajduje się w tej Wiedzy. Szczegółowy opis pozwala sztucznej inteligencji na dostęp do treści Wiedzy w odpowiednim czasie. Jeśli jest pusty, IDX użyje domyślnej strategii trafień.",
    ...
    upgradeHighQualityTip:
      "Po uaktualnieniu do trybu wysokiej jakości powrót do trybu ekonomicznego nie jest dostępny",
    indexMethodChangeToEconomyDisabledTip:
      "Niedostępne w przypadku zmiany z HQ na ECO",
  },
};
