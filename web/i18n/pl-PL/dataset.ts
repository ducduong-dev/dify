const translation = {
  ...
  datasetUsedByApp:
    "Ta wiedza jest wykorzystywana przez niektóre aplikacje. Aplikacje nie będą już mogły korzystać z tej Wiedzy, a wszystkie konfiguracje podpowiedzi i logi zostaną trwale usunięte.",
  datasetDeleted: "Wiedza usunięta",
  datasetDeleteFailed: "Nie udało się usunąć Wiedzy",
  didYouKnow: "Czy wiedziałeś?",
  intro1: "Wiedzę można zintegrować z aplikacją IDX ",
  ...
  mixtureHighQualityAndEconomicTip:
    "Model ponownego rankingu jest wymagany dla mieszanki wysokiej jakości i ekonomicznych baz wiedzy.",
  inconsistentEmbeddingModelTip:
    "Model ponownego rankingu jest wymagany, jeśli modele osadzania wybranych baz wiedzy są niespójne.",
  retrievalSettings: "Ustawienia wyszukiwania",
  rerankSettings: "Ustawienia ponownego rankingu",
  weightedScore: {
    title: "Ważona ocena",
    description:
      "Poprzez dostosowanie przypisanych wag, ta strategia ponownego rankingu określa, czy priorytetowo traktować dopasowanie semantyczne czy słów kluczowych.",
  ...
  nTo1RetrievalLegacy:
    "Wyszukiwanie N-do-1 zostanie oficjalnie wycofane od września. Zaleca się korzystanie z najnowszego wyszukiwania wielościeżkowego, aby uzyskać lepsze wyniki.",
  nTo1RetrievalLegacyLink: "Dowiedz się więcej",
  nTo1RetrievalLegacyLinkText:
    "Wyszukiwanie N-do-1 zostanie oficjalnie wycofane we wrześniu.",
  defaultRetrievalTip:
    "Pobieranie wielu ścieżek jest używane domyślnie. Wiedza jest pobierana z wielu baz wiedzy, a następnie ponownie klasyfikowana.",
  ...
  connectDatasetIntro: {
    content: {
      front:
        "Aby nawiązać połączenie z zewnętrzną bazą wiedzy, należy najpierw utworzyć zewnętrzny interfejs API. Przeczytaj uważnie i zapoznaj się z",
  ...
  connectHelper: {
    helper1:
      "Połącz się z zewnętrznymi bazami wiedzy za pośrednictwem interfejsu API i identyfikatora bazy wiedzy. Obecnie",
  ...
  externalAPIForm: {
    encrypted: {
      ...
      front:
        "Twój token API zostanie zaszyfrowany i będzie przechowywany za pomocą",
    },
    edit: "Redagować",
    save: "Zapisać",
    name: "Nazwa",
  ...
  noExternalKnowledge:
    "Nie ma jeszcze interfejsu API wiedzy zewnętrznej, kliknij tutaj, aby utworzyć",
  ...
  externalKnowledgeDescriptionPlaceholder:
    "Opisz, co znajduje się w tej bazie wiedzy (opcjonalnie)",
  allExternalTip:
    "W przypadku korzystania tylko z wiedzy zewnętrznej użytkownik może zdecydować, czy chce włączyć model Rerank. Jeśli ta opcja nie jest włączona, pobrane fragmenty będą sortowane na podstawie wyników. Gdy strategie wyszukiwania z różnych baz wiedzy są niespójne, będzie to niedokładne.",
  editExternalAPIFormTitle: "Edytowanie interfejsu API wiedzy zewnętrznej",
  mixtureInternalAndExternalTip:
    "Model Rerank jest wymagany do połączenia wiedzy wewnętrznej i zewnętrznej.",
  externalAPI: "Zewnętrzny interfejs API",
  externalTag: "Zewnętrzny",
  learnHowToWriteGoodKnowledgeDescription:
    "Dowiedz się, jak napisać dobry opis wiedzy",
  externalKnowledgeNamePlaceholder: "Podaj nazwę bazy wiedzy",
  externalAPIPanelDescription:
    "Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza IDX i pobierania wiedzy z tej bazy wiedzy.",
  chunkingMode: {
  ...
  documentsDisabled:
    "{{num}} dokumenty wyłączone - nieaktywne przez ponad 30 dni",
  enable: "Umożliwiać",
  allKnowledge: "Cała wiedza",
  allKnowledgeDescription:
    "Wybierz tę opcję, aby wyświetlić całą wiedzę w tym obszarze roboczym. Tylko właściciel obszaru roboczego może zarządzać całą wiedzą.",
};
