const translation = {
  ...
  automatic: {
    ...
    description:
      "Opisz swój scenariusz, IDX zorkiestruje aplikację dla Ciebie.",
  ...
  varKeyError: {
    ...
    tooLong: "{{key}} za długi. Nie może być dłuższy niż 30 znaków",
    notValid:
      "{{key}} jest nieprawidłowy. Może zawierać tylko litery, cyfry i podkreślenia",
    notStartWithNumber: "{{key}} nie może zaczynać się od cyfry",
