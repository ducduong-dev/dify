const translation = {
  list: {
    title: "Dokumenty",
    desc: "Wszystkie pliki wiedzy są tutaj pokazane, a cała wiedza może być powiązana z odnośnikami IDX lub zindeksowana za pomocą wtyczki Chat.",
    addFile: "dodaj plik",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Ponowne wygenerowanie fragmentów podrzędnych spowoduje zastąpienie bieżących fragmentów podrzędnych, w tym fragmentów edytowanych i nowo dodanych fragmentów. Regeneracji nie można cofnąć.",
