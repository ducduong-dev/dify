const translation = {
  ...
  setAdminAccountDesc:
    "앱 생성 및 LLM 제공자 관리 등 최고 권한을 가진 관리자 계정 설정",
  ...
  rightDesc:
    "매력적이고 조작 가능하며 개선 가능한 AI 애플리케이션을 쉽게 구축하세요.",
  tos: "이용약관",
  pp: "개인정보 처리 방침",
  ...
  forgotPasswordDesc:
    "비밀번호를 재설정하려면 이메일 주소를 입력하세요. 비밀번호 재설정 방법에 대한 이메일을 보내드리겠습니다.",
  checkEmailForResetLink:
    "비밀번호 재설정 링크를 확인하려면 이메일을 확인하세요. 몇 분 내에 나타나지 않으면 스팸 폴더를 확인하세요.",
  ...
  error: {
    ...
    registrationNotAllowed:
      "계정을 찾을 수 없습니다. 등록하려면 시스템 관리자에게 문의하십시오.",
  },
  license: {
  ...
  resetPasswordDesc:
    "Dify에 가입할 때 사용한 이메일을 입력하면 비밀번호 재설정 이메일을 보내드립니다.",
  licenseInactiveTip:
    "작업 영역에 대한 IDX Enterprise 라이선스가 비활성 상태입니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.",
  licenseLost: "라이센스 분실",
  licenseLostTip:
    "Dify 라이선스 서버에 연결하지 못했습니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.",
  licenseInactive: "License Inactive(라이선스 비활성)",
  licenseExpired: "라이센스가 만료되었습니다.",
  licenseExpiredTip:
    "작업 영역에 대한 IDX Enterprise 라이선스가 만료되었습니다. Dify를 계속 사용하려면 관리자에게 문의하십시오.",
};
