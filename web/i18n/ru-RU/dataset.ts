const translation = {
  ...
  datasetUsedByApp:
    "База знаний используется некоторыми приложениями. Приложения больше не смогут использовать эту базу знаний, и все настройки подсказок и журналы будут безвозвратно удалены.",
  datasetDeleted: "База знаний удалена",
  datasetDeleteFailed: "Не удалось удалить базу знаний",
  didYouKnow: "Знаете ли вы?",
  intro1: "Базу знаний можно интегрировать в приложение IDX ",
  ...
  unavailableTip:
    "Модель встраивания недоступна, необходимо настроить модель встраивания по умолчанию",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "Создайте встраивания запросов и найдите фрагмент текста, наиболее похожий на его векторное представление.",
    },
    full_text_search: {
      title: "Полнотекстовый поиск",
      description:
        "Индексируйте все термины в документе, позволяя пользователям искать любой термин и извлекать соответствующий фрагмент текста, содержащий эти термины.",
    },
    hybrid_search: {
      title: "Гибридный поиск",
      description:
        "Выполняйте полнотекстовый поиск и векторный поиск одновременно, переранжируйте, чтобы выбрать наилучшее соответствие запросу пользователя. Пользователи могут выбрать установку весов или настройку модели переранжирования.",
      recommend: "Рекомендуется",
    },
    invertedIndex: {
      title: "Инвертированный индекс",
      description:
        "Инвертированный индекс - это структура, используемая для эффективного поиска. Организованный по терминам, каждый термин указывает на документы или веб-страницы, содержащие его.",
    },
    change: "Изменить",
  ...
  mixtureHighQualityAndEconomicTip:
    "Для смешивания высококачественных и экономичных баз знаний требуется модель переранжирования.",
  inconsistentEmbeddingModelTip:
    "Модель переранжирования требуется, если модели встраивания выбранных баз знаний несовместимы.",
  retrievalSettings: "Настройки поиска",
  rerankSettings: "Настройки переранжирования",
  weightedScore: {
    title: "Взвешенная оценка",
    description:
      "Регулируя назначенные веса, эта стратегия переранжирования определяет, следует ли отдавать приоритет семантическому или ключевому соответствию.",
  ...
  nTo1RetrievalLegacy:
    "Поиск N-к-1 будет официально прекращен с сентября. Рекомендуется использовать новейший многопутный поиск для получения лучших результатов.",
  nTo1RetrievalLegacyLink: "Узнать больше",
  nTo1RetrievalLegacyLinkText:
    " Поиск N-к-1 будет официально прекращен в сентябре.",
  defaultRetrievalTip:
    "По умолчанию используется многоканальная проверка. Знания извлекаются из нескольких баз знаний, а затем повторно ранжируются.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "Чтобы подключиться к внешней базе знаний, необходимо сначала создать внешний API. Пожалуйста, внимательно прочтите и обратитесь к",
  ...
  connectHelper: {
    ...
    helper1:
      "Подключение к внешним базам знаний через API и идентификатор базы знаний. В настоящее время",
  },
  ...
  learnHowToWriteGoodKnowledgeDescription:
    "Узнайте, как написать хорошее описание знаний",
  ...
  externalKnowledgeDescriptionPlaceholder:
    "Опишите, что входит в эту базу знаний (необязательно)",
  noExternalKnowledge:
    "У нас еще нет External Knowledge API, нажмите здесь, чтобы создать",
  ...
  mixtureInternalAndExternalTip:
    "Модель Rerank необходима для смешивания внутренних и внешних знаний.",
  allExternalTip:
    "При использовании только внешних знаний пользователь может выбрать, следует ли включать модель повторного ранжирования. Если этот параметр не включен, полученные фрагменты будут сортироваться на основе баллов. Когда стратегии извлечения из разных баз знаний несовместимы, они будут неточными.",
  externalAPIPanelDocumentation: "Узнайте, как создать API внешних знаний",
  externalAPIPanelDescription:
    "Внешний API базы знаний используется для подключения к базе знаний за пределами IDX и извлечения знаний из этой базы знаний.",
  chunkingMode: {
    general: "Общее",
  ...
  allKnowledgeDescription:
    "Выберите, чтобы отобразить все знания в этой рабочей области. Только владелец рабочего пространства может управлять всеми знаниями.",
};
