const translation = {
  list: {
    title: "Документы",
    desc: "Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами IDX или проиндексирована с помощью чата.",
  ...
  embedding: {
    ...
    previewTip:
      "Предварительный просмотр абзацев будет доступен после завершения расчета эмбеддингов",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "При повторном создании дочерних блоков текущие дочерние блоки будут перезаписаны, включая отредактированные и вновь добавленные блоки. Регенерацию нельзя отменить.",
