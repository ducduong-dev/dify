const translation = {
  ...
  setAdminAccountDesc:
    "Максимальные привилегии для учетной записи администратора, которые можно использовать для создания приложений, управления поставщиками LLM и т. д.",
  createAndSignIn: "Создать и войти",
  oneMoreStep: "Еще один шаг",
  createSample:
    "На основе этой информации мы создадим для вас пример приложения",
  ...
  go: "Перейти к Dify",
  sendUsMail:
    "Отправьте нам по электронной почте свое представление, и мы обработаем запрос на приглашение.",
  ...
  rightDesc:
    "Без труда создавайте визуально привлекательные, работоспособные и улучшаемые приложения ИИ.",
  tos: "Условия обслуживания",
  pp: "Политика конфиденциальности",
  tosDesc: "Регистрируясь, вы соглашаетесь с нашими",
  goToInit:
    "Если вы не инициализировали учетную запись, перейдите на страницу инициализации",
  dontHave: "Нет?",
  ...
  forgotPasswordDesc:
    "Пожалуйста, введите свой адрес электронной почты, чтобы сбросить пароль. Мы отправим вам электронное письмо с инструкциями о том, как сбросить пароль.",
  checkEmailForResetLink:
    "Пожалуйста, проверьте свою электронную почту на наличие ссылки для сброса пароля. Если она не появится в течение нескольких минут, обязательно проверьте папку со спамом.",
  passwordChanged: "Войдите сейчас",
  changePassword: "Изменить пароль",
  changePasswordTip:
    "Пожалуйста, введите новый пароль для своей учетной записи",
  ...
  error: {
    ...
    passwordInvalid:
      "Пароль должен содержать буквы и цифры, а длина должна быть больше 8",
    registrationNotAllowed:
      "Аккаунт не найден. Пожалуйста, свяжитесь с системным администратором для регистрации.",
  },
  license: {
    tip: "Перед запуском IDX Community Edition ознакомьтесь с лицензией GitHub",
  ...
  noLoginMethodTip:
    "Обратитесь к системному администратору, чтобы добавить метод аутентификации.",
  resetPasswordDesc:
    "Введите адрес электронной почты, который вы использовали для регистрации в Dify, и мы отправим вам электронное письмо для сброса пароля.",
  or: "ИЛИ",
  licenseInactive: "Лицензия неактивна",
  licenseLostTip:
    "Не удалось подключить сервер лицензий Dify. Обратитесь к своему администратору, чтобы продолжить использование Dify.",
  licenseExpired: "Срок действия лицензии истек",
  licenseLost: "Утеряна лицензия",
  licenseInactiveTip:
    "Лицензия IDX Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование Dify.",
  licenseExpiredTip:
    "Срок действия лицензии IDX Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование Dify.",
};
