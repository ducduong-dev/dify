const translation = {
  ...
  setAdminAccountDesc:
    "管理員擁有的最大許可權，可用於建立應用和管理 LLM 供應商等。",
  ...
  backToSignIn: "返回登錄",
  forgotPasswordDesc:
    "請輸入您的電子郵件地址以重設密碼。我們將向您發送一封電子郵件，說明如何重設密碼。",
  checkEmailForResetLink:
    "請檢查您的電子郵件以獲取重設密碼的連結。如果幾分鐘內沒有收到，請檢查您的垃圾郵件文件夾。",
  ...
  license: {
    tip: "啟動 IDX 社群版之前, 請閱讀 GitHub 上的",
    link: "開源協議",
  },
  join: "加入",
  joinTipStart: "邀請你加入",
  ...
  back: "返回",
  resetPasswordDesc:
    "輸入您用於註冊 IDX 的電子郵件，我們將向您發送一封密碼重置電子郵件。",
  usePassword: "使用密碼",
  licenseExpiredTip:
    "您的工作區的 IDX Enterprise 許可證已過期。請聯繫您的管理員以繼續使用 Dify。",
  licenseExpired: "許可證已過期",
  licenseLost: "許可證丟失",
  licenseInactive: "許可證處於非活動狀態",
  licenseInactiveTip:
    "您的工作區的 IDX Enterprise 許可證處於非活動狀態。請聯繫您的管理員以繼續使用 Dify。",
  licenseLostTip:
    "無法連接 IDX 許可證伺服器。請聯繫您的管理員以繼續使用 Dify。",
};
