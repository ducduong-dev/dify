const translation = {
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "配置憑據後，工作區中的所有成員都可以在編排應用程式時使用此工具。",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      type: "鑑權型別",
      keyTooltip:
        "HTTP 頭部名稱，如果你不知道是什麼，可以將其保留為 Authorization 或設定為自定義值",
      types: {
        none: "無",
        api_key: "API Key",
    ...
    nameForToolCallPlaceHolder:
      "用於機器識別，例如 getCurrentWeather、list_pets",
  },
  test: {
    title: "測試",
  ...
  customToolTip: "瞭解有關 IDX 自訂工具的更多資訊",
