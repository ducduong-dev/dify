const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "Квота пробного періоду надається для вашого тестувального використання. Перш ніж будуть вичерпані виклики квоти пробного періоду, налаштуйте свого власного постачальника моделей або придбайте додаткову квоту.",
      },
      exhausted: {
        title:
          "Вашу квоту пробного періоду вичерпано, налаштуйте свій ключ API.",
        description:
          "Вашу квоту пробного періоду вичерпано. Налаштуйте свого власного постачальника моделей або придбайте додаткову квоту.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "Або спробуйте хмарну версію IDX з безкоштовним цитатою",
  },
  overview: {
    title: "Огляд",
    appInfo: {
      ...
      settings: {
        ...
        webDescTip:
          "Цей текст буде відображений на клієнтському боці, надаючи базові вказівки щодо використання додатка",
        ...
        workflow: {
          ...
          showDesc:
            "Відображення або приховування відомостей про робочий процес у веб-програмі",
        },
        ...
        more: {
          ...
          privacyPolicyPlaceholder:
            "Введіть посилання на політику конфіденційності",
          privacyPolicyTip:
            "Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> Dify.",
          customDisclaimer: "Відмова від відповідальності",
          customDisclaimerPlaceholder: "Введіть відмову від відповідальності",
          customDisclaimerTip:
            "Відображається на клієнтському боці, щоб визначити відповідальність за використання додатка",
          copyrightTip:
            "Відображення інформації про авторські права у веб-програмі",
          copyrightTooltip:
            "Будь ласка, перейдіть на тарифний план «Professional» або вище",
        },
        sso: {
          title: "Єдиний вхід для WebApp",
          description:
            "Усі користувачі повинні увійти в систему за допомогою єдиного входу перед використанням WebApp",
          tooltip:
            "Зверніться до адміністратора, щоб увімкнути єдиний вхід WebApp",
      ...
      embedded: {
        ...
        iframe:
          "Для додавання чат-додатка в будь-яке місце на вашому веб-сайті, додайте цей iframe до вашого HTML-коду.",
        scripts:
          "Для додавання чат-додатка в правий нижній кут вашого веб-сайту додайте цей код до вашого HTML.",
        chromePlugin: "Встановити розширення Chrome IDX Chatbot",
        copied: "Скопійовано",
        copy: "Скопіювати",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "Ви можете налаштувати інтерфейс користувача веб-додатка, щоб він відповідав вашим потребам у сценаріях та стилі.",
        way1: {
          ...
          step1Tip:
            "Натисніть тут, щоб склонувати вихідний код у ваш обліковий запис GitHub та відредагувати код",
          step1Operation: "Клієнт-Web-Dify",
          step2: "Розгорніть на Vercel",
          step2Tip:
            "Натисніть тут, щоб імпортувати репозиторій у Vercel та розгорнути",
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Кількість щоденних розмов з ШІ; інженерія/налагодження промптів виключено.",
    },
    activeUsers: {
      title: "Активні користувачі",
      explanation:
        "Унікальні користувачі, які взаємодіють з AI; інженерія/налагодження запитів виключено.",
    },
    tokenUsage: {
      title: "Використання токенів",
      explanation:
        "Відображає щоденне використання токенів мовної моделі для додатка, корисно для контролю витрат.",
      consumed: "Спожито",
    },
    avgSessionInteractions: {
      title: "Середня кількість взаємодій за сесію",
      explanation:
        "Кількість продовжуючихся спілкувань користувача з AI; для програм, що базуються на розмові.",
    },
    avgUserInteractions: {
      title: "Середня кількість взаємодій на користувача",
      explanation:
        "Відображає щоденну частоту використання користувачами. Ця метрика відображає лояльність користувачів.",
    },
    userSatisfactionRate: {
      title: "Показник задоволення користувача",
      explanation:
        "Кількість лайків на 1000 повідомлень. Це вказує на те, наскільки задоволені користувачі відповідями.",
    },
    avgResponseTime: {
    ...
    tps: {
      ...
      explanation:
        "Вимірює продуктивність LLM. Підраховує швидкість виведення токенів LLM від початку запиту до завершення виведення.",
    },
  },
};
