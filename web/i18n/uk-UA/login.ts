const translation = {
  ...
  setAdminAccountDesc:
    "Максимальні привілеї для облікового запису адміністратора, які можна використовувати для створення програм, керування постачальниками LLM тощо.",
  ...
  go: "Перейти до Dify",
  sendUsMail:
    "Надішліть нам своє представлення, і ми обробимо запит на запрошення.",
  ...
  rightDesc:
    "З легкістю створюйте візуально привабливі, функціональні та вдосконалювані програми зі штучним інтелектом.",
  tos: "Умови обслуговування",
  pp: "Політика конфіденційності",
  tosDesc: "Реєструючись, ви приймаєте наші",
  goToInit:
    "Якщо ви ще не ініціалізували обліковий запис, перейдіть на сторінку ініціалізації",
  dontHave: "Не маєте?",
  ...
  forgotPasswordDesc:
    "Будь ласка, введіть свою електронну адресу, щоб скинути пароль. Ми надішлемо вам електронного листа з інструкціями щодо скидання пароля.",
  checkEmailForResetLink:
    "Будь ласка, перевірте свою електронну пошту на наявність посилання для скидання пароля. Якщо протягом кількох хвилин не з’явиться, перевірте папку зі спамом.",
  passwordChanged: "Увійдіть зараз",
  changePassword: "Змінити пароль",
  changePasswordTip:
    "Будь ласка, введіть новий пароль для свого облікового запису",
  ...
  error: {
    ...
    passwordInvalid:
      "Пароль повинен містити літери та цифри, а довжина повинна бути більшою за 8",
    passwordLengthInValid: "Пароль повинен бути не менше 8 символів",
    registrationNotAllowed:
      "Аккаунт не знайдено. Будь ласка, зверніться до адміністратора системи для реєстрації.",
  },
  license: {
    tip: "Перед запуском IDX Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub",
  ...
  noLoginMethodTip:
    "Будь ласка, зверніться до адміністратора системи, щоб додати метод автентифікації.",
  resetPasswordDesc:
    "Введіть адресу електронної пошти, яку ви використовували для реєстрації на Dify, і ми надішлемо вам електронний лист для скидання пароля.",
  resetPassword: "Скинути пароль",
  licenseLostTip:
    "Не вдалося підключити сервер ліцензій Dify. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Dify.",
  licenseExpired: "Термін дії ліцензії минув",
  licenseInactive: "Ліцензія неактивна",
  licenseLost: "Ліцензію втрачено",
  licenseInactiveTip:
    "Ліцензія IDX Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Dify.",
  licenseExpiredTip:
    "Термін дії ліцензії IDX Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Dify.",
};
