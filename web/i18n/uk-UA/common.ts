const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Ваше максимальне значення токена велике, що може обмежувати простір для запитів, даних тощо. Краще налаштувати його менш як 2/3.",
      setToCurrentModelMaxTokenTip:
        "Максимальний токен оновлено до максимуму токена поточної моделі {{maxToken}}.",
      stop_sequences: "Зупинити послідовності",
      stop_sequencesTip:
        "До чотирьох послідовностей, у яких API припинить генерацію подальших токенів. Повернений текст не міститиме зупинку послідовності.",
  ...
  menus: {
    ...
    datasets: "Знання",
    datasetsTips:
      "СКОРО:  імпортуйте власні текстові дані або пишіть дані в реальному часі через Webhook для покращення контексту LLM.",
  ...
  account: {
    ...
    password: "Пароль",
    passwordTip:
      "Ви можете встановити постійний пароль, якщо не хочете використовувати тимчасові коди для входу",
    ...
    langGeniusAccountTip:
      "Ваш обліковий запис IDX та пов’язані з ним дані користувача.",
    editName: "Редагувати ім'я",
    showAppLength: "Показати {{length}} програм",
    delete: "Видалити обліковий запис",
    deleteTip:
      "Видалення вашого облікового запису призведе до остаточного видалення всіх ваших даних, і їх неможливо буде відновити.",
    deleteConfirmTip:
      "Щоб підтвердити, будь ласка, надішліть наступне з вашої зареєстрованої електронної пошти на ",
    account: "Рахунок",
    studio: "Студія Dify",
    ...
    deletePrivacyLinkTip:
      "Для отримання додаткової інформації про те, як ми обробляємо ваші дані, будь ласка, перегляньте наш",
    deleteSuccessTip:
      "Вашому обліковому запису потрібен час, щоб завершити видалення. Ми надішлемо вам електронного листа, коли все буде готово.",
    deleteLabel:
      "Для підтвердження, будь ласка, введіть свою електронну пошту нижче",
  ...
  members: {
    ...
    normal: "Звичайний",
    normalTip:
      "Може лише використовувати програми, не може створювати програми",
    editor: "Редактор",
    editorTip:
      "Може створювати програми, але не може керувати налаштуваннями команди",
    inviteTeamMember: "Додати учасника команди",
    inviteTeamMemberTip:
      "Вони зможуть отримати доступ до даних вашої команди безпосередньо після входу.",
    emailNotSetup:
      "Поштовий сервер не налаштований, тому запрошення електронною поштою не можуть бути надіслані. Будь ласка, повідомте користувачів про посилання для запрошення, яке буде видано після запрошення.",
    email: "Електронна пошта",
    ...
    invitationSentTip:
      "Запрошення надіслано, і вони можуть увійти в Dify, щоб отримати доступ до даних вашої команди.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "У цього ключа API немає доступної квоти, будь ласка, прочитайте",
    addKey: "Додати ключ",
    comingSoon: "Скоро",
    editKey: "Редагувати",
    ...
    azure: {
      apiBase: "API-шлях",
      apiBasePlaceholder:
        "Базовий URL-адреса API вашої кінцевої точки Azure OpenAI.",
      apiKey: "Ключ API",
    ...
    openaiHosted: {
      ...
      usedUp:
        "Пробна квота використана. Додайте власного постачальника моделі.",
    ...
    anthropicHosted: {
      ...
      close: "Закрити",
      trialQuotaTip:
        "Ваша квота на антропічні пробні випробування закінчується 11.03.2025 і після цього більше не буде доступна. Будь ласка, скористайтеся ним вчасно.",
    },
    anthropic: {
      using: "Функція вбудовування використовує",
      enableTip:
        "Щоб активувати модель Anthropic, спочатку потрібно прив’язатись до OpenAI або Azure OpenAI Service.",
  ...
  modelProvider: {
    notConfigured:
      "Системну модель ще не повністю налаштовано, і деякі функції можуть бути недоступні.",
    ...
    item: {
      deleteDesc:
        "{{modelName}} використовуються як системні моделі міркування. Деякі функції будуть недоступні після видалення. Будь ласка, підтвердьте.",
    ...
    loadBalancingDescription:
      "Зменшіть тиск за допомогою кількох наборів облікових даних.",
    ...
    upgradeForLoadBalancing:
      "Оновіть свій план, щоб увімкнути балансування навантаження.",
    apiKeyRateLimit:
      "Було досягнуто ліміту швидкості, доступного після {{seconds}}",
    providerManagedDescription:
      "Використовуйте єдиний набір облікових даних, наданий постачальником моделі.",
    loadBalancingLeastKeyWarning:
      "Щоб увімкнути балансування навантаження, має бути ввімкнено щонайменше 2 клавіші.",
    loadBalancingInfo:
      "За замовчуванням для балансування навантаження використовується стратегія кругової системи. Якщо спрацьовує обмеження швидкості, буде застосовано період перезарядки тривалістю 1 хвилина.",
  ...
  plugin: {
    serpapi: {
      ...
      keyFrom:
        "Отримайте свій ключ SerpAPI зі сторінки облікового запису SerpAPI",
    },
  },
  apiBasedExtension: {
    title:
      "API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах Dify.",
  ...
  datasetMenus: {
    ...
    settings: "Налаштування",
    emptyTip:
      "Знання не пов’язані, будь ласка, перейдіть до програми або плагіна, щоб завершити зв’язок.",
  ...
  promptEditor: {
    placeholder:
      "Пишіть свої підказки тут, вводьте '{', щоб вставити змінну чи '/', щоб вставити блок-підказку",
    context: {
      item: {
        title: "Контекст",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Помилка зчитування зображення, повторіть спробу.",
    uploadFromComputerUploadError:
      "Помилка завантаження зображення, спробуйте знову.",
    uploadFromComputerLimit:
      "Розмір зображення не може перевищувати {{size}} МБ",
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "Не вдалося завантажити файл, будь ласка, завантажте ще раз.",
  },
  license: {
