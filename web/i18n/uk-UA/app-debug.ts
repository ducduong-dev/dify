const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "Ви перейшли в експертний режим, і після того, як ви зміните PROMPT, ви НЕ можете повернутися назад в базовий режим.",
    ...
    contextMissing:
      "Компонент контексту відсутній, ефективність підказки може бути не найкращою.",
  },
  operation: {
  ...
  notSetAPIKey: {
    ...
    description:
      "Ключ провайдера LLM не встановлено, і його потрібно встановити перед налагодженням.",
  ...
  feature: {
    groupChat: {
      ...
      description:
        "Додайте налаштування попередньої розмови для додатків, щоб покращити користувацький досвід.",
    },
    groupExperience: {
    ...
    conversationOpener: {
      ...
      description:
        "У чат-додатках перше речення, яке ШІ активно промовляє користувачеві, зазвичай використовується як привітання.",
    },
    suggestedQuestionsAfterAnswer: {
      title: "Наступні",
      description:
        "Налаштування пропозицій наступних запитань може надати користувачам кращий чат.",
    ...
    moreLikeThis: {
      title: "Більше такого",
      description:
        "Згенерувати кілька текстів одночасно, а потім редагувати та продовжити генерацію",
    ...
    citation: {
      ...
      description:
        "Після активації показувати вихідний документ та атрибутований розділ згенерованого вмісту.",
      resDes: "Цитати та Атрибуції активовано",
    },
    annotation: {
      title: "Відповідь-Анотація", // Annotation Reply
      description:
        "Ви можете вручну додати високоякісну відповідь до кешу для пріоритетного порівняння з подібними запитаннями користувачів.",
      resDes: "Відповідь-Анотація увімкнена",
      scoreThreshold: {
        title: "Поріг оцінки", // Score Threshold
        description:
          "Використовується для встановлення порогу схожості для відповіді-анотації.",
    ...
    dataSet: {
      ...
      queryVariable: {
        ...
        unableToQueryDataSetTip:
          "Не вдалося успішно виконати запит до Бази Знань, будь ласка, виберіть змінну контекстного запиту в розділі контексту.",
        ok: "ОК", // OK
        ...
        deleteContextVarTip:
          "Ця змінна була встановлена ​​як змінна контекстного запиту, і її видалення вплине на нормальне використання Знань. Якщо вам все ще потрібно її видалити, будь ласка, виберіть її повторно в розділі контексту.",
      },
    },
    tools: {
    ...
    moderation: {
      ...
      description:
        "Захистіть вивід моделі, використовуючи API модерації або список конфіденційних слів.", // Secure model output...
      ...
      modal: {
        ...
        provider: {
          ...
          openaiTip: {
            prefix:
              "Для модерації OpenAI потрібен ключ API OpenAI, налаштований у ",
            suffix: ".",
          },
        ...
        content: {
          ...
          condition:
            "Увімкнено принаймні одне: «Модерувати ВВЕДЕННЯ ТА ВИВЕДЕННЯ Вмісту»",
          fromApi: "Попередньо встановлені відповіді повертаються через API", // Preset replies are returned by API
          errorMessage:
            "Попередньо встановлені відповіді не можуть бути порожніми",
          supportMarkdown: "Підтримка Markdown", // Markdown supported
        },
        openaiNotConfig: {
          before:
            "Модерація OpenAI вимагає, щоб ключ API OpenAI був налаштований у ",
          after: "",
        },
      },
    },
  ...
  automatic: {
    ...
    description: "Опишіть свій сценарій, IDX збере для вас застосунок.",
    ...
    noData:
      "Опишіть свій випадок використання зліва, тут буде показано попередній перегляд оркестрації.",
    loading: "Оркестрація програми для вас...",
    overwriteTitle: "Перезаписати існуючу конфігурацію?",
    overwriteMessage:
      "Застосування цієї оркестрації призведе до перезапису існуючої конфігурації.",
  },
  resetConfig: {
    title: "Підтвердіть скидання?",
    message:
      "Скидання призводить до скасування змін, відновлюючи останню опубліковану конфігурацію.",
  },
  errorMessage: {
    ...
    waitForResponse:
      "Будь ласка, зачекайте, доки буде завершено відповідь на попереднє повідомлення.", // Please wait for the response to the previous message to complete.
    waitForBatchResponse:
      "Будь ласка, дочекайтеся завершення відповіді на пакетне завдання.", // Please wait for the response to the batch task to complete.
  ...
  promptTip:
    "Запити керують відповідями ШІ, надаючи інструкції та обмеження. Вставте змінні, як-от {{input}}. Цей запит не буде видно користувачам.",
  formattingChangedTitle: "Змінено форматування", // Formatting changed
  formattingChangedText:
    "Змінення форматування призведе до скидання області налагодження. Ви впевнені?", // Modifying the formatting will reset the debug area, are you sure?
  variableTitle: "Змінні", // Variables
  variableTip:
    "Користувачі заповнюють змінні у формі, автоматично замінюючи змінні в команді.",
  notSetVar:
    'Змінні дозволяють користувачам вводити підказки або вступні зауваження під час заповнення форм. Ви можете спробувати ввести "{{input}}" у слова підказки.',
  autoAddVar:
    "На невизначені змінні, на які посилаються в попередньому запиті, є посилання. Ви хочете додати їх у форму вводу користувача?", // Undefined variables referenced in pre-prompt, are you want to add them in user input form?
  variableTable: {
  ...
  varKeyError: {
    ...
    notValid:
      "{{key}} недійсний. Може містити лише літери, цифри та підкреслення", // Variable key: {{key}} is invalid. Can only contain letters, numbers, and underscores
  ...
  vision: {
    ...
    description:
      'Увімкнення функції "Зображення" дозволить моделі приймати зображення та відповідати на запитання про них.',
  ...
  openingStatement: {
    ...
    placeholder:
      "Напишіть тут своє вступне повідомлення, ви можете використовувати змінні, спробуйте ввести {{variable}}.", // Write your opener message here...
    openingQuestion: "Відкриваючі питання", // Opening Questions
    noDataPlaceHolder:
      "Початок розмови з користувачем може допомогти ШІ встановити більш тісний зв’язок з ним у розмовних застосунках.", // ... conversational applications.
    varTip: "Ви можете використовувати змінні, спробуйте ввести {{variable}}", // You can use variables, try type {{variable}}
    tooShort:
      "Для створення вступних зауважень для розмови потрібно принаймні 20 слів вступного запиту.", // ... are required to generate an opening remarks for the conversation.
    notIncludeKey:
      "Початковий запит не включає змінну: {{key}}. Будь ласка, додайте її до початкового запиту.", // ... does not include the variable ...
  },
  modelConfig: {
    model: "Модель", // Model
  ...
  inputs: {
    ...
    noPrompt:
      "Спробуйте написати якийсь запит у полі введення префіксу команди", // Try write some prompt in pre-prompt input
    userInputField: "Поле введення користувача", // User Input Field
    noVar:
      "Заповніть значення змінної, яка буде автоматично замінена в слові-підказці під час кожного запуску нового сеансу.", // Fill in the value of the variable...
    chatVarTip:
      "Заповніть значення змінної, яка буде автоматично замінена в слові-підказці під час кожного запуску нового сеансу.", // Fill in the value of the variable...
    completionVarTip:
      "Заповніть значення змінної, яка буде автоматично замінена в словах-підказках під час кожного відправлення запиту.", // Fill in the value of the variable...
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description:
        "На основі намірів користувача та описів Знань Агент самостійно вибирає найкращі Знання для запитів. Найкраще підходить для застосунків з окремими, обмеженими Знаннями.",
    },
    retrieveMultiWay: {
      title: "Багатосторонній пошук", // Multi-path retrieval
      description:
        "На основі намірів користувача запитує по всіх Базах Знань, отримує релевантний текст із кількох джерел і вибирає найкращі результати, що відповідають запиту користувача, після переранжування. Необхідна конфігурація API моделі переранжування.",
    },
    ...
    top_kTip:
      "Використовується для фільтрації фрагментів, найбільш схожих на запитання користувачів. Система також динамічно регулюватиме значення K у відповідності з max_tokens обраної моделі.",
    score_threshold: "Поріг оцінки", // Score Threshold
    score_thresholdTip:
      "Використовується для встановлення порогу схожості для фільтрації фрагментів.",
    retrieveChangeTip:
      "Зміна  режиму індексування та режиму отримання може вплинути на застосунки, пов’язані з цими знаннями.", // Modifying...
  },
  ...
  assistantType: {
    ...
    chatAssistant: {
      ...
      description:
        "Створіть помічника на базі чату за допомогою великої мовної моделі", // Build a chat-based...
    },
    agentAssistant: {
      name: "Інтелектуальний помічник", // Agent Assistant
      description:
        "Створіть інтелектуального агента, який може самостійно вибирати інструменти для виконання завдань", // Build an intelligent Agent...
    },
  },
  agent: {
    ...
    setting: {
      ...
      description:
        "Налаштування агента дозволяють встановити режим агента та розширені функції, наприклад вбудовані команди, доступні тільки для типу агента.", // Agent Assistant settings allow...
      maximumIterations: {
        name: "Максимальна кількість ітерацій", // Maximum Iterations
        description:
          "Обмежте кількість ітерацій, які може виконати помічник агента", // Limit the number of iterations...
      },
    },
    ...
    tools: {
      ...
      description:
        "Використання інструментів може розширити можливості LLM, наприклад, пошук в Інтернеті або виконання наукових розрахунків", // Using tools can extend...
