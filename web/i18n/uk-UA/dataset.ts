const translation = {
  ...
  createDatasetIntro:
    "Імпортуйте власні текстові дані або записуйте дані в реальному часі через Webhook для покращення LLM-контексту.",
  ...
  datasetUsedByApp:
    "Ці знання використовуються деякими додатками. Додатки більше не зможуть використовувати ці Знання, а всі конфігурації підказок та журнали будуть остаточно видалені.",
  datasetDeleted: "Знання видалено",
  datasetDeleteFailed: "Не вдалося видалити Знання",
  didYouKnow: "Чи знаєте ви?",
  intro1: "Знання можна інтегрувати до програми IDX ",
  intro2: "як контекст",
  intro3: ",",
  intro4: "або його ",
  ...
  unavailableTip:
    "Модель вбудовування недоступна, необхідно налаштувати модель вбудовування за замовчуванням",
  datasets: "ЗНАННЯ",
  datasetsApi: "API",
  retrieval: {
    semantic_search: {
      ...
      description:
        "Генерує вбудовування запитів і шукає фрагмент тексту, найбільш схожий на його векторне представлення.",
    },
    full_text_search: {
      title: "Повнотекстовий пошук",
      description:
        "Індексує всі терміни в документі, дозволяючи користувачам шукати будь-який термін і отримувати відповідний фрагмент тексту, що містить цей термін.",
    },
    hybrid_search: {
      title: "Гібридний пошук",
      description:
        "Виконуйте повнотекстовий пошук і векторний пошук одночасно, повторно ранжуючи, щоб вибрати найкращу відповідність на запит користувача. Необхідна конфігурація Rerank model API.",
      recommend: "Рекомендовано",
    },
    invertedIndex: {
      title: "Інвертований індекс",
      description:
        "Інвертований індекс – це структура, яка використовується для ефективного пошуку. Організований за термінами, кожен термін вказує на документи або веб-сторінки, що його містять.",
    },
    change: "Змінити",
  ...
  mixtureHighQualityAndEconomicTip:
    "Модель перерангування потрібна для суміші високоякісних та економічних баз знань.",
  inconsistentEmbeddingModelTip:
    "Модель перерангування потрібна, якщо моделі вбудовування вибраних баз знань є несумісними.",
  retrievalSettings: "Налаштування пошуку",
  rerankSettings: "Налаштування перерангування",
  weightedScore: {
    title: "Зважена оцінка",
    description:
      "Регулюючи призначені ваги, ця стратегія перерангування визначає, чи надавати пріоритет семантичному чи ключовому відповідності.",
  ...
  nTo1RetrievalLegacy:
    "N-до-1 пошук буде офіційно застарілим з вересня. Рекомендується використовувати найновіший багатошляховий пошук для отримання кращих результатів.",
  nTo1RetrievalLegacyLink: "Дізнатися більше",
  nTo1RetrievalLegacyLinkText:
    "N-до-1 пошук буде офіційно застарілим у вересні.",
  defaultRetrievalTip:
    "За замовчуванням використовується отримання кількома шляхами. Знання витягуються з кількох баз знань, а потім заново ранжуються.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "Щоб підключитися до зовнішньої бази знань, спочатку потрібно створити зовнішній API. Будь ласка, уважно прочитайте та зверніться до",
  ...
  connectHelper: {
    ...
    helper1:
      "Підключайтеся до зовнішніх баз знань через API та ідентифікатор бази знань. Наразі",
  },
  ...
  externalKnowledgeDescriptionPlaceholder:
    "Опишіть, що міститься в цій базі знань (необов'язково)",
  ...
  noExternalKnowledge:
    "API зовнішніх знань поки що не існує, натисніть тут, щоб створити",
  ...
  learnHowToWriteGoodKnowledgeDescription:
    "Навчіться писати хороший опис знань",
  allExternalTip:
    "При використанні тільки зовнішніх знань користувач може вибрати, чи включати модель Rerank. Якщо цей параметр не увімкнено, отримані фрагменти будуть відсортовані на основі оцінок. Коли стратегії пошуку різних баз знань несумісні, це буде неточно.",
  mixtureInternalAndExternalTip:
    "Модель Rerank необхідна для поєднання внутрішніх і зовнішніх знань.",
  externalKnowledgeIdPlaceholder: "Будь ласка, введіть Knowledge ID",
  externalAPIPanelDescription:
    "API зовнішніх знань використовується для підключення до бази знань за межами IDX і отримання знань із цієї бази знань.",
  chunkingMode: {
  ...
  allKnowledgeDescription:
    "Виберіть, щоб відобразити всі знання в цій робочій області. Тільки власник робочої області може керувати всіма знаннями.",
};
