const translation = {
  ...
  form: {
    ...
    descInfo:
      "Напишіть зрозумілий текстовий опис, щоб окреслити вміст бази знань. Цей опис використовуватиметься як основа для узгодження під час вибору з кількох баз знань для висновку.",
    descPlaceholder:
      "Опишіть, що міститься в цій базі знань. Детальний опис дозволяє AI своєчасно отримати доступ до вмісту бази знань. Якщо значення порожнє, IDX використовуватиме стратегію влучань за умовчанням.",
    ...
    indexMethodHighQualityTip:
      "Викликати модель Embedding для обробки, щоб забезпечити вищу точність під час запитів користувачів.",
    indexMethodEconomy: "Економний",
    indexMethodEconomyTip:
      "Використовуйте автономні векторні двигуни, індекси ключових слів тощо, щоб зменшити точність без використання токенів.",
    ...
    retrievalSetting: {
      ...
      longDescription:
        " про метод вибірки, ви можете змінити це будь-коли в налаштуваннях бази знань.",
    },
    save: "Зберегти",
    me: "(Ви)",
    ...
    indexMethodChangeToEconomyDisabledTip:
      "Недоступно для пониження з HQ до ECO",
    upgradeHighQualityTip:
      "Після оновлення до режиму високої якості повернення до економного режиму недоступне",
  },
};
