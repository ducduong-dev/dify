const translation = {
  list: {
    title: "Документи",
    desc: "Тут відображаються всі файли Знання, і все Знання можна зв’язати з цитатами IDX або проіндексувати за допомогою плагіна Chat.",
    addFile: "додати файл",
  ...
  metadata: {
    ...
    docTypeSelectWarning:
      "Якщо тип документа буде змінено, наразі заповнені метадані більше не зберігатимуться",
  ...
  embedding: {
    ...
    previewTip:
      "Попередній перегляд параграфа буде доступний після завершення побудови векторів",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Регенерація дочірніх фрагментів перезаписує поточні дочірні фрагменти, включаючи відредаговані фрагменти та нещодавно додані фрагменти. Регенерація не може бути скасована.",
    chunk: "Шматок",
