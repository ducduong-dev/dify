const translation = {
  ...
  setAdminAccountDesc:
    "Yönetici hesabı için maksimum ayrıcalıklar, uygulama oluşturma ve LLM sağlayıcılarını yönetme gibi işlemler için kullanılabilir.",
  createAndSignIn: "Oluştur ve giriş yap",
  oneMoreStep: "Bir adım kaldı",
  createSample:
    "Bu bilgilere dayanarak, sizin için örnek bir uygulama oluşturacağız",
  ...
  go: "Dify'ye git",
  sendUsMail:
    "Tanıtımınızı e-posta ile gönderin, davet talebini işleme alalım.",
  ...
  rightDesc:
    "Görsel olarak çekici, çalışılabilir ve iyileştirilebilir AI uygulamaları oluşturun.",
  tos: "Hizmet Şartları",
  ...
  forgotPasswordDesc:
    "Şifrenizi sıfırlamak için e-posta adresinizi girin. Şifrenizi nasıl sıfırlayacağınıza dair talimatları içeren bir e-posta göndereceğiz.",
  checkEmailForResetLink:
    "Şifrenizi sıfırlamak için bir bağlantı içeren e-postayı kontrol edin. Birkaç dakika içinde görünmezse, spam klasörünüzü kontrol ettiğinizden emin olun.",
  ...
  error: {
    ...
    passwordInvalid:
      "Şifre harf ve rakamlardan oluşmalı ve uzunluğu 8 karakterden fazla olmalıdır",
    registrationNotAllowed:
      "Hesap bulunamadı. Kayıt olmak için lütfen sistem yöneticisi ile iletişime geçin.",
  },
  license: {
  ...
  resetPasswordDesc:
    "Dify'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.",
  backToLogin: "Girişe geri dön",
  useVerificationCode: "Doğrulama Kodunu Kullan",
  noLoginMethodTip:
    "Bir kimlik doğrulama yöntemi eklemek için lütfen sistem yöneticisine başvurun.",
  sendVerificationCode: "Doğrulama Kodu Gönder",
  back: "Geri",
  licenseExpiredTip:
    "Çalışma alanınız için IDX Enterprise lisansının süresi doldu. Dify'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.",
  licenseLostTip:
    "Dify lisans sunucusuna bağlanılamadı. Dify'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.",
  licenseInactiveTip:
    "Çalışma alanınız için IDX Enterprise lisansı etkin değil. Dify'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.",
