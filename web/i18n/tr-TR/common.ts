const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Maksimum token ayarınız yüksek, bu da promptlar, sorgular ve veriler için alanı sınırlayabilir. Bu değeri 2/3'ün altında ayarlamayı düşünün.",
      setToCurrentModelMaxTokenTip:
        "Maksimum token, mevcut modelin maksimum token'ın %80'ine {maxToken} olarak güncellendi.",
      stop_sequences: "Stop sıraları",
      stop_sequencesTip:
        "API, dört adede kadar sıra belirleyerek daha fazla token üretmeyi durduracaktır. Dönülen metin durdurma sırasını içermez.",
  ...
  menus: {
    ...
    plugins: "Eklentiler",
    pluginsTips:
      "Üçüncü taraf eklentileri entegre edin veya ChatGPT uyumlu AI-Eklentileri oluşturun.",
    datasets: "Bilgi",
    datasetsTips:
      "YAKINDA: Kendi metin verilerinizi içe aktarın veya LLM bağlamını geliştirmek için Webhook aracılığıyla gerçek zamanlı veri yazın.",
  ...
  account: {
    ...
    password: "Şifre",
    passwordTip:
      "Geçici giriş kodlarını kullanmak istemiyorsanız kalıcı bir şifre ayarlayabilirsiniz",
    ...
    delete: "Hesabı Sil",
    deleteTip:
      "Hesabınızı silmek tüm verilerinizi kalıcı olarak siler ve geri alınamaz.",
    deleteConfirmTip:
      "Onaylamak için, kayıtlı e-postanızdan şu adrese e-posta gönderin: ",
    account: "Hesap",
    myAccount: "Hesabım",
    studio: "Dify Stüdyo",
    deleteSuccessTip:
      "Hesabınızın silme işleminin tamamlanması için zamana ihtiyacı var. Her şey bittiğinde size e-posta göndereceğiz.",
    ...
    deletePrivacyLinkTip:
      "Verilerinizi nasıl işlediğimiz hakkında daha fazla bilgi için lütfen",
  ...
  members: {
    ...
    inviteTeamMemberTip:
      "Giriş yaptıktan sonra takım verilerinize doğrudan erişebilirler.",
    emailNotSetup:
      "E-posta sunucusu kurulu değil, bu nedenle davet e-postaları gönderilemiyor. Lütfen kullanıcıları davetten sonra verilecek davet bağlantısı hakkında bilgilendirin.",
    email: "E-posta",
    ...
    invitationSentTip:
      "Davet gönderildi, Dify'ye giriş yaparak takım verilerinize erişebilirler.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Bu API ANAHTARININ kullanılabilir kotası yok, lütfen okuyun",
    addKey: "Anahtar Ekle",
    comingSoon: "Yakında",
    editKey: "Düzenle",
    ...
    anthropicHosted: {
      ...
      close: "Kapat",
      trialQuotaTip:
        "Antropik deneme kotanız 11/03/2025 tarihinde sona erecek ve bu tarihten sonra kullanılamayacaktır. Lütfen zamanında kullanın.",
    },
    anthropic: {
      using: "Yerleştirme yeteneği,",
      enableTip:
        "Anthropic modelini etkinleştirmek için önce OpenAI veya Azure OpenAI hizmetine bağlanmanız gerekir.",
  ...
  modelProvider: {
    notConfigured:
      "Sistem modeli henüz tam olarak yapılandırılmadı ve bazı işlevler kullanılamayabilir.",
    ...
    item: {
      deleteDesc:
        "{{modelName}} şu anda sistem çıkarım modeli olarak kullanılmaktadır. Kaldırıldıktan sonra bazı işlevler kullanılamayabilir. Lütfen onaylayın.",
    ...
    loadBalancingDescription:
      "Birden fazla kimlik bilgisi grubu ile baskıyı azaltın.",
    ...
    providerManagedDescription:
      "Model sağlayıcı tarafından sağlanan tek bir kimlik bilgisi grubunu kullanın.",
    defaultConfig: "Varsayılan Yapılandırma",
    apiKeyStatusNormal: "API Anahtarının durumu normal",
    apiKeyRateLimit:
      "Hız sınırına ulaşıldı, {{seconds}} saniye sonra tekrar kullanılabilir",
    addConfig: "Yapılandırma Ekle",
    editConfig: "Yapılandırmayı Düzenle",
    loadBalancingLeastKeyWarning:
      "Yük dengeleme etkinleştirmek için en az 2 anahtar etkinleştirilmelidir.",
    loadBalancingInfo:
      "Varsayılan olarak, yük dengeleme Yuvarlakrobin stratejisini kullanır. Hız sınırlaması tetiklenirse, 1 dakikalık bir soğuma süresi uygulanacaktır.",
    upgradeForLoadBalancing:
      "Yük Dengelemeyi etkinleştirmek için planınızı yükseltin.",
  ...
  dataSource: {
    ...
    website: {
      title: "Web Sitesi",
      description:
        "Web tarayıcı kullanarak web sitelerinden içerik içe aktarın.",
      with: "İle",
  ...
  apiBasedExtension: {
    title:
      "API uzantıları merkezi API yönetimi sağlar, Dify'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.",
  ...
  datasetMenus: {
    ...
    settings: "Ayarlar",
    emptyTip:
      "Bilgi ilişkilendirilmemiş, ilişkilendirme işlemini tamamlamak için uygulama veya eklentiye gidin.",
  ...
  promptEditor: {
    placeholder:
      "Prompt kelimenizi buraya yazın, değişken eklemek için '{' tuşuna, prompt içerik bloğu eklemek için '/' tuşuna basın",
    context: {
      item: {
        title: "Bağlam",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Görüntü okuma başarısız oldu, lütfen tekrar deneyin.",
    uploadFromComputerUploadError:
      "Görüntü yükleme başarısız oldu, lütfen tekrar yükleyin.",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "Dosya okuma başarısız oldu, lütfen tekrar deneyin.",
    uploadFromComputerLimit: "Dosya Yükleme {{size}}'ı aşamaz",
    uploadFromComputerUploadError:
      "Dosya yükleme başarısız oldu, lütfen tekrar yükleyin.",
