const translation = {
  list: {
    title: "Belgeler",
    desc: "Bilginin tüm dosyaları burada gösterilir ve Bilginin tamamı IDX alıntılarına veya Sohbet eklentisi üzerinden dizine eklenebilir.",
    addFile: "Dosya Ekle",
    addPages: "Sayfa Ekle",
    addUrl: "URL Ekle",
    table: {
  ...
  metadata: {
    ...
    docTypeSelectWarning:
      "Belge türü değiştirilirse, şimdi doldurulan meta veriler artık korunmayacaktır",
  ...
  embedding: {
    ...
    custom: "Özel",
    previewTip:
      "Paragraf önizlemesi yerleştirme tamamlandıktan sonra kullanılabilir olacak",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Alt öbekleri yeniden oluşturmak, düzenlenen öbekler ve yeni eklenen öbekler de dahil olmak üzere mevcut alt öbeklerin üzerine yazılır. Yenilenme geri alınamaz.",
    ...
    regenerationConfirmTitle:
      "Alt parçaları yeniden oluşturmak istiyor musunuz?",
