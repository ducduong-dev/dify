const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      preview: "预览",
      maxDepthTooltip:
        "相对于输入 URL 的最大抓取深度。深度0仅抓取输入 URL 本身的页面，深度1抓取输入 URL 及其后的一层目录（一个 /），依此类推。",
    },
  },
  stepTwo: {
    segmentation: "分段设置",
    ...
    qaSwitchHighQualityTipContent:
      "目前，只有高质量的索引方法支持 Q&A 格式分块。您要切换到高质量模式吗？",
  ...
  otherDataSource: {
    title: "连接到其他数据源？",
    description:
      "目前，Dify 的知识库只有有限的数据源。向 IDX 知识库贡献数据源是帮助所有用户增强平台灵活性和强大功能的绝佳方式。我们的贡献指南使入门变得容易。请点击下面的链接了解更多信息。",
    learnMore: "了解更多信息",
  },
};
