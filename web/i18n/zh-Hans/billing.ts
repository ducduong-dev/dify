const translation = {
  ...
  usagePage: {
    ...
    vectorSpaceTooltip:
      "采用高质量索引模式的文档会消耗知识数据存储资源。当知识数据存储达到限制时，将不会上传新文档。",
  },
  upgradeBtn: {
    plain: "查看套餐",
    encourage: "立即升级",
  ...
  plansCommon: {
    ...
    talkToSales: "联系销售",
    modelProviders:
      "支持 OpenAI/Anthropic/Llama2/Azure OpenAI/Hugging Face/Replicate",
    ...
    documentsRequestQuotaTooltip:
      "指每分钟内，一个空间在知识库中可执行的操作总数，包括数据集的创建、删除、更新，文档的上传、修改、归档，以及知识库查询等，用于评估知识库请求的性能。例如，Sandbox 用户在 1 分钟内连续执行 10 次命中测试，其工作区将在接下来的 1 分钟内无法继续执行以下操作：数据集的创建、删除、更新，文档的上传、修改等操作。",
    ...
    ragAPIRequestTooltip: "指单独调用 IDX 知识库数据处理能力的 API。",
  ...
  plans: {
    ...
    enterprise: {
      ...
      for: "适合大人员规模的团队",
      description:
        "对于需要组织范围内的安全性、合规性、可扩展性、控制和更高级功能的企业",
      price: "定制",
      priceTip: "仅按年计费",
      btnText: "联系销售",
