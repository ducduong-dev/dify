const translation = {
  ...
  apiKeyInfo: {
    ...
    usedToken: "使用 Tokens",
    setAPIBtn: "设置模型提供商",
    tryCloud: "或者尝试使用 IDX 的云版本并使用试用配额",
  },
  overview: {
    title: "概览",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "帮助访问者了解该应用收集的数据，可参考 IDX 的<privacyPolicyLink>隐私政策</privacyPolicyLink>。",
          customDisclaimer: "自定义免责声明",
          customDisclaimerPlaceholder: "请输入免责声明",
          customDisclaimerTip:
            "在应用中展示免责声明，可用于告知用户 AI 的局限性。",
        },
      },
      embedded: {
        entry: "嵌入",
        ...
        chromePlugin: "安装 IDX Chrome 浏览器扩展",
        copied: "已复制",
        copy: "复制",
      },
      qrcode: {
  ...
  analysis: {
    ...
    totalMessages: {
      title: "全部消息数",
      explanation:
        "反映 AI 每天的互动总次数，每回答用户一个问题算一条 Message。",
    },
    totalConversations: {
      title: "全部会话数",
    ...
    avgResponseTime: {
      title: "平均响应时间",
      explanation:
        "衡量 AI 应用处理和回复用户请求所花费的平均时间，单位为毫秒，反映性能和用户体验。仅在文本型应用提供。",
    },
    tps: {
      title: "Token 输出速度",
      explanation:
        "衡量 LLM 的性能。统计 LLM 从请求开始到输出完毕这段期间的 Tokens 输出速度。",
    },
  },
};
