const translation = {
  ...
  backToSignIn: "返回登录",
  forgotPasswordDesc:
    "请输入您的电子邮件地址以重置密码。我们将向您发送一封电子邮件，包含如何重置密码的说明。",
  ...
  license: {
    tip: "启动 IDX 社区版之前, 请阅读 GitHub 上的",
    link: "开源协议",
  },
  join: "加入 ",
  joinTipStart: "邀请你加入 ",
  ...
  resetPassword: "重置密码",
  resetPasswordDesc:
    "请输入您的电子邮件地址以重置密码。我们将向您发送一封电子邮件。",
  backToLogin: "返回登录",
  ...
  licenseExpiredTip:
    "您所在空间的 IDX Enterprise 许可证已过期，请联系管理员以继续使用 Dify。",
  licenseLost: "许可证丢失",
  licenseLostTip: "无法连接 IDX 许可证服务器，请联系管理员以继续使用 Dify。",
  licenseInactive: "许可证未激活",
  licenseInactiveTip:
    "您所在空间的 IDX Enterprise 许可证尚未激活，请联系管理员以继续使用 Dify。",
};
