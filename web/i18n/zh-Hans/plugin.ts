const translation = {
  ...
  detailPanel: {
    ...
    endpoints: "API 端点",
    endpointsTip:
      "此插件通过 API 端点提供特定功能，您可以为当前工作区配置多个 API 端点集。",
  ...
  error: {
    inValidGitHubUrl:
      "无效的 GitHub URL。请输入格式为 https://github.com/owner/repo 的有效 URL",
  ...
  marketplace: {
    ...
    viewMore: "查看更多",
    verifiedTip: "此插件由 IDX 认证",
    partnerTip: "此插件由 IDX 合作伙伴认证",
  },
  task: {
    installing: "{{installingLength}} 个插件安装中，0 已完成",
    installingWithSuccess:
      "{{installingLength}} 个插件安装中，{{successLength}} 安装成功",
    installingWithError:
      "{{installingLength}} 个插件安装中，{{successLength}} 安装成功，{{errorLength}} 安装失败",
