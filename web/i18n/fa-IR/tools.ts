const translation = {
  ...
  customToolTip: "بیشتر در مورد ابزارهای سفارشی IDX بیاموزید",
  type: {
    all: "همه",
    builtIn: "سفارشی شده",
    custom: "سفارشی",
  ...
  contribute: {
    ...
    line2: "مشارکت در ابزارهای IDX هستم.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "پس از پیکربندی اعتبارنامه‌ها، همه اعضای موجود در فضای کاری می‌توانند از این ابزار هنگام هماهنگی برنامه‌ها استفاده کنند.",
  },
  ...
  createTool: {
    ...
    nameForToolCallPlaceHolder:
      "برای شناسایی ماشین، مانند getCurrentWeather، list_pets",
    nameForToolCallTip: "فقط اعداد، حروف و خط زیر پشتیبانی می‌شود.",
    description: "توضیحات",
    descriptionPlaceholder:
      "توضیحات مختصر در مورد هدف ابزار، مثلاً، گرفتن دما برای یک مکان خاص.",
    schema: "طرح",
    ...
    authMethod: {
      ...
      type: "نوع مجوز",
      keyTooltip:
        'کلید Http Header، می‌توانید آن را با "Authorization" ترک کنید اگر نمی‌دانید چیست یا آن را به یک مقدار سفارشی تنظیم کنید',
      types: {
        none: "هیچ",
        api_key: "کلید API",
    ...
    confirmTip:
      "برنامه‌هایی که از این ابزار استفاده می‌کنند تحت تأثیر قرار خواهند گرفت",
    deleteToolConfirmTitle: "آیا این ابزار را حذف کنید؟",
    deleteToolConfirmContent:
      "حذف ابزار غیرقابل بازگشت است. کاربران دیگر قادر به دسترسی به ابزار شما نخواهند بود.",
  },
  test: {
    title: "آزمایش",
  ...
  noCustomTool: {
    ...
    content:
      "ابزارهای سفارشی خود را در اینجا اضافه و مدیریت کنید تا برنامه‌های هوش مصنوعی بسازید.",
    createTool: "ایجاد ابزار",
  },
  noSearchRes: {
    title: "متأسفیم، نتیجه‌ای پیدا نشد!",
    content:
      "ما نتوانستیم ابزارهایی که با جستجوی شما مطابقت داشته باشد پیدا کنیم.",
