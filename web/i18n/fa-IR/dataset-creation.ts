const translation = {
  ...
  stepOne: {
    ...
    notionSyncTip:
      "برای همگامسازی با Notion، ابتدا باید اتصال به Notion برقرار شود.",
    ...
    website: {
      ...
      fireCrawlNotConfiguredDescription:
        "برای استفاده از Firecrawl با کلید API پیکربندی کنید.",
      configure: "پیکربندی",
      run: "اجرا",
      firecrawlTitle: "استخراج محتوای وب با fireFirecrawl",
      firecrawlDoc: "مستندات Firecrawl",
      firecrawlDocLink:
        '<a href="https://idx-solutions.com/guides/knowledge-base/sync-from-website">https://idx-solutions.com/guides/knowledge-base/sync-from-website</a>',
      options: "گزینهها",
      ...
      extractOnlyMainContent:
        "فقط محتوای اصلی را استخراج کنید (بدون هدرها، ناوبریها، پاورقیها و غیره)",
      ...
      preview: "پیشنمایش",
      maxDepthTooltip:
        "حداکثر عمق برای خزش نسبت به URL وارد شده. عمق 0 فقط صفحه URL وارد شده را خراش میدهد، عمق 1 URL و همه چیز بعد از URL وارد شده + یک / را خراش میدهد، و غیره.",
      ...
      jinaReaderNotConfiguredDescription:
        "با وارد کردن کلید API رایگان خود برای دسترسی، Jina Reader را راه اندازی کنید.",
      useSitemapTooltip:
        "نقشه سایت را دنبال کنید تا سایت را بخزید. در غیر این صورت، Jina Reader بر اساس ارتباط صفحه به صورت تکراری می خزد و صفحات کمتر اما با کیفیت بالاتر را به دست می آورد.",
    },
    cancel: "لغو",
  },
  stepTwo: {
    ...
    auto: "خودکار",
    autoDescription:
      "به طور خودکار قوانین بخشبندی و پیشپردازش را تنظیم کنید. به کاربران ناآشنا توصیه میشود این گزینه را انتخاب کنند.",
    custom: "سفارشی",
    customDescription:
      "قوانین بخشبندی، طول بخشها و قوانین پیشپردازش را سفارشی کنید، و غیره.",
    separator: "شناسه بخش",
    ...
    overlapTip:
      "تنظیم همپوشانی بخش میتواند ارتباط معنایی بین آنها را حفظ کند و اثر بازیابی را افزایش دهد. توصیه میشود 10%-25% از حداکثر اندازه بخش تنظیم شود.",
    ...
    recommend: "توصیه شده",
    qualifiedTip:
      "رابط جاسازی سیستم پیشفرض را برای پردازش فراخوانی کنید تا دقت بالاتری هنگام پرسش کاربران فراهم شود.",
    warning: "لطفاً ابتدا کلید API ارائهدهنده مدل را تنظیم کنید.",
    click: "رفتن به تنظیمات",
    economical: "اقتصادی",
    economicalTip:
      "از موتورهای برداری آفلاین، شاخصهای کلیدواژه و غیره استفاده کنید تا دقت را بدون صرف توکنها کاهش دهید",
    ...
    sideTipP1:
      "هنگام پردازش دادههای متنی، بخشبندی و پاکسازی دو مرحله مهم پیشپردازش هستند.",
    sideTipP2:
      "بخشبندی متن طولانی را به پاراگرافها تقسیم میکند تا مدلها بهتر بتوانند آن را درک کنند. این کیفیت و ارتباط نتایج مدل را بهبود میبخشد.",
    sideTipP3:
      "پاکسازی کاراکترها و فرمتهای غیرضروری را حذف میکند و دانش را پاکتر و آسانتر برای تجزیه میکند.",
    sideTipP4:
      "بخشبندی و پاکسازی مناسب عملکرد مدل را بهبود میبخشد و نتایج دقیقتر و ارزشمندتری ارائه میدهد.",
    previewTitle: "پیشنمایش",
    previewTitleButton: "پیشنمایش",
    previewButton: "تغییر به قالب پرسش و پاسخ",
    previewSwitchTipStart:
      "پیشنمایش بخش فعلی در قالب متن است، تغییر به پیشنمایش قالب پرسش و پاسخ",
    ...
    qaSwitchHighQualityTipContent:
      "در حال حاضر، فقط روش شاخص با کیفیت بالا از تکه تکه کردن فرمت پرسش و پاسخ پشتیبانی می کند. آیا می خواهید به حالت با کیفیت بالا بروید؟",
    previewChunk: "پیش نمایش تکه",
    previewChunkCount: "{{تعداد}} تکه های تخمینی",
    previewChunkTip:
      'روی دکمه "پیش نمایش قطعه" در سمت چپ کلیک کنید تا پیش نمایش بارگیری شود',
    general: "عمومی",
    paragraphTip:
      "این حالت متن را بر اساس جداکننده ها و حداکثر طول تکه به پاراگراف ها تقسیم می کند و از متن تقسیم شده به عنوان تکه والد برای بازیابی استفاده می کند.",
    ...
    generalTip:
      "حالت تکه تکه کردن متن عمومی، تکه های بازیابی شده و فراخوانی شده یکسان هستند.",
    paragraph: "پاراگراف",
    highQualityTip:
      "پس از اتمام جاسازی در حالت کیفیت بالا، بازگشت به حالت اقتصادی در دسترس نیست.",
    parentChildTip:
      "هنگام استفاده از حالت والد-فرزند، تکه فرزند برای بازیابی و تکه والد برای یادآوری به عنوان زمینه استفاده می شود.",
    ...
    fullDocTip:
      "کل سند به عنوان تکه والد استفاده می شود و مستقیما بازیابی می شود. لطفا توجه داشته باشید که به دلایل عملکردی، متن بیش از 10000 توکن به طور خودکار کوتاه می شود.",
    qaSwitchHighQualityTipTitle:
      "فرمت پرسش و پاسخ به روش نمایه سازی با کیفیت بالا نیاز دارد",
    useQALanguage: "تکه با استفاده از فرمت پرسش و پاسخ در",
  },
  stepThree: {
    creationTitle: " دانش ایجاد شد",
    creationContent:
      "ما به طور خودکار نام دانش را تعیین کردیم، شما میتوانید هر زمان آن را تغییر دهید",
    label: "نام دانش",
    ...
    sideTipContent:
      "پس از اتمام فهرستبندی سند، دانش میتواند به عنوان زمینه در برنامه یکپارچه شود، میتوانید تنظیمات زمینه را در صفحه ارکستراسیون درخواست پیدا کنید. همچنین میتوانید آن را به عنوان یک افزونه فهرستبندی مستقل ChatGPT برای انتشار ایجاد کنید.",
    modelTitle: "آیا مطمئن هستید که میخواهید جاسازی را متوقف کنید؟",
    modelContent:
      "اگر نیاز به ادامه پردازش بعداً دارید، از جایی که متوقف شدهاید ادامه خواهید داد.",
  ...
  otherDataSource: {
    ...
    description:
      "در حال حاضر، پایگاه دانش IDX فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش IDX راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.",
