const translation = {
  ...
  buyPermissionDeniedTip:
    "لطفاً با مدیر سازمان خود تماس بگیرید تا اشتراک تهیه کنید",
  plansCommon: {
    ...
    vectorSpaceBillingTooltip:
      "هر 1 مگابایت می‌تواند حدود 1.2 میلیون کاراکتر از داده‌های وکتور شده را ذخیره کند (براساس تخمین با استفاده از OpenAI Embeddings، متفاوت بر اساس مدل‌ها).",
    vectorSpaceTooltip:
      "فضای وکتور سیستم حافظه بلند مدت است که برای درک داده‌های شما توسط LLM‌ها مورد نیاز است.",
    documentsUploadQuota: "سهمیه بارگذاری مستندات",
    documentProcessingPriority: "اولویت پردازش مستندات",
    documentProcessingPriorityTip:
      "برای اولویت پردازش بالاتر مستندات، لطفاً طرح خود را ارتقاء دهید.",
    documentProcessingPriorityUpgrade:
      "داده‌های بیشتری را با دقت بالاتر و سرعت بیشتر پردازش کنید.",
    priority: {
      standard: "استاندارد",
      priority: "اولویت",
    ...
    supportItems: {
      ...
      llmLoadingBalancingTooltip:
        "اضافه کردن چندین کلید API به مدل‌ها، به طور مؤثر از محدودیت‌های نرخ API عبور می‌کند.",
    },
    comingSoon: "به زودی",
    member: "عضو",
    memberAfter: "عضو",
    messageRequest: {
      title: "اعتبارات پیام",
      tooltip:
        "سهمیه‌های فراخوانی پیام برای طرح‌های مختلف با استفاده از مدل‌های OpenAI (به جز gpt4). پیام‌های بیش از حد محدودیت از کلید API OpenAI شما استفاده می‌کنند.",
    },
    annotatedResponse: {
      title: "محدودیت‌های سهمیه حاشیه‌نویسی",
      tooltip:
        "ویرایش دستی و حاشیه‌نویسی پاسخ‌ها، قابلیت‌های پرسش و پاسخ با کیفیت بالا و قابل تنظیم برای اپلیکیشن‌ها را فراهم می‌کند. (فقط در اپلیکیشن‌های چت اعمال می‌شود)",
    },
    ragAPIRequestTooltip:
      "به تعداد درخواست‌های API که فقط قابلیت‌های پردازش پایگاه دانش IDX را فراخوانی می‌کنند اشاره دارد.",
    receiptInfo:
      "فقط صاحب تیم و مدیر تیم می‌توانند اشتراک تهیه کنند و اطلاعات صورتحساب را مشاهده کنند",
  },
  plans: {
    sandbox: {
      name: "محیط آزمایشی",
    ...
    professional: {
      name: "حرفه‌ای",
      description:
        "برای افراد و تیم‌های کوچک برای باز کردن قدرت بیشتر به طور مقرون به صرفه.",
    ...
    enterprise: {
      name: "سازمانی",
      description:
        "دریافت کامل‌ترین قابلیت‌ها و پشتیبانی برای سیستم‌های بزرگ و بحرانی.",
