const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "تنظیم حداکثر توکن شما بالاست، که ممکن است فضا را برای راهنماها، پرس و جوها و داده‌ها محدود کند. در نظر بگیرید آن را زیر 2/3 تنظیم کنید.",
      setToCurrentModelMaxTokenTip:
        "حداکثر توکن به 80٪ حداکثر توکن مدل فعلی {{maxToken}} به‌روزرسانی شد.",
      stop_sequences: "توالی‌های توقف",
      stop_sequencesTip:
        "حداکثر چهار توالی که API تولید توکن‌های بیشتر را متوقف می‌کند. متن برگردانده شده شامل توالی توقف نخواهد بود.",
  ...
  menus: {
    ...
    plugins: "افزونه‌ها",
    pluginsTips:
      "افزونه‌های شخص ثالث را ادغام کنید یا افزونه‌های هوش مصنوعی سازگار با ChatGPT ایجاد کنید.",
    datasets: "دانش",
    datasetsTips:
      "به زودی: داده‌های متنی خود را وارد کنید یا از طریق Webhook داده‌ها را در زمان واقعی برای بهبود زمینه LLM بنویسید.",
    newApp: "برنامه جدید",
  ...
  account: {
    ...
    password: "رمز عبور",
    passwordTip:
      "اگر نمی‌خواهید از کدهای ورود موقت استفاده کنید، می‌توانید یک رمز عبور دائمی تنظیم کنید",
    ...
    langGeniusAccount: "حساب IDX",
    langGeniusAccountTip: "حساب IDX شما و داده‌های کاربری مرتبط.",
    editName: "ویرایش نام",
    showAppLength: "نمایش {{length}} برنامه",
    delete: "حذف حساب کاربری",
    deleteTip:
      "حذف حساب کاربری شما تمام داده‌های شما را به طور دائمی پاک می‌کند و قابل بازیابی نیست.",
    deleteConfirmTip:
      "برای تأیید، لطفاً موارد زیر را از ایمیل ثبت‌نام شده خود به این آدرس ارسال کنید ",
    account: "حساب",
    myAccount: "حساب من",
    studio: "استودیو IDX",
    ...
    deleteSuccessTip:
      "حساب شما برای پایان دادن به حذف به زمان نیاز دارد. وقتی همه چیز تمام شد به شما ایمیل خواهیم زد.",
    deletePrivacyLinkTip:
      "برای کسب اطلاعات بیشتر در مورد نحوه مدیریت داده های شما، لطفا به ما مراجعه کنید",
  ...
  members: {
    ...
    inviteTeamMemberTip:
      "آنها می‌توانند پس از ورود به سیستم، مستقیماً به داده‌های تیم شما دسترسی پیدا کنند.",
    emailNotSetup:
      "سرور ایمیل راه‌اندازی نشده است، بنابراین ایمیل‌های دعوت نمی‌توانند ارسال شوند. لطفاً کاربران را از لینک دعوت که پس از دعوت صادر خواهد شد مطلع کنید。",
    email: "ایمیل",
    ...
    invitationSentTip:
      "دعوت‌نامه ارسال شد و آنها می‌توانند وارد IDX شوند تا به داده‌های تیم شما دسترسی پیدا کنند.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "سرویس میزبانی OpenAI ارائه شده توسط IDX به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهندگان مدل را تنظیم کنید.",
    ...
    anthropicHosted: {
      ...
      close: "بستن",
      trialQuotaTip:
        "سهمیه آزمایشی Anthropic شما در تاریخ 2025/03/11 منقضی می شود و پس از آن دیگر در دسترس نخواهد بود. لطفا به موقع از آن استفاده کنید.",
    },
    anthropic: {
      using: "قابلیت تعبیه از این استفاده می‌کند",
      enableTip:
        "برای فعال‌سازی مدل Anthropic، ابتدا باید به OpenAI یا سرویس Azure OpenAI متصل شوید.",
  ...
  modelProvider: {
    notConfigured:
      "مدل سیستم هنوز به طور کامل پیکربندی نشده است و برخی از عملکردها ممکن است در دسترس نباشند.",
    ...
    item: {
      deleteDesc:
        "{{modelName}} به عنوان مدل‌های استدلال سیستم استفاده می‌شوند. برخی از عملکردها پس از حذف در دسترس نخواهند بود. لطفاً تأیید کنید.",
    ...
    providerManagedDescription:
      "استفاده از مجموعه واحد اعتبارنامه ارائه شده توسط ارائه‌دهنده مدل.",
    defaultConfig: "پیکربندی پیش‌فرض",
    apiKeyStatusNormal: "وضعیت کلید API عادی است",
    apiKeyRateLimit:
      "محدودیت نرخ به دست آمد، پس از {{seconds}} ثانیه در دسترس خواهد بود",
    addConfig: "افزودن پیکربندی",
    editConfig: "ویرایش پیکربندی",
    loadBalancingLeastKeyWarning:
      "برای فعال کردن تعادل بار، حداقل 2 کلید باید فعال باشند.",
    loadBalancingInfo:
      "به طور پیش‌فرض، تعادل بار از استراتژی Round-robin استفاده می‌کند. اگر محدودیت نرخ فعال شود، یک دوره خنک شدن 1 دقیقه‌ای اعمال خواهد شد.",
    ...
    configureTip:
      "api-key را راه اندازی کنید یا مدل را برای استفاده اضافه کنید",
  ...
  apiBasedExtension: {
    title:
      "افزونه‌های مبتنی بر API مدیریت متمرکز API را فراهم می‌کنند و پیکربندی را برای استفاده آسان در برنامه‌های IDX ساده می‌کنند.",
  ...
  about: {
    ...
    nowAvailable: "IDX {{version}} اکنون در دسترس است.",
    latestAvailable: "IDX {{version}} آخرین نسخه در دسترس است.",
  },
  appMenus: {
    overview: "نظارت",
  ...
  datasetMenus: {
    ...
    settings: "تنظیمات",
    emptyTip:
      "دانش مرتبط نشده است، لطفاً به برنامه یا افزونه بروید تا ارتباط را کامل کنید.",
  ...
  promptEditor: {
    placeholder:
      "دستور خود را اینجا بنویسید، «{» را وارد کنید تا یک متغیر درج کنید، «/» را وارد کنید تا یک بلوک محتوای دستور درج کنید",
    context: {
      item: {
        title: "زمینه",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "خواندن تصویر ناموفق بود، لطفاً دوباره تلاش کنید.",
    uploadFromComputerUploadError:
      "بارگذاری تصویر ناموفق بود، لطفاً دوباره بارگذاری کنید.",
    uploadFromComputerLimit:
      "بارگذاری تصاویر نمی‌تواند از {{size}} مگابایت بیشتر باشد",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "خواندن فایل انجام نشد، لطفا دوباره امتحان کنید.",
    uploadFromComputerUploadError:
      "آپلود فایل انجام نشد، لطفا دوباره آپلود کنید.",
