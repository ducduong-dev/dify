const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "سهمیه آزمایشی برای اهداف تست شما ارائه شده است. قبل از اینکه سهمیه آزمایشی تمام شود، لطفاً ارائه‌دهنده مدل خود را تنظیم کنید یا سهمیه اضافی خریداری کنید.",
      },
      exhausted: {
        title:
          "سهمیه آزمایشی شما تمام شده است، لطفاً کلید API خود را تنظیم کنید.",
        description:
          "شما سهمیه آزمایشی خود را مصرف کرده‌اید. لطفاً ارائه‌دهنده مدل خود را تنظیم کنید یا سهمیه اضافی خریداری کنید.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "یا نسخه ابری IDX با سهمیه رایگان را امتحان کنید",
  },
  overview: {
    title: "نمای کلی",
    appInfo: {
      ...
      settings: {
        ...
        webDescTip:
          "این متن در سمت مشتری نمایش داده می‌شود و راهنمایی‌های اولیه در مورد نحوه استفاده از برنامه را ارائه می‌دهد",
        ...
        more: {
          ...
          privacyPolicyTip:
            "به بازدیدکنندگان کمک می‌کند تا بفهمند برنامه چه داده‌هایی را جمع‌آوری می‌کند، به سیاست حفظ حریم خصوصی IDX نگاه کنید <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.",
          customDisclaimer: "سلب مسئولیت سفارشی",
          customDisclaimerPlaceholder: "متن سلب مسئولیت سفارشی را وارد کنید",
          customDisclaimerTip:
            "متن سلب مسئولیت سفارشی در سمت مشتری نمایش داده می‌شود و اطلاعات بیشتری درباره برنامه ارائه می‌دهد",
      ...
      embedded: {
        ...
        iframe:
          "برای افزودن برنامه چت در هرجای وب‌سایت خود، این iframe را به کد HTML خود اضافه کنید.",
        scripts:
          "برای افزودن برنامه چت به گوشه پایین سمت راست وب‌سایت خود، این کد را به HTML خود اضافه کنید.",
        chromePlugin: "نصب افزونه Chrome Chatbot IDX",
        copied: "کپی شد",
        copy: "کپی",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "شما می‌توانید ظاهر جلویی برنامه وب را برای برآوردن نیازهای سناریو و سبک خود سفارشی کنید.",
        way1: {
          ...
          step1Tip:
            "برای شاخه کردن کد منبع به حساب GitHub خود و تغییر کد اینجا کلیک کنید",
  ...
  analysis: {
    ...
    totalConversations: {
      title: "کل مکالمات",
      explanation:
        "تعداد مکالمات روزانه با هوش مصنوعی؛ مهندسی/اشکال‌زدایی پرامپت مستثنی است.",
    },
    activeUsers: {
      title: "کاربران فعال",
      explanation:
        "کاربران منحصر به فردی که در پرسش و پاسخ با AI شرکت می‌کنند؛ مهندسی/اشکال‌زدایی دستورات مستثنی هستند.",
    },
    tokenUsage: {
      title: "استفاده از توکن",
      explanation:
        "مصرف روزانه توکن‌های مدل زبان برای برنامه را نشان می‌دهد، که برای کنترل هزینه‌ها مفید است.",
      consumed: "مصرف‌شده",
    },
    avgSessionInteractions: {
      title: "میانگین تعاملات جلسه",
      explanation:
        "تعداد تعاملات پیوسته کاربر-AI؛ برای برنامه‌های مبتنی بر گفتگو.",
    },
    avgUserInteractions: {
      title: "میانگین تعاملات کاربران",
      explanation:
        "تکرار استفاده روزانه کاربران را نشان می‌دهد. این معیار چسبندگی کاربران را نشان می‌دهد.",
    },
    userSatisfactionRate: {
      title: "نرخ رضایت کاربران",
      explanation:
        "تعداد لایک‌ها به ازای هر ۱۰۰۰ پیام. این نشان‌دهنده نسبت پاسخ‌هایی است که کاربران به شدت رضایت دارند.",
    },
    avgResponseTime: {
      title: "میانگین زمان پاسخ",
      explanation:
        "زمان (میلی‌ثانیه) برای پردازش/پاسخ AI؛ برای برنامه‌های مبتنی بر متن.",
    },
    tps: {
      title: "سرعت خروجی توکن",
      explanation:
        "عملکرد مدل زبان بزرگ را اندازه‌گیری می‌کند. سرعت خروجی توکن‌های مدل زبان بزرگ از آغاز درخواست تا تکمیل خروجی را بشمارید.",
    },
  },
};
