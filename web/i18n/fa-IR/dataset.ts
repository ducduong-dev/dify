const translation = {
  ...
  createDatasetIntro:
    "داده‌های متنی خود را وارد کنید یا از طریق Webhook در زمان واقعی برای بهبود زمینه LLM بنویسید.",
  ...
  datasetUsedByApp:
    "دانش توسط برخی برنامه‌ها استفاده می‌شود. برنامه‌ها دیگر نمی‌توانند از این دانش استفاده کنند و تمام تنظیمات درخواست و گزارش‌ها به طور دائم حذف خواهند شد.",
  datasetDeleted: "دانش حذف شد",
  datasetDeleteFailed: "حذف دانش ناموفق بود",
  didYouKnow: "آیا می‌دانستید؟",
  intro1: "دانش می‌تواند در برنامه IDX ",
  ...
  unavailableTip:
    "مدل جاسازی در دسترس نیست، نیاز است مدل جاسازی پیش‌فرض پیکربندی شود",
  datasets: "دانش",
  ...
  retrieval: {
    semantic_search: {
      title: "جستجوی برداری",
      description:
        "تولید جاسازی‌های جستجو و جستجوی بخش متنی که بیشترین شباهت را به نمایش برداری آن دارد.",
    },
    full_text_search: {
      title: "جستجوی متن کامل",
      description:
        "فهرست کردن تمام اصطلاحات در سند، به کاربران اجازه می‌دهد هر اصطلاحی را جستجو کنند و بخش متنی مربوط به آن اصطلاحات را بازیابی کنند.",
    },
    hybrid_search: {
      title: "جستجوی هیبریدی",
      description:
        "جستجوی متن کامل و برداری را همزمان اجرا می‌کند، دوباره رتبه‌بندی می‌کند تا بهترین تطابق برای درخواست کاربر انتخاب شود. کاربران می‌توانند وزن‌ها را تنظیم کنند یا به یک مدل دوباره رتبه‌بندی تنظیم کنند.",
      recommend: "توصیه",
    },
    invertedIndex: {
      title: "فهرست معکوس",
      description:
        "فهرست معکوس یک ساختار برای بازیابی کارآمد است. توسط اصطلاحات سازماندهی شده، هر اصطلاح به اسناد یا صفحات وب حاوی آن اشاره می‌کند.",
    },
    change: "تغییر",
  ...
  mixtureHighQualityAndEconomicTip:
    "مدل دوباره رتبه‌بندی برای ترکیب پایگاه‌های دانش با کیفیت بالا و اقتصادی لازم است.",
  inconsistentEmbeddingModelTip:
    "مدل دوباره رتبه‌بندی لازم است اگر مدل‌های جاسازی پایگاه‌های دانش انتخابی ناسازگار باشند.",
  retrievalSettings: "تنظیمات بازیابی",
  rerankSettings: "تنظیمات دوباره رتبه‌بندی",
  weightedScore: {
    title: "امتیاز وزنی",
    description:
      "با تنظیم وزن‌های اختصاص داده شده، این استراتژی دوباره رتبه‌بندی تعیین می‌کند که آیا اولویت با تطابق معنایی یا کلمات کلیدی است.",
  ...
  nTo1RetrievalLegacy:
    "بازیابی N-to-1 از سپتامبر به طور رسمی منسوخ خواهد شد. توصیه می‌شود از بازیابی چند مسیر جدید استفاده کنید تا نتایج بهتری بدست آورید.",
  nTo1RetrievalLegacyLink: "بیشتر بدانید",
  nTo1RetrievalLegacyLinkText:
    " بازیابی N-to-1 از سپتامبر به طور رسمی منسوخ خواهد شد.",
  defaultRetrievalTip:
    "بازیابی چند مسیره به طور پیش فرض استفاده می شود. دانش از چندین پایگاه دانش بازیابی می شود و سپس دوباره رتبه بندی می شود.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "برای اتصال به یک پایگاه دانش خارجی، ابتدا باید یک API خارجی ایجاد کنید. لطفا با دقت بخوانید و به",
  ...
  connectHelper: {
    ...
    helper1:
      "از طریق API و شناسه پایگاه دانش به پایگاه های دانش خارجی متصل شوید. در حال حاضر،",
  },
  ...
  externalKnowledgeDescriptionPlaceholder:
    "آنچه در این پایگاه دانش وجود دارد را توضیح دهید (اختیاری)",
  externalKnowledgeDescription: "توضیحات دانش",
  externalTag: "خارجی",
  externalKnowledgeIdPlaceholder: "لطفا شناسه دانش را وارد کنید",
  noExternalKnowledge:
    "هنوز هیچ API دانش خارجی وجود ندارد، برای ایجاد اینجا را کلیک کنید",
  ...
  learnHowToWriteGoodKnowledgeDescription:
    "یاد بگیرید که چگونه یک توضیحات دانش خوب بنویسید.",
  editExternalAPIFormTitle: "ویرایش API دانش خارجی",
  externalAPIPanelDescription:
    "API دانش خارجی برای اتصال به یک پایگاه دانش خارج از IDX و بازیابی دانش از آن پایگاه دانش استفاده می شود.",
  allExternalTip:
    "هنگامی که فقط از دانش خارجی استفاده می کنید، کاربر می تواند انتخاب کند که آیا مدل Rerank را فعال کند یا خیر. اگر فعال نباشد، تکه های بازیابی شده بر اساس امتیازات مرتب می شوند. هنگامی که استراتژی های بازیابی پایگاه های دانش مختلف متناقض باشد، نادرست خواهد بود.",
  mixtureInternalAndExternalTip:
    "مدل Rerank برای آمیختگی دانش درونی و بیرونی مورد نیاز است.",
  chunkingMode: {
  ...
  allKnowledgeDescription:
    "برای نمایش تمام دانش در این فضای کاری انتخاب کنید. فقط مالک فضای کاری می تواند تمام دانش را مدیریت کند.",
};
