const translation = {
  ...
  welcome: "به IDX خوش آمدید، لطفا برای ادامه وارد شوید.",
  email: "آدرس ایمیل",
  ...
  setAdminAccountDesc:
    "بیشترین امتیازات برای حساب مدیر، که می‌تواند برای ایجاد برنامه‌ها و مدیریت ارائه‌دهندگان LLM و غیره استفاده شود.",
  createAndSignIn: "ایجاد و ورود",
  oneMoreStep: "یک مرحله دیگر",
  createSample:
    "بر اساس این اطلاعات، ما برای شما یک نمونه برنامه ایجاد خواهیم کرد",
  ...
  go: "برو به Dify",
  sendUsMail:
    "ایمیل معرفی خود را برای ما ارسال کنید، و ما درخواست دعوت را بررسی خواهیم کرد.",
  ...
  rightDesc:
    "به راحتی برنامه‌های AI با ظاهری جذاب، قابل اجرا و بهبود پذیر ایجاد کنید.",
  tos: "شرایط خدمات",
  ...
  forgotPasswordDesc:
    "لطفاً آدرس ایمیل خود را وارد کنید تا رمز عبور خود را بازنشانی کنید. ما یک ایمیل با دستورالعمل‌های بازنشانی برای شما ارسال خواهیم کرد.",
  checkEmailForResetLink:
    "لطفاً ایمیل خود را برای لینک بازنشانی رمز عبور بررسی کنید. اگر در عرض چند دقیقه ظاهر نشد، پوشه اسپم خود را بررسی کنید.",
  ...
  error: {
    ...
    passwordInvalid:
      "رمز عبور باید شامل حروف و اعداد باشد و طول آن بیشتر از ۸ کاراکتر باشد",
    registrationNotAllowed:
      "حساب پیدا نشد. لطفا برای ثبت نام با مدیر سیستم تماس حاصل فرمایید.",
  },
  license: {
    tip: "قبل از شروع IDX Community Edition، GitHub را بخوانید",
    link: "مجوز منبع باز",
  },
  join: "عضویت",
  ...
  noLoginMethodTip:
    "لطفا برای افزودن روش احراز هویت با مدیر سیستم تماس بگیرید.",
  resetPasswordDesc:
    "ایمیلی را که برای ثبت نام در IDX استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.",
  licenseInactive: "مجوز غیر فعال",
  licenseLost: "مجوز گم شده است",
  licenseExpired: "مجوز منقضی شده است",
  licenseExpiredTip:
    "مجوز IDX Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از IDX با سرپرست خود تماس بگیرید.",
  licenseInactiveTip:
    "مجوز IDX Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از IDX با سرپرست خود تماس بگیرید.",
  licenseLostTip:
    "اتصال سرور مجوز IDX انجام نشد. لطفا برای ادامه استفاده از IDX با سرپرست خود تماس بگیرید.",
};
