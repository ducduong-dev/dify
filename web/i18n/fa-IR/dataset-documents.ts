const translation = {
  list: {
    title: "اسناد",
    desc: "تمامی فایل‌های دانش در اینجا نمایش داده می‌شوند و کل دانش می‌تواند به ارجاعات IDX متصل شود یا از طریق افزونه چت ایندکس شود.",
    ...
    empty: {
      ...
      sync: {
        tip: "IDX به‌طور دوره‌ای فایل‌ها را از Notion شما دانلود و پردازش را کامل می‌کند.",
      },
    },
    delete: {
      title: "آیا مطمئن هستید که حذف شود؟",
      content:
        "اگر بعداً نیاز به ادامه پردازش داشتید، از همان جایی که مانده بودید ادامه می‌دهید",
    },
    batchModal: {
  ...
  metadata: {
    ...
    docTypeSelectWarning:
      "اگر نوع سند تغییر کند، متادیتای پر شده فعلی دیگر حفظ نخواهد شد",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "بازآفرینی تکه های فرزند تکه های فرزند فعلی، از جمله تکه های ویرایش شده و تکه های تازه اضافه شده را بازنویسی می کند. بازسازی را نمی توان خنثی کرد.",
