const translation = {
  ...
  createDatasetIntro:
    "Importați-vă propriile date text sau scrieți date în timp real prin Webhook pentru îmbunătățirea contextului LLM.",
  ...
  datasetUsedByApp:
    "Cunoștințele sunt utilizate de unele aplicații. Aplicațiile nu vor mai putea utiliza aceste Cunoștințe, iar toate configurațiile de prompt și jurnalele vor fi șterse definitiv.",
  datasetDeleted: "Cunoștințe șterse",
  datasetDeleteFailed: "Eșec la ștergerea Cunoștințelor",
  didYouKnow: "Știați că?",
  intro1: "Cunoștințele pot fi integrate în aplicația IDX ",
  ...
  unavailableTip:
    "Modelul de încorporare nu este disponibil, modelul de încorporare implicit trebuie configurat",
  datasets: "CUNOȘTINȚE",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "Generați încorporările interogărilor și căutați bucata de text cea mai similară cu reprezentarea sa vectorială.",
    },
    full_text_search: {
      title: "Căutare Full-Text",
      description:
        "Indexați toți termenii din document, permițând utilizatorilor să caute orice termen și să recupereze bucățile de text relevante care conțin acei termeni.",
    },
    hybrid_search: {
      title: "Căutare Hibridă",
      description:
        "Executați căutări full-text și căutări vectoriale în același timp, reclasificați pentru a selecta cea mai bună potrivire pentru interogarea utilizatorului. Configurarea API-ului modelului Rerank este necesară.",
  ...
  mixtureHighQualityAndEconomicTip:
    "Modelul de reclasificare este necesar pentru amestecul de baze de cunoștințe de înaltă calitate și economice.",
  ...
  weightedScore: {
    title: "Scor ponderat",
    description:
      "Prin ajustarea ponderilor atribuite, această strategie de reclasificare determină dacă să prioritizeze potrivirea semantică sau pe cea a cuvintelor cheie.",
  ...
  nTo1RetrievalLegacy:
    "Recuperarea N-la-1 va fi oficial depreciată din septembrie. Se recomandă utilizarea celei mai recente recuperări cu căi multiple pentru a obține rezultate mai bune.",
  nTo1RetrievalLegacyLink: "Află mai multe",
  nTo1RetrievalLegacyLinkText:
    "Recuperarea N-la-1 va fi oficial depreciată în septembrie.",
  defaultRetrievalTip:
    "Recuperarea pe mai multe căi este utilizată în mod implicit. Cunoștințele sunt preluate din mai multe baze de cunoștințe și apoi reclasificate.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "Pentru a vă conecta la o bază de cunoștințe externă, trebuie mai întâi să creați un API extern. Vă rugăm să citiți cu atenție și să consultați",
    },
  ...
  connectHelper: {
    ...
    helper1:
      "Conectați-vă la baze de cunoștințe externe prin API și ID-ul bazei de cunoștințe. În prezent,",
  },
  ...
  externalKnowledgeDescriptionPlaceholder:
    "Descrieți ce este în această bază de cunoștințe (opțional)",
  externalAPI: "API extern",
  learnHowToWriteGoodKnowledgeDescription:
    "Aflați cum să scrieți o descriere bună a cunoștințelor",
  externalAPIPanelTitle: "API de cunoștințe externe",
  allExternalTip:
    "Când utilizează numai cunoștințe externe, utilizatorul poate alege dacă să activeze modelul Rerank. Dacă nu este activată, bucățile preluate vor fi sortate pe baza scorurilor. Când strategiile de recuperare a diferitelor baze de cunoștințe sunt inconsistente, acestea vor fi inexacte.",
  externalKnowledgeNamePlaceholder:
    "Vă rugăm să introduceți numele bazei de cunoștințe",
  externalAPIPanelDocumentation:
    "Aflați cum să creați un API de cunoștințe externe",
  ...
  noExternalKnowledge:
    "Nu există încă un API de cunoștințe externe, faceți clic aici pentru a crea",
  externalKnowledgeId: "ID de cunoștințe extern",
  editExternalAPITooltipTitle: "CUNOȘTINȚE LEGATE",
  mixtureInternalAndExternalTip:
    "Modelul Rerank este necesar pentru amestecul de cunoștințe interne și externe.",
  externalAPIPanelDescription:
    "API-ul de cunoștințe externe este utilizat pentru a se conecta la o bază de cunoștințe din afara IDX și pentru a prelua cunoștințe din acea bază de cunoștințe.",
  ...
  documentsDisabled:
    "{{num}} documente dezactivate - inactive de peste 30 de zile",
  ...
  allKnowledgeDescription:
    "Selectați pentru a afișa toate cunoștințele din acest spațiu de lucru. Doar proprietarul spațiului de lucru poate gestiona toate cunoștințele.",
};
