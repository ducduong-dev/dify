const translation = {
  ...
  contribute: {
    ...
    line2: "contribui la IDX cu instrumente.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "După configurarea credențialelor, toți membrii din spațiul de lucru pot utiliza acest instrument la orchestrarea aplicațiilor.",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      keyTooltip:
        'Cheie antet HTTP, puteți lăsa "Autorizare" dacă nu știți ce este sau setați-o la o valoare personalizată',
      types: {
        none: "Niciuna",
        api_key: "Cheie API",
    ...
    privacyPolicyPlaceholder:
      "Vă rugăm să introduceți politica de confidențialitate",
    deleteToolConfirmTitle: "Ștergeți această unealtă?",
    deleteToolConfirmContent:
      " Ștergerea uneltă este irreversibilă. Utilizatorii nu vor mai putea accesa uneltă dvs.",
    toolInput: {
    ...
    descriptionPlaceholder:
      "Scurtă descriere a scopului instrumentului, de exemplu, obțineți temperatura pentru o anumită locație.",
    ...
    nameForToolCallPlaceHolder:
      "Utilizat pentru recunoașterea mașinii, cum ar fi getCurrentWeather, list_pets",
    ...
    customDisclaimerPlaceholder:
      "Vă rugăm să introduceți declinarea responsabilității personalizate",
    nameForToolCallTip:
  ...
  noCustomTool: {
    ...
    content:
      "Adăugați și gestionați aici instrumentele personalizate pentru construirea aplicațiilor AI.",
    createTool: "Creează Instrument",
  },
  noSearchRes: {
    title: "Ne pare rău, nu s-au găsit rezultate!",
    content:
      "Nu am putut găsi niciun instrument care să se potrivească căutării dvs.",
  ...
  toolNameUsageTip:
    "Numele de apel al instrumentului pentru raționamentul și solicitarea agentului",
