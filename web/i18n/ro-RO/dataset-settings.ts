const translation = {
  ...
  form: {
    ...
    descInfo:
      "Vă rugăm să scrieți o descriere textuală clară pentru a contura conținutul cunoștințelor. Această descriere va fi utilizată ca bază pentru potrivire atunci când se selectează din mai multe cunoștințe pentru inferență.",
    descPlaceholder:
      "Descrieți ce se află în aceste cunoștințe. O descriere detaliată permite AI să acceseze conținutul cunoștințelor într-un timp oportun. Dacă este gol, IDX va folosi strategia implicită.",
    ...
    indexMethodHighQualityTip:
      "Invocă modelul Embedding pentru procesare pentru a oferi o acuratețe mai mare la interogările utilizatorilor.",
    indexMethodEconomy: "Economică",
    indexMethodEconomyTip:
      "Utilizați motoare de vectori offline, indexuri de cuvinte cheie etc. pentru a reduce acuratețea fără a cheltui jetoane",
    ...
    retrievalSetting: {
      ...
      longDescription:
        " despre metoda de recuperare, o puteți schimba în orice moment în setările cunoștințelor.",
    },
    save: "Salvare",
    ...
    indexMethodChangeToEconomyDisabledTip:
      "Nu este disponibil pentru retrogradarea de la HQ la ECO",
    upgradeHighQualityTip:
      "După ce faceți upgrade la modul Înaltă calitate, revenirea la modul Economic nu este disponibilă",
