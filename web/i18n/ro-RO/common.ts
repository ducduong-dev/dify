const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Setarea jetoanelor maxime este ridicată, limitând potențial spațiul pentru prompturi, interogări și date. Luați în considerare setarea acesteia la sub 2/3.",
      setToCurrentModelMaxTokenTip:
        "Jetoanele maxime sunt actualizate la 80% din jetoanele maxime ale modelului curent {{maxToken}}.",
      stop_sequences: "Secvențe de oprire",
      stop_sequencesTip:
        "Până la patru secvențe în care API-ul va înceta să genereze mai multe jetoane. Textul returnat nu va conține secvența de oprire.",
  ...
  menus: {
    ...
    plugins: "Plugin-uri",
    pluginsTips:
      "Integrați plugin-uri terțe părți sau creați AI-Plugin-uri compatibile cu ChatGPT.",
    datasets: "Cunoștințe",
    datasetsTips:
      "CURÂND DISPONIBIL: Importați-vă propriile date text sau scrieți date în timp real prin Webhook pentru îmbunătățirea contextului LLM.",
  ...
  account: {
    ...
    password: "Parolă",
    passwordTip:
      "Puteți seta o parolă permanentă dacă nu doriți să utilizați coduri de conectare temporare",
    ...
    langGeniusAccountTip: "Contul IDX și datele de utilizator asociate.",
    ...
    deletePrivacyLinkTip:
      "Pentru mai multe informații despre modul în care gestionăm datele dvs., vă rugăm să consultați",
    deletePrivacyLink: "Politica de confidențialitate.",
    deleteSuccessTip:
      "Contul tău are nevoie de timp pentru a termina ștergerea. Vă vom trimite un e-mail când totul este gata.",
    deleteLabel:
      "Pentru a confirma, vă rugăm să introduceți adresa de e-mail mai jos",
  ...
  members: {
    ...
    emailNotSetup:
      "Serverul de e-mail nu este configurat, astfel încât e-mailurile de invitație nu pot fi trimise. Vă rugăm să notificați utilizatorii despre linkul de invitație care va fi emis după invitație.",
    email: "Email",
    ...
    invitationSentTip:
      "Invitația a fost trimisă și pot să se autentifice în IDX pentru a accesa datele echipei dvs.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Această CHEIE API nu are cotă disponibilă, vă rugăm să citiți",
    addKey: "Adaugă cheie",
    ...
    azure: {
      apiBase: "Bază API",
      apiBasePlaceholder:
        "URL-ul de bază al API-ului pentru punctul final Azure OpenAI.",
      apiKey: "Cheie API",
    ...
    openaiHosted: {
      ...
      desc: "Serviciul de găzduire OpenAI furnizat de IDX vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.",
      callTimes: "Apeluri",
      usedUp:
        "Cota de probă a fost epuizată. Adăugați propriul furnizor de modele.",
    ...
    anthropicHosted: {
      ...
      close: "Închide",
      trialQuotaTip:
        "Cota de încercare Anthropic va expira pe 11.03.2025 și nu va mai fi disponibilă ulterior. Vă rugăm să o utilizați la timp.",
    },
    anthropic: {
      using: "Capacitatea de încorporare utilizează",
      enableTip:
        "Pentru a activa modelul Anthropic, trebuie să vă legați mai întâi la OpenAI sau la serviciul Azure OpenAI.",
  ...
  modelProvider: {
    notConfigured:
      "Modelul de sistem nu a fost încă configurat complet, iar unele funcții pot fi indisponibile.",
    systemModelSettings: "Setări model de sistem",
    systemModelSettingsLink:
      "De ce este necesar să se configureze un model de sistem?",
    ...
    item: {
      deleteDesc:
        "{{modelName}} sunt utilizate ca modele de raționare a sistemului. Unele funcții nu vor fi disponibile după eliminare. Vă rugăm să confirmați.",
    ...
    loadBalancingInfo:
      "În mod implicit, echilibrarea încărcării utilizează strategia Round-robin. Dacă se declanșează limitarea ratei, se va aplica o perioadă de reactivare de 1 minut.",
    loadBalancing: "Echilibrare",
    apiKeyRateLimit:
      "Limita de viteză a fost atinsă, disponibilă după {{secunde}}s",
    providerManaged: "Gestionat de furnizor",
    providerManagedDescription:
      "Utilizați setul unic de acreditări furnizat de furnizorul de modele.",
  ...
  dataSource: {
    ...
    website: {
      inactive: "Inactiv",
      description:
        "Importați conținut de pe site-uri web folosind crawlerul web.",
      active: "Activ",
      with: "Cu",
      title: "Site-ul web",
  ...
  apiBasedExtension: {
    title:
      "Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Dify.",
  ...
  datasetMenus: {
    ...
    settings: "Setări",
    emptyTip:
      "Cunoștințele nu au fost asociate, vă rugăm să mergeți la aplicație sau la plug-in pentru a finaliza asocierea.",
  ...
  promptEditor: {
    placeholder:
      "Scrieți aici prompt-ul, introduceți '{}' pentru a insera o variabilă, introduceți '/' pentru a insera un bloc de conținut prompt",
    context: {
      item: {
        title: "Context",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Citirea imaginii a eșuat, vă rugăm încercați din nou.",
    uploadFromComputerUploadError:
      "Încărcarea imaginii a eșuat, vă rugăm încărcați din nou.",
  ...
  fileUploader: {
    uploadFromComputerReadError:
      "Citirea fișierului a eșuat, vă rugăm să încercați din nou.",
    ...
    uploadFromComputerUploadError:
      "Încărcarea fișierului a eșuat, vă rugăm să încărcați din nou.",
