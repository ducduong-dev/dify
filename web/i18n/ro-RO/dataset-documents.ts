const translation = {
  list: {
    title: "Documente",
    desc: "Toate fișierele din Cunoștințe sunt afișate aici, iar întreaga Cunoaștere poate fi legată de citări IDX sau indexată prin intermediul pluginului Chat.",
  ...
  segment: {
    ...
    regeneratingMessage:
      "Acest lucru poate dura un moment, vă rugăm să așteptați...",
    parentChunks_one: "FRAGMENT PĂRINTE",
    regenerationConfirmMessage:
      "Regenerarea bucăților copii va suprascrie bucățile copil curente, inclusiv bucățile editate și bucățile nou adăugate. Regenerarea nu poate fi anulată.",
