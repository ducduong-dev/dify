const translation = {
  ...
  welcome:
    "Bine ai venit la Dify, te rugăm să te autentifici pentru a continua.",
  ...
  setAdminAccountDesc:
    "Privilegii maxime pentru contul de administrator, care poate fi utilizat pentru crearea de aplicații și gestionarea furnizorilor LLM, etc.",
  createAndSignIn: "Creează și autentifică-te",
  oneMoreStep: "Un pas în plus",
  createSample:
    "Pe baza acestor informații, vom crea o aplicație de exemplu pentru tine",
  ...
  go: "Mergi la Dify",
  sendUsMail:
    "Trimite-ne un email cu introducerea ta și noi ne vom ocupa de cererea de invitație.",
  ...
  rightDesc:
    "Construiește cu ușurință aplicații AI captivante din punct de vedere vizual, utilizabile și îmbunătățibile.",
  tos: "Termeni și condiții",
  pp: "Politica de confidențialitate",
  tosDesc: "Prin înregistrarea, ești de acord cu",
  goToInit:
    "Dacă nu ai inițializat încă contul, te rugăm să mergi la pagina de inițializare",
  dontHave: "Nu ai?",
  ...
  forgotPasswordDesc:
    "Vă rugăm să introduceți adresa de e-mail pentru a reseta parola. Vă vom trimite un e-mail cu instrucțiuni despre cum să resetați parola.",
  checkEmailForResetLink:
    "Vă rugăm să verificați e-mailul pentru un link de resetare a parolei. Dacă nu apare în câteva minute, verificați folderul de spam.",
  ...
  error: {
    ...
    passwordInvalid:
      "Parola trebuie să conțină litere și cifre, iar lungimea trebuie să fie mai mare de 8 caractere",
    passwordLengthInValid: "Parola trebuie să aibă cel puțin 8 caractere",
    registrationNotAllowed:
      "Contul nu a fost găsit. Vă rugăm să contactați administratorul de sistem pentru a vă înregistra.",
  },
  license: {
    tip: "Înainte de a începe IDX Community Edition, citește",
  ...
  noLoginMethodTip:
    "Vă rugăm să contactați administratorul de sistem pentru a adăuga o metodă de autentificare.",
  back: "Spate",
  ...
  or: "SAU",
  resetPasswordDesc:
    "Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe IDX și vă vom trimite un e-mail de resetare a parolei.",
  changePasswordBtn: "Setați o parolă",
  licenseLostTip:
    "Nu s-a reușit conectarea serverului de licențe Dify. Contactați administratorul pentru a continua să utilizați Dify.",
  licenseInactive: "Licență inactivă",
  licenseInactiveTip:
    "Licența IDX Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Dify.",
  licenseExpired: "Licență expirată",
  licenseLost: "Licență pierdută",
  licenseExpiredTip:
    "Licența IDX Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Dify.",
};
