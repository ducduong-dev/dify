const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "Ați commutat la Modul Expert și, odată ce modificați PROMPT-ul, NU puteți reveni la modul de bază.",
    ...
    contextMissing:
      "Componentă de context lipsește, eficacitatea promptului poate să nu fie bună.",
  },
  operation: {
    applyConfig: "Publică",
  ...
  notSetAPIKey: {
    ...
    description:
      "Cheia furnizorului LLM nu a fost setată și trebuie să fie setată înainte de depanare.",
  ...
  feature: {
    groupChat: {
      ...
      description:
        "Adăugați setări pre-conversație pentru aplicații, pentru a îmbunătăți experiența utilizatorilor.",
    },
    groupExperience: {
    ...
    conversationOpener: {
      ...
      description:
        "Într-o aplicație de chat, prima propoziție pe care IA o vorbește în mod activ utilizatorului este de obicei utilizată ca salut.",
    },
    suggestedQuestionsAfterAnswer: {
      title: "Urmărire",
      description:
        "Setarea sugestiilor pentru întrebările următoare poate oferi utilizatorilor o conversație mai bună.",
    ...
    moreLikeThis: {
      ...
      description:
        "Generați mai multe texte o dată, apoi editați și continuați să generați",
    ...
    citation: {
      ...
      description:
        "După activare, se vor afișa documentul sursă și secțiunea atribuită a conținutului generat.",
      resDes: "Citări și atribuiri sunt activate",
    },
    annotation: {
      title: "Răspuns anotat",
      description:
        "Puteți adăuga manual răspunsuri de înaltă calitate în cache pentru a le prioritiza la potrivirea cu întrebările similare ale utilizatorilor.",
      resDes: "Răspuns anotat este activat",
      scoreThreshold: {
        title: "Prag de scor",
        description:
          "Folosit pentru a seta pragul de similitudine pentru răspunsul anotat.",
    ...
    dataSet: {
      ...
      queryVariable: {
        ...
        unableToQueryDataSetTip:
          "Nu s-a reușit interogarea cu succes a Cunoștințelor, vă rugăm să alegeți o variabilă de interogare a contextului în secțiunea context.",
        ok: "OK",
        contextVarNotEmpty:
          "variabila de interogare a contextului nu poate fi goală",
        deleteContextVarTitle: 'Ștergeți variabila "{{varName}}"?',
        deleteContextVarTip:
          "Această variabilă a fost setată ca variabilă de interogare a contextului și eliminarea ei va afecta utilizarea normală a Cunoștințelor. Dacă totuși trebuie să o ștergeți, vă rugăm să o reselectați în secțiunea context.",
      },
    },
    tools: {
      title: "Instrumente",
    ...
    moderation: {
      ...
      description:
        "Asigurați securitatea ieșirii modelului folosind API-ul de moderare sau menținând o listă de cuvinte sensibile.",
      ...
      modal: {
        ...
        provider: {
          ...
          openaiTip: {
            prefix:
              "Moderarea OpenAI necesită o cheie API OpenAI configurată în",
            suffix: ".",
          },
        ...
        content: {
          ...
          condition:
            "Moderează conținut INTRARE și IEȘIRE activat cel puțin unul",
  ...
  automatic: {
    ...
    description:
      "Descrieți scenariul dvs., IDX vă va orchestra o aplicație pentru dvs.",
    ...
    solveProblemPlaceHolder:
      "de ex. Extrage informații și rezumă informații din rapoarte și articole lungi",
    generate: "Generează",
    ...
    noData:
      "Descrieți cazul de utilizare din stânga, previzualizarea orchestrării se va afișa aici.",
    loading: "Orchestrarea aplicației pentru dvs...",
    overwriteTitle: "Suprascrieți configurația existentă?",
    overwriteMessage:
      "Aplicarea acestei orchestrări va suprascrie configurația existentă.",
  },
  resetConfig: {
  ...
  errorMessage: {
    ...
    waitForBatchResponse: "Vă rugăm să așteptați finalizarea sarcinii în lot.",
  ...
  notSetVar:
    'Variabilele permit utilizatorilor să introducă cuvinte de prompt sau remarci de deschidere atunci când completează formulare. Puteți încerca să introduceți "{{input}}" în cuvintele de prompt.',
  autoAddVar:
    "Variabilele nedefinite la care se face referire în pre-prompt, doriți să le adăugați în formularul de intrare al utilizatorului?",
  variableTable: {
    key: "Cheie variabilă",
  ...
  varKeyError: {
    ...
    tooLong:
      "{{key}} este prea lungă. Nu poate fi mai lungă de 30 de caractere",
    notValid:
      "{{key}} este nevalidă. Poate conține doar litere, cifre și sublinieri",
  ...
  vision: {
    name: "Viziune",
    description:
      "Activarea Viziunii va permite modelului să primească imagini și să răspundă la întrebări despre ele.",
    settings: "Setări",
    visionSettings: {
  ...
  openingStatement: {
    ...
    placeholder:
      "Scrieți aici mesajul de deschidere, puteți utiliza variabile, încercați să tastați {{variable}}.",
    ...
    tooShort:
      "Este necesară o promptare inițială de cel puțin 20 de cuvinte pentru a genera o remarcă de deschidere a conversației.",
    notIncludeKey:
      "Promptarea inițială nu include variabila: {{key}}. Vă rugăm să o adăugați la promptarea inițială.",
  },
  modelConfig: {
    model: "Model",
  ...
  inputs: {
    ...
    noPrompt:
      "Încercați să scrieți o promptare în câmpul de intrare pre-promptare",
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description:
        "Pe baza intenției utilizatorului și a descrierilor Cunoștințelor, Agentul selectează în mod autonom cea mai bună Cunoștință pentru interogare. Cel mai bun pentru aplicații cu Cunoștințe distincte și limitate.",
    },
    retrieveMultiWay: {
      title: "Recuperare multi-cale",
      description:
        "Pe baza intenției utilizatorului, interogați toate Cunoștințele, recuperați textul relevant din mai multe surse și selectați cele mai bune rezultate care se potrivesc interogării utilizatorului după reclasificare. Este necesară configurarea API-ului Rerank Model.",
    },
    rerankModelRequired: "Este necesar modelul Rerank",
    params: "Parametri",
    top_k: "Top K",
    top_kTip:
      "Utilizat pentru a filtra bucățile cele mai similare cu întrebările utilizatorilor. Sistemul va ajusta, de asemenea, în mod dinamic valoarea Top K, în funcție de max_tokens al modelului selectat.",
    score_threshold: "Prag scor",
    score_thresholdTip:
      "Utilizat pentru a seta pragul de similitudine pentru filtrarea bucăților.",
    retrieveChangeTip:
      "Modificarea modului de indexare și a modului de recuperare poate afecta aplicațiile asociate cu aceste Cunoștințe.",
  },
  ...
  assistantType: {
    ...
    chatAssistant: {
      ...
      description:
        "Construiți un asistent bazat pe chat utilizând un Model de Limbaj Mare",
    },
    agentAssistant: {
      name: "Asistent Agent",
      description:
        "Construiți un Agent inteligent care poate alege în mod autonom instrumente pentru a îndeplini sarcinile",
    },
  },
  agent: {
    agentMode: "Mod Agent",
    ...
    setting: {
      name: "Setări Agent",
      description:
        "Setările Asistentului Agent permit setarea modului agent și a funcțiilor avansate, cum ar fi prompturile încorporate, disponibile numai în tipul Agent.",
      maximumIterations: {
        name: "Iterații maxime",
        description:
          "Limitați numărul de iterații pe care le poate executa un asistent agent",
      },
    },
    ...
    tools: {
      name: "Instrumente",
      description:
        "Utilizarea instrumentelor poate extinde capacitățile LLM, cum ar fi căutarea pe internet sau efectuarea de calcule științifice",
      enabled: "Activat",
    },
  },
};
