const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "Bạn đã chuyển sang Chế độ Chuyên gia. Sau khi sửa đổi YÊU CẦU, bạn KHÔNG THỂ quay lại chế độ cơ bản.",
      description:
        "Trong Chế độ Chuyên gia, bạn có thể chỉnh sửa toàn bộ YÊU CẦU.",
    ...
    contextMissing:
      "Thiếu thành phần Ngữ cảnh, hiệu quả của yêu cầu có thể không tốt.",
  },
  operation: {
    applyConfig: "Áp dụng",
    resetConfig: "Đặt lại",
  ...
  notSetAPIKey: {
    ...
    description:
      "Chưa thiết lập khóa API của nhà cung cấp LLM. Cần thiết lập trước khi gỡ lỗi.",
  ...
  feature: {
    groupChat: {
      ...
      description:
        "Thêm cài đặt trước cho cuộc trò chuyện có thể cải thiện trải nghiệm người dùng.",
    },
    groupExperience: {
    ...
    conversationOpener: {
      ...
      description:
        "Trong ứng dụng trò chuyện, câu nói đầu tiên mà AI tự động nói với người dùng thường được sử dụng như một lời chào.",
    },
    suggestedQuestionsAfterAnswer: {
      title: "Câu hỏi gợi ý",
      description:
        "Thiết lập đề xuất câu hỏi tiếp theo có thể tạo ra cuộc trò chuyện tốt hơn cho người dùng.",
    ...
    moreLikeThis: {
      title: "Thêm tương tự",
      description:
        "Tạo nhiều văn bản cùng một lúc, sau đó chỉnh sửa và tiếp tục tạo ra.",
    ...
    textToSpeech: {
      ...
      description:
        "Khi được bật, văn bản có thể được chuyển đổi thành giọng nói.",
      resDes: "Đã bật chuyển đổi văn bản thành âm thanh",
    },
    citation: {
      title: "Trích dẫn và chú thích",
      description:
        "Khi được bật, hiển thị nguồn tài liệu và phần được trích dẫn của nội dung được tạo ra.",
      resDes: "Đã bật trích dẫn và chú thích",
    },
    annotation: {
      title: "Phản hồi có chú thích",
      description:
        "Bạn có thể thêm phản hồi chất lượng cao vào bộ nhớ cache để ưu tiên phù hợp với các câu hỏi tương tự của người dùng.",
      resDes: "Đã bật phản hồi có chú thích",
      scoreThreshold: {
        title: "Ngưỡng điểm",
        description:
          "Được sử dụng để đặt ngưỡng tương đồng cho phản hồi có chú thích.",
    ...
    dataSet: {
      ...
      queryVariable: {
        ...
        unableToQueryDataSetTip:
          "Không thể truy vấn kiến thức thành công, vui lòng chọn một biến truy vấn ngữ cảnh trong phần ngữ cảnh.",
        ok: "Đồng ý",
        contextVarNotEmpty: "Biến truy vấn ngữ cảnh không thể trống",
        deleteContextVarTitle: 'Xóa biến "{{varName}}"?',
        deleteContextVarTip:
          "Biến này đã được thiết lập là biến truy vấn ngữ cảnh, và việc xóa nó sẽ ảnh hưởng đến việc sử dụng bình thường của kiến thức. Nếu bạn vẫn cần xóa nó, vui lòng chọn lại biến khác trong phần ngữ cảnh.",
      },
    },
    tools: {
      title: "Công cụ",
    ...
    moderation: {
      ...
      description:
        "Bảo vệ đầu ra của mô hình bằng cách sử dụng API kiểm duyệt hoặc danh sách từ nhạy cảm.",
  ...
  automatic: {
    ...
    description:
      "Mô tả tình huống của bạn, IDX sẽ tự động hóa một ứng dụng cho bạn.",
    ...
    noData:
      "Mô tả tình huống sử dụng của bạn ở bên trái, xem trước tự động hóa sẽ hiển thị ở đây.",
    loading: "Đang tự động hóa ứng dụng cho bạn...",
    overwriteTitle: "Ghi đè cấu hình hiện tại?",
    overwriteMessage:
      "Áp dụng tự động hóa này sẽ ghi đè lên cấu hình hiện tại.",
  },
  resetConfig: {
  ...
  notSetVar:
    'Biến cho phép người dùng đưa ra từ khóa lời nhắc hoặc mở đầu khi điền vào biểu mẫu. Bạn có thể thử nhập "{{input}}" trong các từ khóa lời nhắc.',
  autoAddVar:
    "Phát hiện biến không xác định được tham chiếu trong tiền-lời nhắc, bạn có muốn thêm chúng vào biểu mẫu đầu vào người dùng không?",
  variableTable: {
    key: "Khóa biến",
  ...
  varKeyError: {
    ...
    notValid:
      "{{key}} không hợp lệ. Chỉ có thể chứa chữ cái, số, và dấu gạch dưới",
  ...
  otherError: {
    ...
    historyNoBeEmpty:
      "Lịch sử cuộc trò chuyện phải được thiết lập trong lời nhắc",
  ...
  vision: {
    name: "Thị giác",
    description:
      "Cho phép tính năng thị giác sẽ cho phép mô hình nhận diện hình ảnh và trả lời các câu hỏi về chúng.",
    settings: "Cài đặt",
    visionSettings: {
  ...
  openingStatement: {
    ...
    placeholder:
      "Viết thông điệp mở đầu của bạn ở đây, bạn có thể sử dụng biến, hãy thử nhập {{biến}}.",
    openingQuestion: "Câu hỏi mở đầu",
    noDataPlaceHolder:
      "Bắt đầu cuộc trò chuyện với người dùng có thể giúp AI thiết lập mối quan hệ gần gũi hơn với họ trong các ứng dụng trò chuyện.",
    varTip: "Bạn có thể sử dụng biến, hãy thử nhập {{biến}}",
    tooShort:
      "Cần ít nhất 20 từ trong lời nhắc ban đầu để tạo ra các câu mở đầu cho cuộc trò chuyện.",
    notIncludeKey:
      "Lời nhắc ban đầu không bao gồm biến: {{key}}. Vui lòng thêm nó vào lời nhắc ban đầu.",
  },
  modelConfig: {
    model: "Mô hình",
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description:
        "Dựa trên ý định của người dùng và mô tả kiến thức, Agent tự động chọn kiến thức tốt nhất để truy vấn. Phù hợp nhất cho các ứng dụng có kiến thức cụ thể, giới hạn.",
    },
    retrieveMultiWay: {
      title: "Truy xuất đa hướng",
      description:
        "Dựa trên ý định của người dùng, truy vấn qua tất cả kiến thức, truy xuất văn bản liên quan từ nhiều nguồn và chọn ra kết quả tốt nhất phù hợp với truy vấn của người dùng sau khi sắp xếp lại. Yêu cầu cấu hình của API mô hình Rerank.",
    },
    rerankModelRequired: "Mô hình Rerank là bắt buộc",
    params: "Tham số",
    top_k: "Top K",
    top_kTip:
      "Sử dụng để lọc các phần chính xác nhất với câu hỏi của người dùng. Hệ thống cũng sẽ tự động điều chỉnh giá trị của Top K, theo max_tokens của mô hình đã chọn.",
    score_threshold: "Ngưỡng điểm",
    score_thresholdTip:
      "Sử dụng để thiết lập ngưỡng tương đồng cho việc lọc các phần.",
    retrieveChangeTip:
      "Thay đổi chế độ chỉ mục và chế độ truy xuất có thể ảnh hưởng đến các ứng dụng liên quan đến kiến thức này.",
  },
  ...
  assistantType: {
    ...
    chatAssistant: {
      name: "Trợ lý cơ bản",
      description:
        "Xây dựng một trợ lý dựa trên trò chuyện sử dụng một Mô hình Ngôn ngữ Lớn.",
    },
    agentAssistant: {
      name: "Trợ lý tác nhân",
      description:
        "Xây dựng một tác nhân thông minh có thể tự động chọn các công cụ để hoàn thành các nhiệm vụ.",
    },
  },
  agent: {
    ...
    setting: {
      ...
      description:
        "Thiết lập tác nhân cho phép cấu hình chế độ tác nhân và các tính năng nâng cao như lời nhắc tích hợp sẵn, chỉ có sẵn trong loại Tác nhân.",
      maximumIterations: {
        name: "Số lần lặp tối đa",
        description:
          "Giới hạn số lần lặp mà một trợ lý tác nhân có thể thực hiện",
      },
    },
    ...
    tools: {
      name: "Công cụ",
      description:
        "Sử dụng công cụ có thể mở rộng khả năng của LLM, như tìm kiếm trên internet hoặc thực hiện các phép tính khoa học",
