const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "Gói dùng thử được cung cấp để bạn kiểm tra. Trước khi hết lượt gọi của gói dùng thử, vui lòng thiết lập nhà cung cấp mô hình riêng hoặc mua thêm hạn mức.",
      },
      exhausted: {
        title:
          "Gói dùng thử của bạn đã hết, vui lòng thiết lập khóa API của bạn.",
        description:
          "Gói dùng thử của bạn đã hết. Vui lòng thiết lập nhà cung cấp mô hình riêng hoặc mua thêm hạn mức.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "Hoặc dùng thử phiên bản đám mây của IDX với gói miễn phí",
  },
  overview: {
    title: "Tổng quan",
    appInfo: {
      ...
      settings: {
        ...
        webDescTip:
          "Văn bản này sẽ hiển thị ở phía người dùng, cung cấp hướng dẫn cơ bản về cách sử dụng ứng dụng",
        ...
        more: {
          ...
          privacyPolicyTip:
            "Giúp người dùng hiểu dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của Dify.",
          customDisclaimer: "Tuyên bố từ chối trách nhiệm tùy chỉnh",
          customDisclaimerPlaceholder:
            "Nhập liên kết tuyên bố từ chối trách nhiệm",
          customDisclaimerTip:
            "Liên kết này sẽ hiển thị ở phía người dùng, cung cấp thông tin về trách nhiệm của ứng dụng",
        ...
        sso: {
          ...
          description:
            "Tất cả người dùng được yêu cầu đăng nhập bằng SSO trước khi sử dụng WebApp",
      ...
      embedded: {
        ...
        explanation:
          "Chọn cách nhúng ứng dụng trò chuyện vào trang web của bạn",
        iframe:
          "Để thêm ứng dụng trò chuyện vào bất kỳ đâu trên trang web của bạn, hãy thêm iframe này vào mã HTML của bạn.",
        scripts:
          "Để thêm ứng dụng trò chuyện vào góc dưới bên phải của trang web, thêm mã này vào mã HTML của bạn.",
        chromePlugin: "Cài đặt tiện ích mở rộng IDX Chatbot cho Chrome",
        copied: "Đã sao chép",
        copy: "Sao chép",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "Bạn có thể tùy chỉnh giao diện của ứng dụng web để phù hợp với kịch bản và phong cách mong muốn.",
        way1: {
          name: "Fork mã nguồn phía client, sửa đổi và triển khai lên Vercel (khuyến nghị)",
          step1: "Fork mã nguồn phía client và sửa đổi",
          step1Tip:
            "Nhấp vào đây để fork mã nguồn vào tài khoản GitHub của bạn và sửa đổi",
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Số lượng cuộc hội thoại AI hàng ngày; không bao gồm kỹ thuật/gỡ lỗi prompt.",
    },
    activeUsers: {
      title: "Người dùng hoạt động",
      explanation:
        "Số người dùng duy nhất tham gia trò chuyện với AI; không tính việc tạo lại/lặp lại câu hỏi.",
    },
    tokenUsage: {
      title: "Sử dụng token",
      explanation:
        "Phản ánh việc sử dụng mô hình ngôn ngữ hàng ngày cho ứng dụng, hữu ích cho mục đích kiểm soát chi phí.",
      consumed: "Đã sử dụng",
    },
    avgSessionInteractions: {
      title: "Trung bình tương tác mỗi phiên",
      explanation:
        "Số lần giao tiếp liên tục giữa người dùng và AI; áp dụng cho các ứng dụng dựa trên trò chuyện.",
    },
    avgUserInteractions: {
      title: "Trung bình tương tác mỗi người dùng",
      explanation:
        "Phản ánh tần suất sử dụng hàng ngày của người dùng. Chỉ số này cho biết mức độ gắn kết của người dùng.",
    },
    userSatisfactionRate: {
      title: "Tỷ lệ hài lòng của người dùng",
      explanation:
        "Số lượt thích trên mỗi 1.000 tin nhắn. Chỉ số này cho biết tỷ lệ câu trả lời mà người dùng rất hài lòng.",
    },
    avgResponseTime: {
      title: "Thời gian phản hồi trung bình",
      explanation:
        "Thời gian (ms) để AI xử lý/phản hồi; áp dụng cho các ứng dụng dựa trên văn bản.",
    },
    tps: {
      title: "Tốc độ đầu ra token",
      explanation:
        "Đo lường hiệu suất của LLM. Đếm tốc độ đầu ra token của LLM từ khi bắt đầu yêu cầu đến khi hoàn thành đầu ra.",
    },
  },
};
