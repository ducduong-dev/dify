const translation = {
  list: {
    title: "Tài liệu",
    desc: "Tất cả các tệp của Kiến thức được hiển thị ở đây. Toàn bộ Kiến thức có thể được liên kết với trích dẫn của IDX hoặc được lập chỉ mục thông qua plugin Chat.",
    addFile: "Thêm tệp",
    addPages: "Thêm trang",
    table: {
      header: {
  ...
  metadata: {
    ...
    docTypeSelectWarning:
      "Nếu thay đổi loại tài liệu, các siêu dữ liệu hiện tại sẽ không được bảo toàn",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Tạo lại các chunk con sẽ ghi đè lên các chunk con hiện tại, bao gồm các chunk đã chỉnh sửa và chunk mới được thêm vào. Sự tái sinh không thể hoàn tác.",
