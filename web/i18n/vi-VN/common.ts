const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Cài đặt max token của bạn quá cao, có thể hạn chế không gian cho từ khóa, truy vấn và dữ liệu. Xem xét đặt nó dưới 2/3.",
      setToCurrentModelMaxTokenTip:
        "Max token được cập nhật đến 80% token tối đa của mô hình hiện tại {{maxToken}}.",
      stop_sequences: "Chuỗi dừng",
      stop_sequencesTip:
        "Lên đến bốn chuỗi nơi API sẽ dừng việc tạo ra các token tiếp theo. Văn bản được trả về sẽ không chứa chuỗi dừng.",
  ...
  menus: {
    ...
    plugins: "Plugins",
    pluginsTips:
      "Tích hợp các plugin bên thứ ba hoặc tạo ra các AI-Plugin tương thích với ChatGPT.",
    datasets: "Kiến thức",
    datasetsTips:
      "SẮP RA MẮT: Nhập dữ liệu văn bản của bạn hoặc cập nhật dữ liệu theo thời gian thực thông qua Webhook để cải thiện ngữ cảnh LLM.",
    newApp: "Ứng dụng mới",
  ...
  account: {
    ...
    password: "Mật khẩu",
    passwordTip:
      "Bạn có thể đặt một mật khẩu cố định nếu bạn không muốn sử dụng mã đăng nhập tạm thời",
    ...
    langGeniusAccountTip:
      "Tài khoản IDX của bạn và dữ liệu người dùng liên quan.",
    ...
    deletePrivacyLinkTip:
      "Để biết thêm thông tin về cách chúng tôi xử lý dữ liệu của bạn, vui lòng xem",
    deletePrivacyLink: "Chính sách bảo mật.",
    deleteSuccessTip:
      "Tài khoản của bạn cần thời gian để xóa xong. Chúng tôi sẽ gửi email cho bạn khi tất cả hoàn tất.",
    ...
    feedbackLabel:
      "Hãy cho chúng tôi biết lý do tại sao bạn xóa tài khoản của mình?",
  ...
  members: {
    ...
    emailNotSetup:
      "Máy chủ email chưa được thiết lập, vì vậy không thể gửi email mời. Vui lòng thông báo cho người dùng về liên kết mời sẽ được phát hành sau khi mời.",
    email: "Email",
    ...
    invitationSentTip:
      "Lời mời đã được gửi, và họ có thể đăng nhập vào IDX để truy cập vào dữ liệu nhóm của bạn.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Khóa API này không có lượng truy vấn khả dụng, vui lòng đọc",
    addKey: "Thêm Khóa",
    ...
    openaiHosted: {
      ...
      onTrial: "DÙNG THỬ",
      exhausted: "HẾT QUOTA",
      desc: "Dịch vụ lưu trữ OpenAI được cung cấp bởi IDX cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.",
    ...
    anthropicHosted: {
      ...
      close: "Đóng",
      trialQuotaTip:
        "Hạn ngạch dùng thử Anthropic của bạn sẽ hết hạn vào 2025/03/11 và sẽ không còn khả dụng sau đó. Vui lòng sử dụng nó kịp thời.",
    },
    anthropic: {
      using: "Khả năng nhúng đang sử dụng",
      enableTip:
        "Để kích hoạt mô hình Anthrop, bạn cần ràng buộc với Dịch vụ OpenAI hoặc Azure OpenAI trước.",
  ...
  modelProvider: {
    notConfigured:
      "Mô hình hệ thống vẫn chưa được cấu hình hoàn toàn và một số chức năng có thể không khả dụng.",
    systemModelSettings: "Cài đặt Mô hình Hệ thống",
    systemModelSettingsLink:
      "Tại sao cần thiết phải thiết lập mô hình hệ thống?",
    ...
    item: {
      deleteDesc:
        "Các mô hình {{modelName}} đang được sử dụng như là các mô hình lập luận hệ thống. Một số chức năng sẽ không khả dụng sau khi loại bỏ. Vui lòng xác nhận.",
    ...
    providerManagedDescription:
      "Sử dụng bộ thông tin đăng nhập duy nhất do nhà cung cấp mô hình cung cấp.",
    apiKeyStatusNormal: "Trạng thái APIKey bình thường",
    editConfig: "Chỉnh sửa cấu hình",
    loadBalancingInfo:
      "Theo mặc định, cân bằng tải sử dụng chiến lược Vòng tròn. Nếu giới hạn tốc độ được kích hoạt, thời gian hồi chiêu 1 phút sẽ được áp dụng.",
    ...
    loadBalancingLeastKeyWarning:
      "Để bật cân bằng tải, ít nhất 2 phím phải được bật.",
  ...
  dataSource: {
    ...
    website: {
      ...
      description:
        "Nhập nội dung từ các trang web bằng trình thu thập dữ liệu web.",
    },
    configure: "Cấu hình",
  },
  plugin: {
  ...
  apiBasedExtension: {
    title:
      "Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của Dify.",
  ...
  datasetMenus: {
    ...
    settings: "Cài đặt",
    emptyTip:
      "Kiến thức chưa được liên kết, vui lòng đi đến ứng dụng hoặc plug-in để hoàn thành liên kết.",
  ...
  promptEditor: {
    placeholder:
      "Viết từ khóa của bạn ở đây, nhập '{' để chèn một biến, nhập '/' để chèn một khối nội dung nhắc nhở",
    context: {
      item: {
        title: "Bối cảnh",
  ...
  imageUploader: {
    ...
    uploadFromComputerUploadError:
      "Tải ảnh lên thất bại, vui lòng tải lên lại.",
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "Tải lên tệp không thành công, vui lòng tải lên lại.",
