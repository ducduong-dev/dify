const translation = {
  ...
  setAdminAccountDesc:
    "Tài khoản quản trị có quyền tối đa, có thể tạo ứng dụng và quản lý các nhà cung cấp LLM, v.v.",
  createAndSignIn: "Tạo và đăng nhập",
  oneMoreStep: "Còn một bước nữa",
  createSample:
    "Dựa trên thông tin này, chúng tôi sẽ tạo một ứng dụng mẫu cho bạn",
  ...
  go: "Đi đến Dify",
  sendUsMail:
    "Gửi email giới thiệu cho chúng tôi, chúng tôi sẽ xử lý yêu cầu mời của bạn.",
  ...
  rightDesc:
    "Dễ dàng xây dựng ứng dụng AI hấp dẫn, có thể vận hành và cải thiện được.",
  tos: "Điều khoản dịch vụ",
  pp: "Chính sách bảo mật",
  tosDesc: "Bằng cách đăng ký, bạn đồng ý với",
  goToInit:
    "Nếu bạn chưa khởi tạo tài khoản, vui lòng chuyển đến trang khởi tạo",
  ...
  forgotPasswordDesc:
    "Vui lòng nhập địa chỉ email của bạn để đặt lại mật khẩu. Chúng tôi sẽ gửi cho bạn một email hướng dẫn cách đặt lại mật khẩu.",
  checkEmailForResetLink:
    "Vui lòng kiểm tra email để nhận liên kết đặt lại mật khẩu. Nếu không thấy trong vài phút, hãy kiểm tra thư mục spam.",
  ...
  error: {
    ...
    passwordInvalid:
      "Mật khẩu phải chứa cả chữ và số, và có độ dài ít nhất 8 ký tự",
    passwordLengthInValid: "Mật khẩu phải có ít nhất 8 ký tự",
    registrationNotAllowed:
      "Không tìm thấy tài khoản. Vui lòng liên hệ với quản trị viên hệ thống để đăng ký.",
  },
  license: {
  ...
  noLoginMethodTip:
    "Vui lòng liên hệ với quản trị viên hệ thống để thêm phương thức xác thực.",
  ...
  or: "HOẶC",
  resetPasswordDesc:
    "Nhập email bạn đã sử dụng để đăng ký trên IDX và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.",
  ...
  licenseInactiveTip:
    "Giấy phép IDX Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng Dify.",
  licenseExpired: "Giấy phép đã hết hạn",
  licenseExpiredTip:
    "Giấy phép IDX Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng Dify.",
  licenseLostTip:
    "Không thể kết nối máy chủ cấp phép Dify. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng Dify.",
};
