const translation = {
  ...
  intro1: "La Conoscenza può essere integrata nell'applicazione IDX ",
  ...
  mixtureHighQualityAndEconomicTip:
    "Il modello di riclassificazione è necessario per la miscela di basi di conoscenza di alta qualità ed economiche.",
  inconsistentEmbeddingModelTip:
    "Il modello di riclassificazione è necessario se i modelli di embedding delle basi di conoscenza selezionate sono incoerenti.",
  retrievalSettings: "Impostazioni di recupero",
  rerankSettings: "Impostazioni di riclassificazione",
  weightedScore: {
    title: "Punteggio ponderato",
    description:
      "Regolando i pesi assegnati, questa strategia di riclassificazione determina se dare priorità alla corrispondenza semantica o per parole chiave.",
  ...
  nTo1RetrievalLegacy:
    "Il recupero N-a-1 sarà ufficialmente deprecato da settembre. Si consiglia di utilizzare il più recente recupero multi-percorso per ottenere risultati migliori.",
  nTo1RetrievalLegacyLink: "Scopri di più",
  nTo1RetrievalLegacyLinkText:
    "Il recupero N-a-1 sarà ufficialmente deprecato a settembre.",
  defaultRetrievalTip:
    "Per impostazione predefinita, il recupero a percorsi multipli viene utilizzato. Le informazioni vengono recuperate da più knowledge base e quindi riclassificate.",
  ...
  connectDatasetIntro: {
    content: {
      front:
        "Per connettersi a una knowledge base esterna, è necessario prima creare un'API esterna. Si prega di leggere attentamente e fare riferimento a",
  ...
  connectHelper: {
    ...
    helper1:
      "Connettiti a knowledge base esterne tramite API e ID knowledge base. Attualmente,",
  ...
  externalAPIPanelDescription:
    "L'API di conoscenza esterna viene utilizzata per connettersi a una knowledge base esterna a IDX e recuperare le informazioni da tale knowledge base.",
  createExternalAPI: "Aggiungere un'API di conoscenza esterna",
  learnHowToWriteGoodKnowledgeDescription:
    "Impara a scrivere una buona descrizione della conoscenza",
  ...
  externalAPIPanelDocumentation:
    "Scopri come creare un'API della Knowledge Base esterna",
  connectDataset: "Connettiti a una Knowledge Base esterna",
  mixtureInternalAndExternalTip:
    "Il modello Rerank è necessario per la combinazione di conoscenze interne ed esterne.",
  ...
  allExternalTip:
    "Quando si utilizzano solo conoscenze esterne, l'utente può scegliere se abilitare il modello Rerank. Se non è abilitato, i blocchi recuperati verranno ordinati in base ai punteggi. Quando le strategie di recupero di diverse basi di conoscenza sono incoerenti, saranno imprecise.",
  externalKnowledgeDescriptionPlaceholder:
    "Descrivi cosa c'è in questa Knowledge Base (facoltativo)",
  noExternalKnowledge:
    "Non esiste ancora un'API di conoscenza esterna, fai clic qui per creare",
  chunkingMode: {
    general: "Generale",
  ...
  enable: "Abilitare",
  documentsDisabled:
    "{{num}} documenti disabilitati - inattivi da oltre 30 giorni",
  localDocs: "Documenti locali",
  allKnowledge: "Tutta la conoscenza",
  allKnowledgeDescription:
    "Selezionare questa opzione per visualizzare tutte le informazioni in questa area di lavoro. Solo il proprietario dell'area di lavoro può gestire tutte le conoscenze.",
};
