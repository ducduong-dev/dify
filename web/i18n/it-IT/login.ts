const translation = {
  ...
  error: {
    ...
    registrationNotAllowed:
      "Account non trovato. Si prega di contattare l'amministratore di sistema per registrarsi.",
  },
  license: {
    tip: "Prima di avviare IDX Community Edition, leggi su GitHub",
  ...
  resetPasswordDesc:
    "Digita l'e-mail che hai utilizzato per registrarti su IDX e ti invieremo un'e-mail per reimpostare la password.",
  noLoginMethodTip:
    "Contatta l'amministratore di sistema per aggiungere un metodo di autenticazione.",
  enterYourName: "Inserisci il tuo nome utente",
  licenseLostTip:
    "Impossibile connettersi al server licenze Dify. Contatta il tuo amministratore per continuare a utilizzare Dify.",
  licenseExpired: "Licenza scaduta",
  licenseLost: "Licenza persa",
  licenseExpiredTip:
    "La licenza IDX Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Dify.",
  licenseInactiveTip:
    "La licenza IDX Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Dify.",
