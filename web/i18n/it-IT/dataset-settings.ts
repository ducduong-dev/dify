const translation = {
  ...
  form: {
    ...
    descPlaceholder:
      "Descrivi cosa c'è in questa Conoscenza. Una descrizione dettagliata permette all'IA di accedere al contenuto della Conoscenza in modo tempestivo. Se vuota, IDX utilizzerà la strategia di recupero predefinita.",
    ...
    upgradeHighQualityTip:
      "Una volta effettuato l'aggiornamento alla modalità Alta qualità, il ripristino della modalità Risparmio non è disponibile",
    indexMethodChangeToEconomyDisabledTip:
      "Non disponibile per il downgrade da HQ a ECO",
  },
};
