const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "O prova la versione cloud di IDX con quota gratuita",
  },
  overview: {
    title: "Panoramica",
    appInfo: {
      ...
      settings: {
        ...
        workflow: {
          ...
          showDesc:
            "Mostrare o nascondere i dettagli del flusso di lavoro in WebApp",
        },
        ...
        more: {
          ...
          copyrightTip:
            "Visualizzare le informazioni sul copyright nella webapp",
          copyrightTooltip:
            "Si prega di eseguire l'upgrade al piano Professional o superiore",
        },
        sso: {
          label: "Autenticazione SSO",
          title: "WebApp SSO",
          description:
            "Tutti gli utenti devono effettuare l'accesso con SSO prima di utilizzare WebApp",
      ...
      embedded: {
        ...
        chromePlugin: "Installa l'estensione Chrome di IDX Chatbot",
        copied: "Copiato",
        copy: "Copia",
      },
      qrcode: {
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Conteggio delle conversazioni giornaliere con l'IA; ingegneria/debug dei prompt esclusi.",
    },
    activeUsers: {
      title: "Utenti Attivi",
      explanation:
