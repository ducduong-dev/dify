const translation = {
  list: {
    title: "Documenti",
    desc: "Tutti i file della Conoscenza sono mostrati qui, e l'intera Conoscenza può essere collegata alle citazioni di IDX o indicizzata tramite il plugin di Chat.",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "La rigenerazione dei blocchi figlio sovrascriverà i blocchi figlio correnti, inclusi i blocchi modificati e i blocchi appena aggiunti. La rigenerazione non può essere annullata.",
    ...
    regeneratingMessage:
      "Questo potrebbe richiedere un momento, si prega di attendere...",
