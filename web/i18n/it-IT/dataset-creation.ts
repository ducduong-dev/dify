const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink:
        "https://idx-solutions.com/guides/knowledge-base/sync_from_website",
      options: "Opzioni",
      ...
      useSitemapTooltip:
        "Segui la sitemap per eseguire la scansione del sito. In caso contrario, Jina Reader eseguirà la scansione in modo iterativo in base alla pertinenza della pagina, producendo meno pagine ma di qualità superiore.",
      ...
      jinaReaderNotConfiguredDescription:
        "Configura Jina Reader inserendo la tua chiave API gratuita per l'accesso.",
  ...
  stepTwo: {
    ...
    generalTip:
      "Modalità generale di suddivisione in blocchi del testo, i blocchi recuperati e richiamati sono gli stessi.",
    ...
    fullDocTip:
      "L'intero documento viene utilizzato come blocco principale e recuperato direttamente. Si prega di notare che per motivi di prestazioni, il testo che supera i 10000 token verrà automaticamente troncato.",
    parentChild: "Genitore-figlio",
    qaSwitchHighQualityTipContent:
      "Attualmente, solo il metodo dell'indice di alta qualità supporta la suddivisione in blocchi del formato Domande e risposte. Volete passare alla modalità di alta qualità?",
    parentChunkForContext: "Parent-chunk per il contesto",
    switch: "Interruttore",
    paragraphTip:
      "Questa modalità suddivide il testo in paragrafi in base ai delimitatori e alla lunghezza massima del blocco, utilizzando il testo diviso come blocco principale per il recupero.",
    notAvailableForQA: "Non disponibile per l'indice Q&A",
    parentChildTip:
      "Quando si utilizza la modalità genitore-figlio, il blocco figlio viene utilizzato per il recupero e il blocco padre viene utilizzato per il richiamo come contesto.",
    highQualityTip:
      "Una volta terminato l'incorporamento in modalità Alta qualità, il ripristino della modalità Economica non è disponibile.",
    ...
    qaSwitchHighQualityTipTitle:
      "Il formato Domande e risposte richiede un metodo di indicizzazione di alta qualità",
  },
  stepThree: {
  ...
  otherDataSource: {
    ...
    description:
      "Attualmente, la knowledge base di IDX ha solo fonti di dati limitate. Contribuire con una fonte di dati alla knowledge base di IDX è un modo fantastico per migliorare la flessibilità e la potenza della piattaforma per tutti gli utenti. La nostra guida ai contributi ti aiuta a iniziare. Clicca sul link sottostante per saperne di più.",
  },
};
