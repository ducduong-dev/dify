const translation = {
  ...
  account: {
    ...
    langGeniusAccountTip: "Il tuo account IDX e i dati utente associati.",
    ...
    deletePrivacyLinkTip:
      "Per ulteriori informazioni su come gestiamo i tuoi dati, consulta il nostro",
    deletePrivacyLink: "Informativa sulla privacy.",
    deleteSuccessTip:
      "Il tuo account ha bisogno di tempo per completare l'eliminazione. Ti invieremo un'e-mail quando tutto sarà finito.",
  ...
  members: {
    ...
    emailNotSetup:
      "Il server email non è configurato, quindi non è possibile inviare email di invito. Si prega di notificare agli utenti il link di invito che verrà emesso dopo l'invito.",
    email: "Email",
    ...
    invitationSentTip:
      "Invito inviato, e possono accedere a IDX per accedere ai dati del tuo team.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "Il servizio di hosting OpenAI fornito da IDX ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.",
    ...
    anthropicHosted: {
      ...
      close: "Chiudi",
      trialQuotaTip:
        "La tua quota di prova di Anthropic scadrà l'11/03/2025 e non sarà più disponibile in seguito. Sfruttalo in tempo.",
    },
    anthropic: {
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "Caricamento del file non riuscito, carica di nuovo.",
