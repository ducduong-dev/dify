const translation = {
  ...
  automatic: {
    ...
    description:
      "Descrivi il tuo scenario, IDX orchestrerà un'applicazione per te.",
  ...
  varKeyError: {
    ...
    tooLong: "{{key}} è troppo lunga. Non può essere più lunga di 30 caratteri",
    notValid:
      "{{key}} non è valida. Può contenere solo lettere, numeri e underscore",
    notStartWithNumber: "{{key}} non può iniziare con un numero",
