const translation = {
  ...
  form: {
    ...
    descInfo:
      "Veuillez rédiger une description textuelle claire pour décrire le contenu de la Connaissance. Cette description sera utilisée comme base pour la correspondance lors de la sélection parmi plusieurs Connaissances pour l'inférence.",
    descPlaceholder:
      "Décrivez ce qui se trouve dans cette Connaissance. Une description détaillée permet à l'IA d'accéder au contenu de la Connaissance en temps opportun. Si vide, IDX utilisera la stratégie de hit par défaut.",
    descWrite:
      "Apprenez comment rédiger une bonne description de connaissance.",
    ...
    indexMethodHighQualityTip:
      "Appeler le modèle d'Embedding pour le traitement afin de fournir une plus grande précision lors des requêtes des utilisateurs.",
    ...
    retrievalSetting: {
      ...
      longDescription:
        "À propos de la méthode de récupération, vous pouvez la modifier à tout moment dans les paramètres de Connaissance.",
    },
    save: "Enregistrer",
    me: "(Vous)",
    ...
    indexMethodChangeToEconomyDisabledTip:
      "Non disponible pour le déclassement de HQ à ECO",
    upgradeHighQualityTip:
      "Une fois la mise à niveau vers le mode Haute Qualité, il n’est pas possible de revenir au mode Économique",
