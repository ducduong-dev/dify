const translation = {
  list: {
    title: "Documents",
    desc: "Tous les fichiers de la Connaissance sont affichés ici, et l'ensemble de la Connaissance peut être lié aux citations IDX ou indexé via le plugin Chat.",
    ...
    delete: {
      ...
      content:
        "Si vous avez besoin de reprendre le traitement plus tard, vous continuerez à partir de l'endroit où vous vous êtes arrêté",
    },
    batchModal: {
  ...
  embedding: {
    ...
    custom: "Personnalisé",
    previewTip:
      "L'aperçu du paragraphe sera disponible après la fin de l'embedding.",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "La régénération des blocs enfants remplacera les blocs enfants actuels, y compris les blocs modifiés et les blocs nouvellement ajoutés. La régénération ne peut pas être annulée.",
