const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Votre réglage de max token est élevé, limitant potentiellement l'espace pour les prompts, les requêtes et les données. Envisagez de le définir en dessous de 2/3.",
      setToCurrentModelMaxTokenTip:
        "Le max token est mis à jour à 80% du max token du modèle actuel {{maxToken}}.",
      stop_sequences: "Séquences d'arrêt",
      stop_sequencesTip:
        "Jusqu'à quatre séquences où l'API arrêtera de générer d'autres tokens. Le texte renvoyé ne contiendra pas la séquence d'arrêt.",
  ...
  menus: {
    ...
    plugins: "Plugins",
    pluginsTips:
      "Intégrez des plugins tiers ou créez des AI-Plugins compatibles avec ChatGPT.",
  ...
  account: {
    ...
    passwordTip:
      "Vous pouvez définir un mot de passe permanent si vous ne souhaitez pas utiliser des codes de connexion temporaires.",
    ...
    langGeniusAccountTip:
      "Votre compte IDX et les données utilisateur associées.",
    ...
    deleteSuccessTip:
      "Votre compte a besoin de temps pour terminer la suppression. Nous vous enverrons un e-mail lorsque tout sera terminé.",
    deleteLabel:
      "Pour confirmer, veuillez saisir votre adresse e-mail ci-dessous",
  ...
  members: {
    ...
    adminTip:
      "Peut construire des applications & gérer les paramètres de l'équipe",
    normal: "Normal",
    normalTip:
    ...
    emailNotSetup:
      "Le serveur de messagerie n'est pas configuré, les e-mails d'invitation ne peuvent donc pas être envoyés. Veuillez informer les utilisateurs du lien d'invitation qui sera émis après l'invitation.",
    ...
    invitationSentTip:
      "Invitation envoyée, et ils peuvent se connecter à IDX pour accéder aux données de votre équipe.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Cette clé API n'a pas de quota disponible, veuillez lire",
    ...
    azure: {
      ...
      apiBasePlaceholder:
        "L'URL de base de l'API de votre point de terminaison Azure OpenAI.",
      apiKey: "Clé API",
    ...
    openaiHosted: {
      ...
      desc: "Le service d'hébergement OpenAI fourni par IDX vous permet d'utiliser des modèles tels que GPT-3.5. Avant que votre quota d'essai ne soit épuisé, vous devez configurer d'autres fournisseurs de modèles.",
      callTimes: "Temps d'appel",
      usedUp:
        "Quota d'essai épuisé. Ajoutez votre propre fournisseur de modèle.",
    ...
    anthropicHosted: {
      ...
      close: "Fermer",
      trialQuotaTip:
        "Votre quota d’essai Anthropic expirera le 11/03/2025 et ne sera plus disponible par la suite. Veuillez l’utiliser à temps.",
    },
    anthropic: {
      using: "La capacité d'embedding est utilisée",
      enableTip:
        "Pour activer le modèle Anthropic, vous devez d'abord vous lier à OpenAI ou au service Azure OpenAI.",
  ...
  modelProvider: {
    notConfigured:
      "Le modèle du système n'a pas encore été entièrement configuré, et certaines fonctions peuvent être indisponibles.",
    systemModelSettings: "Paramètres du Modèle Système",
    systemModelSettingsLink:
      "Pourquoi est-il nécessaire de mettre en place un modèle de système ?",
    ...
    item: {
      deleteDesc:
        "{{modelName}} sont utilisés comme modèles de raisonnement système. Certaines fonctions ne seront pas disponibles après la suppression. Veuillez confirmer.",
    ...
    providerManagedDescription:
      "Utilisez l’ensemble unique d’informations d’identification fourni par le fournisseur de modèle.",
    loadBalancingHeadline: "Équilibrage",
    loadBalancing: "Équilibrage",
    loadBalancingLeastKeyWarning:
      "Pour activer l’équilibrage de charge, au moins 2 clés doivent être activées.",
    apiKey: "API-KEY",
    apiKeyStatusNormal: "L’état de l’APIKey est normal",
    configLoadBalancing: "Équilibrage de charge de configuration",
    loadBalancingInfo:
      "Par défaut, l’équilibrage de charge utilise la stratégie Round-robin. Si la limitation de vitesse est déclenchée, une période de recharge de 1 minute sera appliquée.",
    editConfig: "Modifier la configuration",
    addConfig: "Ajouter une configuration",
    apiKeyRateLimit:
      "La limite de débit a été atteinte, disponible après {{secondes}}s",
    defaultConfig: "Configuration par défaut",
    loadBalancingDescription:
      "Réduisez la pression grâce à plusieurs ensembles d’informations d’identification.",
    providerManaged: "Géré par le fournisseur",
    upgradeForLoadBalancing:
      "Mettez à niveau votre plan pour activer l’équilibrage de charge.",
  ...
  dataSource: {
    ...
    notion: {
      title: "Notion",
      description:
        "Utiliser Notion comme source de données pour la Connaissance.",
    ...
    website: {
      ...
      title: "Site internet",
      description:
        "Importez du contenu à partir de sites Web à l’aide du robot d’indexation.",
    },
  ...
  apiBasedExtension: {
    title:
      "Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Dify.",
    link: "Apprenez comment développer votre propre Extension API.",
    linkUrl:
      "https://idx-solutions.com/fonctionnalites/extension/extension_basee_sur_api",
    ...
    modal: {
      ...
      apiKey: {
        ...
        lengthError:
          "La longueur de la clé API ne peut pas être inférieure à 5 caractères",
      },
    },
    type: "Tapez",
  },
  ...
  datasetMenus: {
    ...
    settings: "Paramètres",
    emptyTip:
      "La Connaissance n'a pas été associée, veuillez aller à l'application ou au plug-in pour compléter l'association.",
  ...
  promptEditor: {
    placeholder:
      "Écrivez votre mot d'invite ici, entrez '{' pour insérer une variable, entrez '/' pour insérer un bloc de contenu d'invite",
    context: {
      item: {
        title: "Contexte",
      ...
      modal: {
        ...
        footer:
          "Vous pouvez gérer les contextes dans la section Contexte ci-dessous.",
      },
    },
    history: {
      item: {
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "La lecture de l'image a échoué, veuillez réessayer.",
    uploadFromComputerUploadError:
      "Le téléchargement de l'image a échoué, veuillez télécharger à nouveau.",
    uploadFromComputerLimit:
      "Le téléchargement d'images ne peut pas dépasser {{size}} MB",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "Échec de la lecture du fichier, veuillez réessayer.",
    uploadFromComputerUploadError:
      "Le téléchargement du fichier a échoué, veuillez le télécharger à nouveau.",
    fileExtensionNotSupport: "Extension de fichier non prise en charge",
    pasteFileLinkInvalid: "Lien de fichier non valide",
    uploadFromComputerLimit:
      "Le fichier de téléchargement ne peut pas dépasser {{size}}",
  },
  license: {
