const translation = {
  ...
  createDatasetIntro:
    "Importez vos propres données textuelles ou écrivez des données en temps réel via Webhook pour l'amélioration du contexte LLM.",
  ...
  datasetUsedByApp:
    "La connaissance est utilisée par certaines applications. Les applications ne pourront plus utiliser cette Connaissance, et toutes les configurations de prompts et les journaux seront définitivement supprimés.",
  ...
  unavailableTip:
    "Le modèle d'embedding n'est pas disponible, le modèle d'embedding par défaut doit être configuré",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "Générez des embeddings de requête et recherchez le morceau de texte le plus similaire à sa représentation vectorielle.",
    },
    full_text_search: {
      title: "Recherche en Texte Intégral",
      description:
        "Indexez tous les termes dans le document, permettant aux utilisateurs de rechercher n'importe quel terme et de récupérer le fragment de texte pertinent contenant ces termes.",
    },
    hybrid_search: {
      title: "Recherche Hybride",
      description:
        "Exécutez une recherche en texte intégral et des recherches vectorielles en même temps, réorganisez pour sélectionner la meilleure correspondance pour la requête de l'utilisateur. La configuration de l'API du modèle de réorganisation est nécessaire.",
      recommend: "Recommander",
    },
    invertedIndex: {
      title: "Index inversé",
      description:
        "L'Index inversé est une structure utilisée pour une récupération efficace. Organisé par termes, chaque terme pointe vers des documents ou des pages web le contenant.",
    },
    change: "Changer",
  ...
  mixtureHighQualityAndEconomicTip:
    "Le modèle de reclassement est nécessaire pour le mélange de bases de connaissances de haute qualité et économiques.",
  ...
  weightedScore: {
    title: "Score pondéré",
    description:
      "En ajustant les poids attribués, cette stratégie de reclassement détermine s'il faut prioriser la correspondance sémantique ou par mots-clés.",
  ...
  nTo1RetrievalLegacy:
    "La récupération N-à-1 sera officiellement obsolète à partir de septembre. Il est recommandé d'utiliser la dernière récupération multi-chemins pour obtenir de meilleurs résultats.",
  nTo1RetrievalLegacyLink: "En savoir plus",
  nTo1RetrievalLegacyLinkText:
    "La récupération N-à-1 sera officiellement obsolète en septembre.",
  defaultRetrievalTip:
    "La récupération à chemins multiples est utilisée par défaut. Les connaissances sont extraites de plusieurs bases de connaissances, puis reclassées.",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "Pour vous connecter à une base de connaissances externe, vous devez d’abord créer une API externe. Veuillez lire attentivement et vous référer à",
    },
  ...
  connectHelper: {
    ...
    helper1:
      "Connectez-vous à des bases de connaissances externes via l’API et l’ID de base de connaissances.",
  },
  ...
  mixtureInternalAndExternalTip:
    "Le modèle Rerank est nécessaire pour mélanger les connaissances internes et externes.",
  ...
  externalAPIPanelDocumentation:
    "Découvrez comment créer une API de connaissances externe",
  createNewExternalAPI: "Créer une API de connaissances externe",
  externalKnowledgeDescriptionPlaceholder:
    "Décrivez le contenu de cette base de connaissances (facultatif)",
  externalAPIPanelDescription:
    "L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de IDX et récupérer des connaissances de cette base de connaissances.",
  externalKnowledgeId: "Identification des connaissances externes",
  externalAPIPanelTitle: "API de connaissances externes",
  noExternalKnowledge:
    "Il n’y a pas encore d’API de connaissances externes, cliquez ici pour créer",
  learnHowToWriteGoodKnowledgeDescription:
    "Apprenez à rédiger une bonne description des connaissances",
  chunkingMode: {
    general: "Généralités",
  ...
  documentsDisabled:
    "{{num}} documents désactivés - inactifs depuis plus de 30 jours",
  localDocs: "Docs locaux",
  enable: "Activer",
  allKnowledge: "Toutes les connaissances",
  allKnowledgeDescription:
    "Sélectionnez cette option pour afficher toutes les connaissances dans cet espace de travail. Seul le propriétaire de l’espace de travail peut gérer toutes les connaissances.",
};
