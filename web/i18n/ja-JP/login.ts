const translation = {
  ...
  setAdminAccountDesc:
    "アプリケーションの作成やLLMプロバイダの管理など、管理者アカウントの最大権限を設定します。",
  ...
  rightDesc:
    "魅力的で操作可能で改善可能なAIアプリケーションを簡単に構築します。",
  tos: "利用規約",
  pp: "プライバシーポリシー",
  tosDesc: "サインアップすることで、以下に同意するものとします",
  goToInit:
    "アカウントを初期化していない場合は、初期化ページに移動してください",
  dontHave: "お持ちでない場合",
  ...
  forgotPasswordDesc:
    "パスワードをリセットするためにメールアドレスを入力してください。パスワードのリセット方法に関する指示が記載されたメールを送信します。",
  checkEmailForResetLink:
    "パスワードリセットリンクを確認するためにメールを確認してください。数分以内に表示されない場合は、スパムフォルダーを確認してください。",
  ...
  error: {
    ...
    passwordInvalid:
      "パスワードは文字と数字を含み、長さは8以上である必要があります",
  ...
  resetPasswordDesc:
    "Difyへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。",
  licenseLost: "ライセンスを失った",
  licenseExpiredTip:
    "ワークスペースの IDX Enterprise ライセンスの有効期限が切れています。Difyを引き続き使用するには、管理者に連絡してください。",
  licenseInactive: "ライセンスが非アクティブです",
  licenseInactiveTip:
    "ワークスペースの IDX Enterprise ライセンスが非アクティブです。Difyを引き続き使用するには、管理者に連絡してください。",
  licenseExpired: "ライセンスの有効期限が切れています",
  licenseLostTip:
    "Difyライセンスサーバーへの接続に失敗しました。続けてDifyを使用するために管理者に連絡してください。",
};
