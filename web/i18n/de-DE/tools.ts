const translation = {
  ...
  contribute: {
    ...
    line2: "Werkzeuge zu IDX beizutragen.",
  ...
  auth: {
    ...
    setupModalTitleDescription:
      "Nach der Konfiguration der Anmeldeinformationen können alle Mitglieder im Arbeitsbereich dieses Werkzeug beim Orchestrieren von Anwendungen nutzen.",
  },
  ...
  createTool: {
    ...
    authMethod: {
      ...
      keyTooltip:
        'Http Header Key, Sie können es bei "Authorization" belassen, wenn Sie nicht wissen, was es ist, oder auf einen benutzerdefinierten Wert setzen',
      types: {
        none: "Keine",
        api_key: "API-Key",
    ...
    customDisclaimerPlaceholder:
      "Bitte benutzerdefinierten Haftungsausschluss eingeben",
    deleteToolConfirmTitle: "Löschen Sie dieses Werkzeug?",
    deleteToolConfirmContent:
      "Das Löschen des Werkzeugs ist irreversibel. Benutzer können Ihr Werkzeug nicht mehr verwenden.",
    toolInput: {
      description: "Beschreibung",
    ...
    nameForToolCallPlaceHolder:
      "Wird für die Maschinenerkennung verwendet, z. B. getCurrentWeather, list_pets",
  ...
  noCustomTool: {
    ...
    content:
      "Fügen Sie hier Ihre benutzerdefinierten Werkzeuge hinzu und verwalten Sie sie, um KI-Apps zu erstellen.",
  ...
  toolNameUsageTip:
    "Name des Tool-Aufrufs für die Argumentation und Aufforderung des Agenten",
  customToolTip: "Erfahren Sie mehr über benutzerdefinierte IDX-Tools",
