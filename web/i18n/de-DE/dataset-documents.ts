const translation = {
  list: {
    title: "Dokumente",
    desc: "Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit IDX-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.",
    ...
    empty: {
      ...
      sync: {
        tip: "IDX wird periodisch Dateien von Ihrem Notion herunterladen und die Verarbeitung abschließen.",
      },
    },
    delete: {
      title: "Sind Sie sicher, dass Sie löschen möchten?",
      content:
        "Wenn Sie die Verarbeitung später fortsetzen müssen, werden Sie dort weitermachen, wo Sie aufgehört haben",
    },
    batchModal: {
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Beim Regenerieren von untergeordneten Blöcken werden die aktuellen untergeordneten Blöcke überschrieben, einschließlich bearbeiteter und neu hinzugefügter Blöcke. Die Regeneration kann nicht rückgängig gemacht werden.",
