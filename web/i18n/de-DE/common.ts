const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Ihre Einstellung für maximale Token ist hoch, was den Platz für Eingabeaufforderungen, Abfragen und Daten potenziell begrenzen kann. Erwägen Sie, dies unter 2/3 zu setzen.",
      setToCurrentModelMaxTokenTip:
        "Maximale Token auf 80 % der maximalen Token des aktuellen Modells {{maxToken}} aktualisiert.",
      stop_sequences: "Stop-Sequenzen",
      stop_sequencesTip:
        "Bis zu vier Sequenzen, bei denen die API die Generierung weiterer Token stoppt. Der zurückgegebene Text wird die Stop-Sequenz nicht enthalten.",
    ...
    addMoreModel:
      "Gehen Sie zu den Einstellungen, um mehr Modelle hinzuzufügen",
  ...
  menus: {
    ...
    plugins: "Plugins",
    pluginsTips:
      "Integrieren Sie Plugins von Drittanbietern oder erstellen Sie ChatGPT-kompatible KI-Plugins.",
    datasets: "Wissen",
    datasetsTips:
      "BALD VERFÜGBAR: Importieren Sie Ihre eigenen Textdaten oder schreiben Sie Daten in Echtzeit über Webhook, um den LLM-Kontext zu verbessern.",
    newApp: "Neue App",
  ...
  account: {
    ...
    password: "Passwort",
    passwordTip:
      "Sie können ein dauerhaftes Passwort festlegen, wenn Sie keine temporären Anmeldecodes verwenden möchten",
    ...
    langGeniusAccount: "IDX-Konto",
    langGeniusAccountTip: "Ihr IDX-Konto und zugehörige Benutzerdaten.",
    ...
    deletePrivacyLinkTip:
      "Weitere Informationen darüber, wie wir mit Ihren Daten umgehen, finden Sie in unserer",
    deletePrivacyLink: "Datenschutzrichtlinie.",
    deleteSuccessTip:
      "Das Löschen Ihres Kontos benötigt einige Zeit, um vollständig gelöscht zu werden. Wir senden Ihnen eine E-Mail, wenn alles erledigt ist.",
    deleteLabel:
      "Zur Bestätigung geben Sie bitte unten Ihre E-Mail-Adresse ein",
  ...
  members: {
    ...
    emailNotSetup:
      "E-Mail-Server ist nicht eingerichtet, daher können keine Einladungs-E-Mails versendet werden. Bitte informieren Sie die Benutzer über den Einladungslink, der nach der Einladung ausgestellt wird.",
    email: "E-Mail",
    ...
    invitationSentTip:
      "Einladung gesendet, und sie können sich bei IDX anmelden, um auf Ihre Teamdaten zuzugreifen.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Dieser API-SCHLÜSSEL verfügt über kein verfügbares Kontingent, bitte lesen",
    ...
    openaiHosted: {
      ...
      desc: "Der OpenAI-Hostingdienst von IDX ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.",
      callTimes: "Anrufzeiten",
      usedUp:
        "Probe-Kontingent aufgebraucht. Eigenen Modellanbieter hinzufügen.",
    ...
    anthropicHosted: {
      ...
      close: "Schließen",
      trialQuotaTip:
        "Ihr Anthropic-Testkontingent läuft am 11.03.2025 ab und steht danach nicht mehr zur Verfügung. Bitte machen Sie rechtzeitig davon Gebrauch.",
    },
    anthropic: {
      using: "Die Einbettungsfähigkeit verwendet",
      enableTip:
        "Um das Anthropische Modell zu aktivieren, müssen Sie sich zuerst mit OpenAI oder Azure OpenAI Service verbinden.",
  ...
  modelProvider: {
    notConfigured:
      "Das Systemmodell wurde noch nicht vollständig konfiguriert, und einige Funktionen sind möglicherweise nicht verfügbar.",
    systemModelSettings: "Systemmodell-Einstellungen",
    systemModelSettingsLink:
      "Warum ist es notwendig, ein Systemmodell einzurichten?",
    ...
    item: {
      deleteDesc:
        "{{modelName}} werden als System-Reasoning-Modelle verwendet. Einige Funktionen stehen nach der Entfernung nicht zur Verfügung. Bitte bestätigen.",
    ...
    providerManagedDescription:
      "Verwenden Sie den einzelnen Satz von Anmeldeinformationen, der vom Modellanbieter bereitgestellt wird.",
    loadBalancingDescription:
      "Reduzieren Sie den Druck mit mehreren Sätzen von Anmeldeinformationen.",
    modelHasBeenDeprecated: "Dieses Modell ist veraltet",
    loadBalancingLeastKeyWarning:
      "Um den Lastausgleich zu aktivieren, müssen mindestens 2 Schlüssel aktiviert sein.",
    providerManaged: "Vom Anbieter verwaltet",
    apiKeyStatusNormal: "APIKey-Status ist normal",
    upgradeForLoadBalancing:
      "Aktualisieren Sie Ihren Plan, um den Lastenausgleich zu aktivieren.",
    defaultConfig: "Standardkonfiguration",
    apiKeyRateLimit: "Ratenlimit wurde erreicht, verfügbar nach {{seconds}}s",
    loadBalancingInfo:
      "Standardmäßig wird für den Lastenausgleich die Round-Robin-Strategie verwendet. Wenn die Ratenbegrenzung ausgelöst wird, wird eine Abklingzeit von 1 Minute angewendet.",
    emptyProviderTip: "Bitte installieren Sie zuerst einen Modellanbieter.",
    configureTip:
      "Einrichten des API-Schlüssels oder Hinzufügen des zu verwendenden Modells",
  ...
  apiBasedExtension: {
    title:
      "API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in IDXs Anwendungen.",
    ...
    modal: {
      ...
      apiKey: {
        ...
        lengthError:
          "Die Länge des API-Schlüssels darf nicht weniger als 5 Zeichen betragen",
      },
    },
    type: "Typ",
  },
  about: {
    ...
    nowAvailable: "IDX {{version}} ist jetzt verfügbar.",
    latestAvailable: "IDX {{version}} ist die neueste verfügbare Version.",
  },
  appMenus: {
    overview: "Übersicht",
  ...
  datasetMenus: {
    ...
    settings: "Einstellungen",
    emptyTip:
      "Das Wissen wurde nicht zugeordnet, bitte gehen Sie zur Anwendung oder zum Plug-in, um die Zuordnung abzuschließen.",
  ...
  promptEditor: {
    placeholder:
      "Schreiben Sie hier Ihr Aufforderungswort, geben Sie '{' ein, um eine Variable einzufügen, geben Sie '/' ein, um einen Aufforderungs-Inhaltsblock einzufügen",
    context: {
      item: {
        title: "Kontext",
      ...
      modal: {
        ...
        footer:
          "Sie können Kontexte im unten stehenden Kontextabschnitt verwalten.",
      },
    },
    history: {
      item: {
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Bildlesung fehlgeschlagen, bitte versuchen Sie es erneut.",
    uploadFromComputerUploadError:
      "Bildupload fehlgeschlagen, bitte erneut hochladen.",
    uploadFromComputerLimit:
      "Hochgeladene Bilder dürfen {{size}} MB nicht überschreiten",
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "Datei-Upload fehlgeschlagen, bitte erneut hochladen.",
    uploadFromComputerLimit:
      "Datei hochladen darf {{size}} nicht überschreiten",
    uploadFromComputerReadError:
      "Lesen der Datei fehlgeschlagen, bitte versuchen Sie es erneut.",
