const translation = {
  ...
  createDatasetIntro:
    "Importiere deine eigenen Textdaten oder schreibe Daten in Echtzeit über Webhook für die LLM-Kontextverbesserung.",
  ...
  datasetUsedByApp:
    "Das Wissen wird von einigen Apps verwendet. Apps werden dieses Wissen nicht mehr nutzen können, und alle Prompt-Konfigurationen und Protokolle werden dauerhaft gelöscht.",
  datasetDeleted: "Wissen gelöscht",
  datasetDeleteFailed: "Löschen des Wissens fehlgeschlagen",
  didYouKnow: "Wusstest du schon?",
  intro1: "Das Wissen kann in die IDX-Anwendung ",
  intro2: "als Kontext",
  intro3: ",",
  intro4: "oder es ",
  ...
  unavailableTip:
    "Einbettungsmodell ist nicht verfügbar, das Standard-Einbettungsmodell muss konfiguriert werden",
  datasets: "WISSEN",
  datasetsApi: "API",
  retrieval: {
    semantic_search: {
      title: "Vektorsuche",
      description:
        "Erzeuge Abfrage-Einbettungen und suche nach dem Textstück, das seiner Vektorrepräsentation am ähnlichsten ist.",
    },
    full_text_search: {
      title: "Volltextsuche",
      description:
        "Indiziere alle Begriffe im Dokument, sodass Benutzer jeden Begriff suchen und den relevanten Textabschnitt finden können, der diese Begriffe enthält.",
    },
    hybrid_search: {
      title: "Hybridsuche",
      description:
        "Führe Volltextsuche und Vektorsuchen gleichzeitig aus, ordne neu, um die beste Übereinstimmung für die Abfrage des Benutzers auszuwählen. Konfiguration des Rerank-Modell-APIs ist notwendig.",
      recommend: "Empfehlen",
    },
    invertedIndex: {
      title: "Invertierter Index",
      description:
        "Ein invertierter Index ist eine Struktur, die für effiziente Abfragen verwendet wird. Organisiert nach Begriffen, zeigt jeder Begriff auf Dokumente oder Webseiten, die ihn enthalten.",
    },
    change: "Ändern",
  ...
  mixtureHighQualityAndEconomicTip:
    "Für die Mischung von hochwertigen und wirtschaftlichen Wissensbasen ist das Rerank-Modell erforderlich.",
  inconsistentEmbeddingModelTip:
    "Das Rerank-Modell ist erforderlich, wenn die Embedding-Modelle der ausgewählten Wissensbasen inkonsistent sind.",
  retrievalSettings: "Abrufeinstellungen",
  rerankSettings: "Rerank-Einstellungen",
  weightedScore: {
    title: "Gewichtete Bewertung",
    description:
      "Durch Anpassung der zugewiesenen Gewichte bestimmt diese Rerank-Strategie, ob semantische oder Schlüsselwort-Übereinstimmung priorisiert werden soll.",
  ...
  nTo1RetrievalLegacy:
    "N-zu-1-Abruf wird ab September offiziell eingestellt. Es wird empfohlen, den neuesten Multi-Pfad-Abruf zu verwenden, um bessere Ergebnisse zu erzielen.",
  nTo1RetrievalLegacyLink: "Mehr erfahren",
  nTo1RetrievalLegacyLinkText:
    "N-zu-1-Abruf wird im September offiziell eingestellt.",
  defaultRetrievalTip:
    "Standardmäßig wird der Multi-Path-Abruf verwendet. Das Wissen wird aus mehreren Wissensdatenbanken abgerufen und dann neu eingestuft.",
  ...
  connectDatasetIntro: {
    content: {
      front:
        "Um eine Verbindung zu einer externen Wissensdatenbank herzustellen, müssen Sie zuerst eine externe API erstellen. Bitte lesen Sie diese sorgfältig durch und beziehen Sie sich auf",
    ...
    title:
      "So stellen Sie eine Verbindung zu einer externen Wissensdatenbank her",
  },
  connectHelper: {
    ...
    helper1:
      "Verbinden Sie sich mit externen Wissensdatenbanken über API und Wissensdatenbank-ID.",
  },
  ...
  externalAPIPanelDescription:
    "Die API für externes Wissen wird verwendet, um eine Verbindung zu einer Wissensdatenbank außerhalb von IDX herzustellen und Wissen aus dieser Wissensdatenbank abzurufen.",
  createNewExternalAPI: "Erstellen einer neuen API für externes Wissen",
  externalKnowledgeDescriptionPlaceholder:
    "Beschreiben Sie, was in dieser Wissensdatenbank enthalten ist (optional)",
  externalAPIPanelDocumentation:
    "Erfahren Sie, wie Sie eine API für externes Wissen erstellen",
  externalAPIPanelTitle: "API für externes Wissen",
  learnHowToWriteGoodKnowledgeDescription:
    "Erfahren Sie, wie Sie eine gute Wissensbeschreibung schreiben",
  editExternalAPITooltipTitle: "VERKNÜPFTES WISSEN",
  externalKnowledgeIdPlaceholder: "Bitte geben Sie die Knowledge ID ein",
  connectDataset:
    "Herstellen einer Verbindung mit einer externen Wissensdatenbank",
  externalAPI: "Externe API",
  externalKnowledgeName: "Name des externen Wissens",
  allExternalTip:
    "Wenn nur externes Wissen verwendet wird, kann der Benutzer auswählen, ob das Rerank-Modell aktiviert werden soll. Wenn diese Option nicht aktiviert ist, werden die abgerufenen Blöcke basierend auf den Punktzahlen sortiert. Wenn die Abrufstrategien verschiedener Wissensdatenbanken inkonsistent sind, ist dies ungenau.",
  externalKnowledgeDescription: "Wissen Beschreibung",
  noExternalKnowledge:
    "Es gibt noch keine External Knowledge API, klicken Sie hier, um zu erstellen",
  externalKnowledgeNamePlaceholder:
    "Bitte geben Sie den Namen der Wissensdatenbank ein.",
  mixtureInternalAndExternalTip:
    "Das Rerank-Modell ist für die Mischung von internem und externem Wissen erforderlich.",
  ...
  documentsDisabled:
    "{{num}} Dokumente deaktiviert - seit über 30 Tagen inaktiv",
  allKnowledge: "Alles Wissen",
  allKnowledgeDescription:
    "Wählen Sie diese Option aus, um das gesamte Wissen in diesem Arbeitsbereich anzuzeigen. Nur der Workspace-Besitzer kann das gesamte Wissen verwalten.",
};
