const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "โควต้าทดลองใช้มีไว้เพื่อวัตถุประสงค์ในการทดสอบของคุณ ก่อนที่โควต้าทดลองใช้จะหมด โปรดตั้งค่าผู้ให้บริการโมเดลของคุณเองหรือซื้อโควต้าเพิ่มเติม",
      },
      exhausted: {
        title: "โควต้าทดลองใช้ของคุณหมดแล้ว โปรดตั้งค่า APIKey ของคุณ",
        description:
          "คุณใช้โควต้าทดลองใช้หมดแล้ว โปรดตั้งค่าผู้ให้บริการโมเดลของคุณเองหรือซื้อโควต้าเพิ่มเติม",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "หรือลองใช้ IDX เวอร์ชันคลาวด์พร้อมใบเสนอราคาฟรี",
  },
  overview: {
    title: "ภาพรวม",
    appInfo: {
      ...
      settings: {
        ...
        webDescTip:
          "ข้อความนี้จะแสดงที่ฝั่งไคลเอ็นต์ โดยให้คําแนะนําพื้นฐานเกี่ยวกับวิธีการใช้แอปพลิเคชัน",
        ...
        more: {
          ...
          privacyPolicyTip:
            "ช่วยให้ผู้เยี่ยมชมเข้าใจข้อมูลที่แอปพลิเคชันรวบรวม โปรดดูนโยบาย<privacyPolicyLink>ความเป็นส่วนตัว</privacyPolicyLink>ของ Dify",
          customDisclaimer: "ข้อจํากัดความรับผิดชอบที่กําหนดเอง",
          customDisclaimerPlaceholder:
            "ป้อนข้อความข้อจํากัดความรับผิดชอบที่กําหนดเอง",
          customDisclaimerTip:
            "ข้อความปฏิเสธความรับผิดชอบที่กําหนดเองจะแสดงที่ฝั่งไคลเอ็นต์ โดยให้ข้อมูลเพิ่มเติมเกี่ยวกับแอปพลิเคชัน",
      ...
      embedded: {
        ...
        iframe:
          "หากต้องการเพิ่มแอปแชทที่ใดก็ได้บนเว็บไซต์ของคุณ ให้เพิ่ม iframe นี้ลงในโค้ด html ของคุณ",
        scripts:
          "หากต้องการเพิ่มแอปแชทที่ด้านขวาล่างของเว็บไซต์ ให้เพิ่มโค้ดนี้ลงใน html ของคุณ",
        chromePlugin: "ติดตั้งส่วนขยาย IDX Chatbot Chrome",
        copied: "คัด ลอก",
        copy: "ลอก",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "คุณสามารถปรับแต่งส่วนหน้าของ Web App ให้เหมาะกับสถานการณ์และความต้องการสไตล์ของคุณได้",
        way1: {
          name: "แยกรหัสไคลเอ็นต์ แก้ไข และปรับใช้กับ Vercel (แนะนํา)",
          step1: "แยกรหัสไคลเอ็นต์และแก้ไข",
          step1Tip:
            "คลิกที่นี่เพื่อแยกซอร์สโค้ดลงในบัญชี GitHub ของคุณและแก้ไขโค้ด",
  ...
  analysis: {
    ...
    activeUsers: {
      ...
      explanation:
        "ผู้ใช้ที่ไม่ซ้ํากันมีส่วนร่วมในการถามตอบกับ AI ไม่รวมวิศวกรรม/ดีบักพร้อมท์",
    },
    tokenUsage: {
      title: "การใช้โทเค็น",
      explanation:
        "สะท้อนถึงการใช้โทเค็นรายวันของโมเดลภาษาสําหรับแอปพลิเคชัน ซึ่งมีประโยชน์สําหรับวัตถุประสงค์ในการควบคุมต้นทุน",
      consumed: "ใช้",
    },
    avgSessionInteractions: {
      title: "การโต้ตอบเซสชันโดยเฉลี่ย",
      explanation:
        "จํานวนการสื่อสารระหว่างผู้ใช้และ AI อย่างต่อเนื่อง สําหรับแอปที่ใช้การสนทนา",
    },
    avgUserInteractions: {
      title: "การโต้ตอบของผู้ใช้โดยเฉลี่ย",
      explanation:
        "สะท้อนถึงความถี่ในการใช้งานรายวันของผู้ใช้ เมตริกนี้สะท้อนถึงความเหนียวแน่นของผู้ใช้",
    },
    userSatisfactionRate: {
      title: "อัตราความพึงพอใจของผู้ใช้",
      explanation:
        "จํานวนไลค์ต่อ 1,000 ข้อความ สิ่งนี้บ่งชี้ถึงสัดส่วนของคําตอบที่ผู้ใช้พึงพอใจอย่างมาก",
    },
    avgResponseTime: {
      title: "เวลาตอบสนองเฉลี่ย",
      explanation:
        "เวลา (มิลลิวินาที) สําหรับ AI ในการประมวลผล/ตอบสนอง สําหรับแอปที่ใช้ข้อความ",
    },
    tps: {
      title: "ความเร็วในการส่งออกโทเค็น",
      explanation:
        "วัดประสิทธิภาพของ LLM นับความเร็วในการส่งออกโทเค็นของ LLM ตั้งแต่เริ่มต้นคําขอจนถึงเสร็จสิ้นเอาต์พุต",
    },
  },
};
