const translation = {
  ...
  externalKnowledgeDescriptionPlaceholder:
    "อธิบายสิ่งที่อยู่ในฐานความรู้นี้ (ไม่บังคับ)",
  learnHowToWriteGoodKnowledgeDescription:
    "เรียนรู้วิธีการเขียนคําอธิบายความรู้ที่ดี",
  externalAPIPanelDescription:
    "API ความรู้ภายนอกใช้เพื่อเชื่อมต่อกับฐานความรู้ภายนอก IDX และดึงความรู้จากฐานความรู้นั้น",
  ...
  connectDatasetIntro: {
    ...
    content: {
      front:
        "เมื่อต้องการเชื่อมต่อกับฐานความรู้ภายนอก คุณต้องสร้าง API ภายนอกก่อน โปรดอ่านอย่างละเอียดและอ้างอิง",
  ...
  createDatasetIntro:
    "นําเข้าข้อมูลข้อความของคุณเองหรือเขียนข้อมูลแบบเรียลไทม์ผ่าน Webhook เพื่อปรับปรุงบริบท LLM",
  deleteDatasetConfirmTitle: "ลบความรู้นี้?",
  deleteDatasetConfirmContent:
    "การลบความรู้นั้นไม่สามารถย้อนกลับได้ ผู้ใช้จะไม่สามารถเข้าถึงความรู้ของคุณอีกต่อไป และการกําหนดค่าพร้อมท์และบันทึกทั้งหมดจะถูกลบอย่างถาวร",
  datasetUsedByApp:
    "ความรู้นี้ถูกใช้โดยบางแอป แอปจะไม่สามารถใช้ความรู้นี้ได้อีกต่อไป และการกําหนดค่าพร้อมท์และบันทึกทั้งหมดจะถูกลบอย่างถาวร",
  datasetDeleted: "ลบความรู้",
  datasetDeleteFailed: "ลบความรู้ไม่สําเร็จ",
  didYouKnow: "คุณรู้หรือไม่?",
  intro1: "ความรู้สามารถรวมเข้ากับแอปพลิเคชัน IDX ได้",
  intro2: "ตามบริบท",
  intro3: ",",
  intro4: "หรือมัน",
  ...
  unavailable: "ไม่",
  unavailableTip:
    "โมเดลการฝังไม่พร้อมใช้งาน จําเป็นต้องกําหนดค่าโมเดลการฝังเริ่มต้น",
  datasets: "ความรู้",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "สร้างการฝังแบบสอบถามและค้นหาส่วนข้อความที่คล้ายกับการแสดงเวกเตอร์มากที่สุด",
    },
    full_text_search: {
      title: "การค้นหาข้อความแบบเต็ม",
      description:
        "จัดทําดัชนีคําศัพท์ทั้งหมดในเอกสาร เพื่อให้ผู้ใช้สามารถค้นหาคําศัพท์ใดก็ได้และดึงข้อความที่เกี่ยวข้องที่มีคําเหล่านั้น",
    },
    hybrid_search: {
      title: "การค้นหาแบบไฮบริด",
      description:
        "ดําเนินการค้นหาข้อความแบบเต็มและการค้นหาแบบเวกเตอร์พร้อมกันจัดอันดับใหม่เพื่อเลือกการจับคู่ที่ดีที่สุดสําหรับคําค้นหาของผู้ใช้ ผู้ใช้สามารถเลือกที่จะตั้งค่าน้ําหนักหรือกําหนดค่าเป็นโมเดล Rerank",
      recommend: "แนะนำ",
    },
    invertedIndex: {
      title: "ดัชนีกลับด้าน",
      description:
        "Inverted Index เป็นโครงสร้างที่ใช้สําหรับการดึงข้อมูลอย่างมีประสิทธิภาพ จัดเรียงตามคําศัพท์ แต่ละคําชี้ไปที่เอกสารหรือหน้าเว็บที่มีคําดังกล่าว",
    },
    change: "เปลี่ยน",
  ...
  defaultRetrievalTip:
    "การดึงข้อมูลหลายเส้นทางจะถูกใช้โดยค่าเริ่มต้น ความรู้จะถูกดึงมาจากฐานความรู้หลายแห่งแล้วจัดอันดับใหม่",
  mixtureHighQualityAndEconomicTip:
    "โมเดล Rerank จําเป็นสําหรับการผสมผสานระหว่างฐานความรู้คุณภาพสูงและประหยัด",
  inconsistentEmbeddingModelTip:
    "จําเป็นต้องมีแบบจําลอง Rerank หากแบบจําลองการฝังของฐานความรู้ที่เลือกไม่สอดคล้องกัน",
  mixtureInternalAndExternalTip:
    "โมเดล Rerank จําเป็นสําหรับการผสมผสานระหว่างความรู้ภายในและภายนอก",
  allExternalTip:
    "เมื่อใช้ความรู้ภายนอกเท่านั้น ผู้ใช้สามารถเลือกได้ว่าจะเปิดใช้งานโมเดล Rerank หรือไม่ หากไม่ได้เปิดใช้งาน ก้อนที่ดึงมาจะถูกจัดเรียงตามคะแนน เมื่อกลยุทธ์การดึงข้อมูลของฐานความรู้ที่แตกต่างกันไม่สอดคล้องกัน ก็จะไม่ถูกต้อง",
  retrievalSettings: "การตั้งค่าการดึงข้อมูล",
  rerankSettings: "การตั้งค่ารีไลน์",
  weightedScore: {
    title: "คะแนนถ่วงน้ําหนัก",
    description:
      "กลยุทธ์การจัดอันดับใหม่นี้จะกําหนดว่าควรจัดลําดับความสําคัญของการจับคู่ความหมายหรือคีย์เวิร์ด",
  ...
  nTo1RetrievalLegacyLinkText:
    "การดึงข้อมูล N-to-1 จะเลิกใช้อย่างเป็นทางการในเดือนกันยายน",
  chunkingMode: {
    general: "ทั่วไป",
  ...
  allKnowledgeDescription:
    "เลือกเพื่อแสดงความรู้ทั้งหมดในพื้นที่ทํางานนี้ เฉพาะเจ้าของพื้นที่ทํางานเท่านั้นที่สามารถจัดการความรู้ทั้งหมดได้",
};
