const translation = {
  ...
  welcome: "👋 ยินดีต้อนรับสู่ IDX โปรดเข้าสู่ระบบเพื่อดําเนินการต่อ",
  email: "ที่อยู่อีเมล",
  ...
  setAdminAccountDesc:
    "สิทธิ์สูงสุดสําหรับบัญชีผู้ดูแลระบบ ซึ่งสามารถใช้สร้างแอปพลิเคชันและจัดการผู้ให้บริการ LLM เป็นต้น",
  ...
  rightDesc:
    "สร้างแอปพลิเคชัน AI ที่ดึงดูดสายตา ใช้งานได้ และปรับปรุงได้อย่างง่ายดาย",
  ...
  forgotPasswordDesc:
    "โปรดป้อนที่อยู่อีเมลของคุณเพื่อรีเซ็ตรหัสผ่านของคุณ เราจะส่งอีเมลพร้อมคําแนะนําเกี่ยวกับวิธีการรีเซ็ตรหัสผ่านของคุณ",
  checkEmailForResetLink:
    "โปรดตรวจสอบอีเมลของคุณเพื่อหาลิงก์สําหรับรีเซ็ตรหัสผ่านของคุณ หากไม่ปรากฏขึ้นภายใน 2-3 นาที โปรดตรวจสอบโฟลเดอร์สแปมของคุณ",
  ...
  license: {
    tip: "ก่อนเริ่ม IDX Community Edition โปรดอ่าน GitHub",
  ...
  resetPasswordDesc:
    "พิมพ์อีเมลที่คุณใช้ลงทะเบียนบน IDX แล้วเราจะส่งอีเมลรีเซ็ตรหัสผ่านให้คุณ",
  ...
  licenseExpiredTip:
    "สิทธิ์การใช้งาน IDX Enterprise สําหรับพื้นที่ทํางานของคุณหมดอายุแล้ว โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ IDX ต่อไป",
  licenseLost: "ใบอนุญาตสูญหาย",
  licenseLostTip:
    "เชื่อมต่อเซิร์ฟเวอร์ใบอนุญาต IDX ไม่สําเร็จ โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ IDX ต่อไป",
  licenseInactive: "ใบอนุญาตไม่ใช้งาน",
  licenseInactiveTip:
    "สิทธิ์การใช้งาน IDX Enterprise สําหรับพื้นที่ทํางานของคุณไม่ได้ใช้งาน โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ IDX ต่อไป",
};
