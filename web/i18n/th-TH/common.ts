const translation = {
  ...
  model: {
    params: {
      ...
      temperatureTip:
        "ควบคุมการสุ่ม: การลดระดับส่งผลให้การสุ่มเสร็จน้อยลง เมื่ออุณหภูมิเข้าใกล้ศูนย์แบบจําลองจะกลายเป็นการกําหนดและซ้ําซาก",
      top_p: "ท็อป P",
      top_pTip:
        "ควบคุมความหลากหลายผ่านการสุ่มตัวอย่างนิวเคลียส: 0.5 หมายถึงครึ่งหนึ่งของตัวเลือกที่ถ่วงน้ําหนักความน่าจะเป็นทั้งหมดได้รับการพิจารณา",
      presence_penalty: "บทลงโทษการแสดงตน",
      presence_penaltyTip:
        "จะลงโทษโทเค็นใหม่เท่าใดโดยพิจารณาจากว่าโทเค็นเหล่านั้นปรากฏในข้อความหรือไม่\nเพิ่มโอกาสของโมเดลในการพูดคุยเกี่ยวกับหัวข้อใหม่",
      ...
      maxTokenSettingTip:
        "การตั้งค่าโทเค็นสูงสุดของคุณสูง ซึ่งอาจจํากัดพื้นที่สําหรับข้อความแจ้ง แบบสอบถาม และข้อมูล พิจารณาตั้งค่าให้ต่ํากว่า 2/3",
      setToCurrentModelMaxTokenTip:
        "โทเค็นสูงสุดได้รับการอัปเดตเป็นโทเค็นสูงสุด 80% ของรุ่นปัจจุบัน {{maxToken}}",
      stop_sequences: "หยุดลําดับ",
      stop_sequencesTip:
        "สูงสุดสี่ลําดับที่ API จะหยุดสร้างโทเค็นเพิ่มเติม ข้อความที่ส่งคืนจะไม่มีลําดับการหยุด",
  ...
  menus: {
    ...
    plugins: "ปลั๊กอิน",
    pluginsTips:
      "รวมปลั๊กอินของบุคคลที่สามหรือสร้างปลั๊กอิน AI ที่เข้ากันได้กับ ChatGPT",
    datasets: "ความรู้",
    datasetsTips:
      "เร็ว ๆ นี้: นําเข้าข้อมูลข้อความของคุณเองหรือเขียนข้อมูลแบบเรียลไทม์ผ่าน Webhook เพื่อปรับปรุงบริบท LLM",
    newApp: "แอพใหม่",
  ...
  account: {
    ...
    langGeniusAccountTip: "บัญชี IDX และข้อมูลผู้ใช้ที่เกี่ยวข้อง",
    editName: "แก้ไขชื่อ",
    showAppLength: "แสดง {{length}} แอป",
    delete: "ลบบัญชี",
    deleteTip:
      "การลบบัญชีของคุณจะเป็นการลบข้อมูลทั้งหมดของคุณอย่างถาวรและไม่สามารถกู้คืนได้",
    deleteConfirmTip:
      "เพื่อยืนยัน โปรดส่งข้อมูลต่อไปนี้จากอีเมลที่ลงทะเบียนไว้ที่",
    deletePrivacyLinkTip:
      "สําหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีที่เราจัดการกับข้อมูลของคุณ โปรดดูที่",
    ...
    deleteSuccessTip:
      "บัญชีของคุณต้องใช้เวลาในการลบให้เสร็จสิ้น เราจะส่งอีเมลถึงคุณเมื่อทุกอย่างเสร็จสิ้น",
  },
  members: {
    team: "ทีม",
    invite: "เพิ่ม",
    ...
    inviteTeamMemberTip:
      "พวกเขาสามารถเข้าถึงข้อมูลทีมของคุณได้โดยตรงหลังจากลงชื่อเข้าใช้",
    emailNotSetup:
      "เซิร์ฟเวอร์อีเมลไม่ได้ตั้งค่าไว้ จึงไม่สามารถส่งอีเมลเชิญได้ กรุณาแจ้งผู้ใช้เกี่ยวกับลิงก์เชิญที่จะออกหลังจากการเชิญแทน",
    email: "อีเมล",
    ...
    invitationSentTip:
      "ส่งคําเชิญแล้ว และพวกเขาสามารถลงชื่อเข้าใช้ IDX เพื่อเข้าถึงข้อมูลทีมของคุณได้",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: "ทดลองใช้",
      exhausted: "โควต้าหมด",
      desc: "บริการโฮสติ้ง OpenAI ที่ให้บริการโดย IDX ช่วยให้คุณใช้โมเดลต่างๆ เช่น GPT-3.5 ก่อนที่โควต้าการทดลองใช้ของคุณจะหมด คุณจําเป็นต้องตั้งค่าผู้ให้บริการรุ่นอื่นๆ",
      callTimes: "เวลาโทร",
    ...
    anthropicHosted: {
      ...
      close: "ปิด",
      trialQuotaTip:
        "โควต้าการทดลองใช้ Anthropic ของคุณจะหมดอายุในวันที่ 2025/03/11 และจะไม่สามารถใช้งานได้อีกต่อไปหลังจากนั้นโปรดใช้มันให้ทันเวลา",
    },
    anthropic: {
      using: "ความสามารถในการฝังกําลังใช้",
      enableTip:
        "ในการเปิดใช้งานโมเดล Anthropic คุณต้องผูกกับ OpenAI หรือ Azure OpenAI Service ก่อน",
  ...
  modelProvider: {
    notConfigured:
      "โมเดลระบบยังไม่ได้รับการกําหนดค่าอย่างสมบูรณ์ และฟังก์ชันบางอย่างอาจไม่พร้อมใช้งาน",
    ...
    item: {
      deleteDesc:
        "{{modelName}} ถูกใช้เป็นแบบจําลองการให้เหตุผลของระบบ ฟังก์ชันบางอย่างจะไม่สามารถใช้งานได้หลังจากการลบออก กรุณายืนยัน",
      freeQuota: "โควต้าฟรี",
    },
    ...
    providerManagedDescription:
      "ใช้ข้อมูลประจําตัวชุดเดียวที่ผู้ให้บริการโมเดลให้มา",
    ...
    loadBalancingLeastKeyWarning:
      "หากต้องการเปิดใช้งานการปรับสมดุลโหลด ต้องเปิดใช้งานคีย์อย่างน้อย 2 ปุ่ม",
    loadBalancingInfo:
      "ตามค่าเริ่มต้น การปรับสมดุลภาระงานจะใช้กลยุทธ์แบบ Round-robin หากเปิดใช้งานการจํากัดอัตรา จะมีการใช้ระยะเวลาคูลดาวน์ 1 นาที",
  ...
  apiBasedExtension: {
    title:
      "ส่วนขยาย API ให้การจัดการ API แบบรวมศูนย์ ทําให้การกําหนดค่าง่ายขึ้นเพื่อให้ใช้งานได้ง่ายในแอปพลิเคชันของ Dify",
  ...
  datasetMenus: {
    ...
    settings: "การตั้งค่า",
    emptyTip:
      "ความรู้ยังไม่ได้เชื่อมโยง โปรดไปที่แอปพลิเคชันหรือปลั๊กอินเพื่อเชื่อมโยงให้เสร็จสมบูรณ์",
  ...
  promptEditor: {
    placeholder:
      "เขียนคําพร้อมท์ของคุณที่นี่ ป้อน '{' เพื่อแทรกตัวแปร ป้อน '/' เพื่อแทรกบล็อกเนื้อหาพร้อมท์",
    context: {
      item: {
        title: "บริบท",
