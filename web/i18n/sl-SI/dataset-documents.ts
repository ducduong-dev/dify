const translation = {
  list: {
    title: "Dokumenti",
    desc: "Vse datoteke znanja so prikazane tukaj, celotno znanje pa je mogoče povezati s citati IDX ali indeksirati prek vtičnika Chat.",
    ...
    delete: {
      ...
      content:
        "Če boste nadaljevali obdelavo kasneje, boste nadaljevali tam, kjer ste končali.",
    },
    batchModal: {
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Obnavljanje podrejenih kosov bo prepisalo trenutne podrejene koščke, vključno z urejenimi koščki in na novo dodanimi kosi. Regeneracije ni mogoče razveljaviti.",
    editChunk: "Uredi kos",
    chunks_one: "KOS",
