const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Vaša nastavitev za največje število žetonov je visoka, kar lahko omeji prostor za pozive, poizvedbe in podatke. Razmislite o nastavitvi pod 2/3.",
      setToCurrentModelMaxTokenTip:
        "Največje število žetonov je posodobljeno na 80 % največjega števila žetonov trenutnega modela {{maxToken}}.",
      stop_sequences: "Zaporedja ustavljanja",
      stop_sequencesTip:
        "Do štiri zaporedja, kjer bo API prenehal generirati nadaljnje žetone. Vrnjen tekst ne bo vseboval zaporedja ustavitve.",
  ...
  menus: {
    ...
    plugins: "Vtičniki",
    pluginsTips:
      "Integrirajte vtičnike tretjih oseb ali ustvarite vtičnike, združljive s ChatGPT.",
    datasets: "Znanje",
    datasetsTips:
      "KMALU: Uvozite svoje besedilne podatke ali pišite podatke v realnem času preko spletnih kljuk za izboljšanje konteksta LLM.",
  ...
  account: {
    ...
    password: "Geslo",
    passwordTip:
      "Lahko nastavite stalno geslo, če ne želite uporabljati začasnih prijavnih kod",
    ...
    langGeniusAccountTip: "Vaš IDX račun in povezani uporabniški podatki.",
    editName: "Uredi ime",
    showAppLength: "Prikaz {{length}} aplikacij",
    delete: "Izbriši račun",
    deleteTip:
      "Brisanje vašega računa bo trajno izbrisalo vse vaše podatke in jih ne bo mogoče obnoviti.",
    deleteConfirmTip:
      "Za potrditev pošljite naslednje s svojega registriranega e-poštnega naslova na ",
    permanentlyDeleteButton: "Trajno izbriši račun",
    deletePrivacyLinkTip:
      "Za več informacij o tem, kako ravnamo z vašimi podatki, si oglejte naše",
    ...
    deleteSuccessTip:
      "Vaš račun potrebuje čas, da dokonča brisanje. Ko bo vse končano, vam bomo poslali e-pošto.",
  ...
  members: {
    ...
    inviteTeamMemberTip:
      "Do vaših podatkov bo lahko dostopal takoj po prijavi.",
    emailNotSetup:
      "E-poštni strežnik ni nastavljen, zato vabil po e-pošti ni mogoče poslati. Prosimo, obvestite uporabnike o povezavi za povabilo, ki bo izdana po povabilu.",
    email: "E-pošta",
    ...
    invitationSentTip:
      "Povabilo poslano, in po prijavi v IDX bodo imeli dostop do vaših podatkov ekipe.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      usedUp:
        "Kvota za preizkus porabljena. Dodajte svojega ponudnika modelov.",
    ...
    anthropicHosted: {
      ...
      close: "Zapri",
      trialQuotaTip:
        "Vaša kvota za preskušanje antropičnih izdelkov bo potekla 11.3.2025 in po tem datumu ne bo več na voljo. Prosimo, da jo pravočasno izkoristite.",
    },
    anthropic: {
      using: "Zmožnost vdelave uporablja",
      enableTip:
        "Za omogočitev modela Anthropic morate najprej povezati OpenAI ali Azure OpenAI storitev.",
  ...
  modelProvider: {
    notConfigured:
      "Sistemski model še ni popolnoma konfiguriran, nekatere funkcije morda ne bodo na voljo.",
    ...
    item: {
      deleteDesc:
        "{{modelName}} se uporablja kot sistemski model za sklepanja. Nekatere funkcije ne bodo na voljo po odstranitvi. Prosimo, potrdite.",
    ...
    loadBalancingDescription:
      "Zmanjšajte pritisk s pomočjo več sklopov poverilnic.",
    ...
    providerManagedDescription:
      "Uporabite enoten sklop poverilnic, ki jih zagotovi ponudnik modela.",
    defaultConfig: "Privzeta konfiguracija",
    apiKeyStatusNormal: "Stanje API ključa je normalno",
    apiKeyRateLimit:
      "Omejitev hitrosti je dosežena, na voljo po {{seconds}} sekundah",
    addConfig: "Dodaj konfiguracijo",
    editConfig: "Uredi konfiguracijo",
    loadBalancingLeastKeyWarning:
      "Za omogočanje uravnoteženja obremenitev morata biti omogočena vsaj 2 ključa.",
    loadBalancingInfo:
      "Privzeto uravnoteženje obremenitev uporablja strategijo Round-robin. Če se sproži omejitev hitrosti, se uporabi 1-minutno obdobje ohlajanja.",
    upgradeForLoadBalancing:
      "Nadgradite svoj načrt, da omogočite uravnoteženje obremenitev.",
    dataSource: {
      ...
      website: {
        title: "Spletna stran",
        description:
          "Uvoz vsebine s spletnih strani z uporabo spletnega pajka.",
        with: "S",
    ...
    apiBasedExtension: {
      title:
        "Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Dify.",
      link: "Naučite se, kako razviti svojo API razširitev.",
      linkUrl:
        "https://idx-solutions.com/features/extension/api_based_extension",
    ...
    datasetMenus: {
      ...
      settings: "Nastavitve",
      emptyTip:
        "Znanost še ni povezana, pojdite v aplikacijo ali vtičnik, da dokončate povezavo.",
    ...
    promptEditor: {
      placeholder:
        "Tukaj napišite svoje pozivno besedilo, vnesite '{' za vstavljanje spremenljivke, vnesite '/' za vstavljanje vsebinskega bloka poziva",
      context: {
        item: {
          title: "Kontekst",
    ...
    imageUploader: {
      ...
      uploadFromComputerUploadError:
        "Nalaganje slike ni uspelo, poskusite znova.",
  ...
  apiBasedExtension: {
    ...
    title:
      "Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Dify.",
  ...
  about: {
    ...
    nowAvailable: "Dify {{version}} je zdaj na voljo.",
    latestAvailable:
      "Dify {{version}} je najnovejša različica, ki je na voljo.",
    changeLog: "Dnevnik sprememb",
  },
  appMenus: {
  ...
  datasetMenus: {
    ...
    emptyTip:
      "Znanje ni bilo povezano, prosimo, pojdite na aplikacijo ali vtičnik, da dokončate združenje.",
  ...
  promptEditor: {
    ...
    existed: "Že obstaja v pozivu",
    placeholder:
      "Tukaj vnesite svojo pozivno besedo, vnesite '{' za vstavljanje spremenljivke, vnesite '/', da vstavite blok vsebine",
  },
  imageUploader: {
    pasteImageLinkInvalid: "Neveljavna povezava do slike",
    uploadFromComputerLimit: "Nalaganje slik ne sme presegati {{size}} MB",
    uploadFromComputerUploadError:
      "Nalaganje slike ni uspelo, naložite ga znova.",
    pasteImageLink: "Prilepi povezavo do slike",
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "Nalaganje datoteke ni uspelo, naložite ga znova.",
