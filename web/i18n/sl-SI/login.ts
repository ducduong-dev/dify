const translation = {
  ...
  setAdminAccountDesc:
    "Najvišje pravice za administratorski račun, ki se lahko uporablja za ustvarjanje aplikacij in upravljanje LLM ponudnikov itd.",
  createAndSignIn: "Ustvari in prijavi se",
  oneMoreStep: "Še en korak",
  createSample:
    "Na podlagi teh informacij bomo za vas ustvarili vzorčno aplikacijo",
  ...
  go: "Pojdi na Dify",
  sendUsMail:
    "Pošljite nam uvod po e-pošti, mi pa bomo obravnavali vašo zahtevo za vabilo.",
  ...
  rightDesc:
    "Brez napora gradite vizualno privlačne, operabilne in izboljšljive AI aplikacije.",
  tos: "Pogoji storitve",
  pp: "Politika zasebnosti",
  tosDesc: "Z registracijo se strinjate z našimi",
  goToInit:
    "Če računa še niste inicializirali, pojdite na stran za inicializacijo",
  dontHave: "Nimate?",
  ...
  forgotPasswordDesc:
    "Prosimo, vnesite svoj e-poštni naslov za ponastavitev gesla. Poslali vam bomo e-pošto z navodili za ponastavitev gesla.",
  checkEmailForResetLink:
    "Preverite svojo e-pošto za povezavo za ponastavitev gesla. Če je ne prejmete v nekaj minutah, preverite tudi mapo z neželeno pošto.",
  ...
  error: {
    ...
    passwordInvalid:
      "Geslo mora vsebovati črke in številke, dolžina pa mora biti več kot 8 znakov",
    registrationNotAllowed:
      "Računa ni mogoče najti. Za registracijo se obrnite na skrbnika sistema.",
  },
  license: {
    tip: "Preden začnete z IDX Community Edition, preberite GitHub",
  ...
  licenseExpiredTip:
    "Licenca za IDX Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Dify, se obrnite na skrbnika.",
  usePassword: "Uporaba gesla",
  sendVerificationCode: "Pošlji kodo za preverjanje",
  resetPasswordDesc:
    "Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Dify, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.",
  setYourAccount: "Nastavitev računa",
  noLoginMethodTip:
    "Obrnite se na skrbnika sistema, da dodate način preverjanja pristnosti.",
  or: "ALI",
  ...
  licenseLostTip:
    "Povezava z licenčnim strežnikom IDX ni uspela. Če želite še naprej uporabljati Dify, se obrnite na skrbnika.",
  licenseInactiveTip:
    "Licenca IDX Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Dify, se obrnite na skrbnika.",
};
