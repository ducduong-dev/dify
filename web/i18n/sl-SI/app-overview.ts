const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "Poskusna kvota je namenjena vašemu testiranju. Preden se kvota izčrpa, nastavite lastnega ponudnika modela ali kupite dodatno kvoto.",
      },
      exhausted: {
        title: "Vaša poskusna kvota je bila porabljena, nastavite API ključ.",
        description:
          "Porabili ste svojo poskusno kvoto. Prosimo, nastavite lastnega ponudnika modela ali kupite dodatno kvoto.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "Ali preizkusite oblačno različico IDX s prosto kvoto",
  },
  overview: {
    title: "Pregled",
    appInfo: {
      ...
      settings: {
        ...
        webDescTip:
          "Besedilo bo prikazano na strani za stranke in bo zagotavljalo osnovna navodila za uporabo aplikacije",
        ...
        workflow: {
          ...
          hide: "Skrij",
          showDesc:
            "Pokažite ali skrijte podrobnosti poteka dela v spletni aplikaciji",
        },
        ...
        sso: {
          ...
          description:
            "Vsi uporabniki morajo pred uporabo spletne aplikacije opraviti prijavo preko SSO",
          tooltip:
            "Za omogočitev SSO za spletno aplikacijo se obrnite na skrbnika",
        },
        more: {
          ...
          privacyPolicyTip:
            "Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> Dify.",
          customDisclaimer: "Prilagojena izjava o omejitvi odgovornosti",
          customDisclaimerPlaceholder:
            "Vnesite prilagojeno izjavo o omejitvi odgovornosti",
          customDisclaimerTip:
            "Prilagojeno izjavo o omejitvi odgovornosti bo prikazano na strani za stranke, ki bo zagotavljala dodatne informacije o aplikaciji",
          copyrightTip:
            "Prikaz informacij o avtorskih pravicah v spletni aplikaciji",
          copyrightTooltip:
            "Prosimo, nadgradite na paket Professional ali višji",
        },
      ...
      embedded: {
        ...
        iframe:
          "Za dodajanje klepeta kjerkoli na vaši spletni strani dodajte to iframe v vašo HTML kodo.",
        scripts:
          "Za dodajanje klepeta na spodnji desni del vaše spletne strani dodajte to kodo v vašo HTML kodo.",
        chromePlugin: "Namestite IDX Chatbot razširitev za Chrome",
        copied: "Kopirano",
        copy: "Kopiraj",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "Lahko prilagodite sprednji del spletne aplikacije, da ustreza vašim scenarijem in potrebam po slogu.",
        way1: {
          name: "Forkajte kodo stranke, jo spremenite in namestite na Vercel (priporočeno)",
          step1: "Forkajte kodo stranke in jo spremenite",
          step1Tip:
            "Kliknite tukaj, da forknite izvorno kodo v svoj GitHub račun in spremenite kodo",
          step1Operation: "Dify-WebClient",
          step2: "Namestite na Vercel",
          step2Tip:
            "Kliknite tukaj, da uvozite repozitorij v Vercel in namestite",
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Število dnevnih AI pogovorov; inženiring promptov/debugging izključeno.",
    },
    activeUsers: {
      title: "Aktivni uporabniki",
      explanation:
        "Unikatni uporabniki, ki sodelujejo v vprašanjih in odgovorih z AI; inženiring promptov/debugging izključeno.",
    },
    tokenUsage: {
      title: "Poraba žetonov",
      explanation:
        "Odzrcaljuje dnevno porabo žetonov jezikovnega modela za aplikacijo, uporabno za namene nadzora stroškov.",
      consumed: "Porabljeni",
    },
    avgSessionInteractions: {
      title: "Povprečne interakcije v seji",
      explanation:
        "Število neprekinjenih komunikacij med uporabnikom in AI; za aplikacije, ki temeljijo na pogovoru.",
    },
    avgUserInteractions: {
      title: "Povprečne interakcije uporabnika",
      explanation:
        "Odzrcaljuje dnevno pogostost uporabe uporabnikov. Ta metrika odraža vezanost uporabnikov.",
    },
    userSatisfactionRate: {
      title: "Stopnja zadovoljstva uporabnikov",
      explanation:
        "Število všečkov na 1.000 sporočil. To kaže delež odgovorov, s katerimi so uporabniki zelo zadovoljni.",
    },
    avgResponseTime: {
      title: "Povprečni odzivni čas",
      explanation:
        "Čas (v ms) za obdelavo/odgovor AI; za aplikacije, ki temeljijo na besedilu.",
    },
    tps: {
      title: "Hitrost izhoda žetonov",
      explanation:
        "Merite učinkovitost LLM. Šteje hitrost izhoda žetonov od začetka zahteve do zaključka izhoda.",
    },
  },
};
