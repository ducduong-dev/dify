const translation = {
  ...
  customToolTip: "Learn more about IDX custom tools",
  type: {
    all: "All",
    builtIn: "Tools",
    custom: "Custom",
  ...
  contribute: {
    ...
    line2: "contributing tools to IDX.",
  ...
  createTool: {
    ...
    deleteToolConfirmContent:
      "Deleting the Tool is irreversible. Users will no longer be able to access your Tool.",
  },
  test: {
    title: "Test",
