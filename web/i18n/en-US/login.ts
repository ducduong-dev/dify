const translation = {
  ...
  welcome: "👋 Welcome to IDX, please log in to continue.",
  email: "Email address",
  ...
  goToInit:
    "If you have not initialized the account, please go to the initialization page",
  dontHave: "Don't have?",
  ...
  forgotPasswordDesc:
    "Please enter your email address to reset your password. We will send you an email with instructions on how to reset your password.",
  checkEmailForResetLink:
    "Please check your email for a link to reset your password. If it doesn't appear within a few minutes, make sure to check your spam folder.",
  ...
  error: {
    ...
    registrationNotAllowed:
      "Account not found. Please contact the system admin to register.",
  },
  license: {
    tip: "Before starting IDX Community Edition, read the GitHub",
    link: "Open-source License",
  },
  join: "Join ",
  joinTipStart: "Invite you join ",
  joinTipEnd: " team on IDX",
  ...
  resetPasswordDesc:
    "Type the email you used to sign up on IDX and we will send you a password reset email.",
  ...
  noLoginMethodTip:
    "Please contact the system admin to add an authentication method.",
  licenseExpired: "License Expired",
  licenseExpiredTip:
    "The IDX Enterprise license for your workspace has expired. Please contact your administrator to continue using IDX.",
  licenseLost: "License Lost",
  licenseLostTip:
    "Failed to connect IDX license server. Please contact your administrator to continue using IDX.",
  licenseInactive: "License Inactive",
  licenseInactiveTip:
    "The IDX Enterprise license for your workspace is inactive. Please contact your administrator to continue using IDX.",
};
