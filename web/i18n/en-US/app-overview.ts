const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "The trial quota is provided for your testing purposes. Before the trial quota is exhausted, please set up your own model provider or purchase additional quota.",
      },
      exhausted: {
        title: "Your trial quota have been used up, please set up your APIKey.",
        description:
          "You have exhausted your trial quota. Please set up your own model provider or purchase additional quota.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "Or try the cloud version of IDX with free quote",
  },
  overview: {
    title: "Overview",
    appInfo: {
      ...
      settings: {
        ...
        sso: {
          ...
          title: "WebApp SSO",
          description:
            "All users are required to login with SSO before using WebApp",
        ...
        more: {
          ...
          privacyPolicyTip:
            "Helps visitors understand the data the application collects, see IDX's <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.",
          customDisclaimer: "Custom Disclaimer",
          customDisclaimerPlaceholder: "Enter the custom disclaimer text",
          customDisclaimerTip:
            "Custom disclaimer text will be displayed on the client side, providing additional information about the application",
        },
      },
      embedded: {
        entry: "Embedded",
        ...
        chromePlugin: "Install IDX Chatbot Chrome Extension",
        copied: "Copied",
        copy: "Copy",
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: "Fork the client code, moIDX it and deploy to Vercel (recommended)",
          step1: "Fork the client code and moIDX it",
          step1Tip:
            "Click here to fork the source code into your GitHub account and moIDX the code",
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Daily AI conversations count; prompt engineering/debugging excluded.",
    },
    activeUsers: {
      title: "Active Users",
      explanation:
    ...
    tokenUsage: {
      title: "Token Usage",
      explanation:
        "Reflects the daily token usage of the language model for the application, useful for cost control purposes.",
      consumed: "Consumed",
    },
    ...
    avgUserInteractions: {
      ...
      explanation:
        "Reflects the daily usage frequency of users. This metric reflects user stickiness.",
    },
    userSatisfactionRate: {
      title: "User Satisfaction Rate",
      explanation:
        "The number of likes per 1,000 messages. This indicates the proportion of answers that users are highly satisfied with.",
    },
    avgResponseTime: {
    ...
    tps: {
      ...
      explanation:
        "Measure the performance of the LLM. Count the Tokens output speed of LLM from the beginning of the request to the completion of the output.",
    },
  },
};
