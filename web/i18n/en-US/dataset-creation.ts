const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      fireCrawlNotConfiguredDescription:
        "Configure Firecrawl with API key to use it.",
      jinaReaderNotConfigured: "Jina Reader is not configured",
      jinaReaderNotConfiguredDescription:
        "Set up Jina Reader by entering your free API key for access.",
      configure: "Configure",
      run: "Run",
      ...
      useSitemapTooltip:
        "Follow the sitemap to crawl the site. If not, Jina Reader will crawl iteratively based on page relevance, yielding fewer but higher-quality pages.",
      options: "Options",
      ...
      preview: "Preview",
      maxDepthTooltip:
        "Maximum depth to crawl relative to the entered URL. Depth 0 just scrapes the page of the entered url, depth 1 scrapes the url and everything after enteredURL + one /, and so on.",
    },
  },
  stepTwo: {
    ...
    paragraph: "Paragraph",
    paragraphTip:
      "This mode splits the text in to paragraphs based on delimiters and the maximum chunk length, using the split text as the parent chunk for retrieval.",
    fullDoc: "Full Doc",
    fullDocTip:
      "The entire document is used as the parent chunk and retrieved directly. Please note that for performance reasons, text exceeding 10000 tokens will be automatically truncated.",
    separator: "Delimiter",
    separatorTip:
      "A delimiter is the character used to separate text. \\n\\n and \\n are commonly used delimiters for separating paragraphs and lines. Combined with commas (\\n\\n,\\n), paragraphs will be segmented by lines when exceeding the maximum chunk length. You can also use special delimiters defined by yourself (e.g. ***).",
    ...
    indexSettingTip:
      "To change the index method & embedding model, please go to the ",
  ...
  stepThree: {
    ...
    creationContent:
      "We automatically named the Knowledge, you can moIDX it at any time.",
  ...
  otherDataSource: {
    ...
    description:
      "Currently, IDX's knowledge base only has limited data sources. Contributing a data source to the IDX knowledge base is a fantastic way to help enhance the platform's flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.",
