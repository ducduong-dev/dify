const translation = {
  ...
  detailPanel: {
    ...
    endpoints: "Endpoints",
    endpointsTip:
      "This plugin provides specific functionalities via endpoints, and you can configure multiple endpoint sets for current workspace.",
    ...
    endpointModalDesc:
      "Once configured, the features provided by the plugin via API endpoints can be used.",
    ...
    toolSelector: {
      ...
      uninstalledContent:
        "This plugin is installed from the local/GitHub repository. Please use after installation.",
      uninstalledLink: "Manage in Plugins",
      unsupportedTitle: "Unsupported Action",
      unsupportedContent:
        "The installed plugin version does not provide this action.",
  ...
  installModal: {
    ...
    fromTrustSource:
      "Please make sure that you only install plugins from a <trustSource>trusted source</trustSource>.",
  ...
  error: {
    inValidGitHubUrl:
      "Invalid GitHub URL. Please enter a valid URL in the format: https://github.com/owner/repo",
    fetchReleasesError: "Unable to retrieve releases. Please try again later.",
    noReleasesFound:
      "No releases found. Please check the GitHub repository or the input URL.",
  },
  marketplace: {
    empower: "Empower your AI development",
    discover: "Discover",
    and: "and",
    difyMarketplace: "IDX Marketplace",
    ...
    viewMore: "View more",
    verifiedTip: "Verified by IDX",
    partnerTip: "Verified by a IDX partner",
  },
  task: {
    installing: "Installing {{installingLength}} plugins, 0 done.",
    installingWithSuccess:
      "Installing {{installingLength}} plugins, {{successLength}} success.",
    installingWithError:
      "Installing {{installingLength}} plugins, {{successLength}} success, {{errorLength}} failed",
