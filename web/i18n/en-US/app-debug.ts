const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "You have switched to Expert Mode, and once you moIDX the PROMPT, you CANNOT return to the basic mode.",
  ...
  feature: {
    ...
    fileUpload: {
      title: "File Upload",
      description:
        "The chat input box allows uploading of images, documents, and other files.",
    ...
    documentUpload: {
      title: "Document",
      description:
        "Enable Document will allows the model to take in documents and answer questions about them.",
    },
  },
  codegen: {
    title: "Code Generator",
    description:
      "The Code Generator uses configured models to generate high-quality code based on your instructions. Please provide clear and detailed instructions.",
    instruction: "Instructions",
    instructionPlaceholder:
      "Enter detailed description of the code you want to generate.",
    ...
    overwriteConfirmMessage:
      "This action will overwrite the existing code. Do you want to continue?",
  },
  generate: {
    title: "Prompt Generator",
    description:
      "The Prompt Generator uses the configured model to optimize prompts for higher quality and better structure. Please write clear and detailed instructions.",
    tryIt: "Try it",
    instruction: "Instructions",
    ...
    overwriteMessage:
      "Applying this prompt will override existing configuration.",
    template: {
      pythonDebugger: {
        name: "Python debugger",
        instruction:
          "A bot that can generate and debug your code based on your instruction",
      },
      translation: {
        name: "Translation",
      ...
      professionalAnalyst: {
        ...
        instruction:
          "Extract insights, identify risk and distill key information from long reports into single memo",
      },
      excelFormulaExpert: {
      ...
      writingsPolisher: {
        ...
        instruction:
          "Use advanced copyediting techniques to improve your writings",
      },
    },
  },
  resetConfig: {
  ...
  varKeyError: {
    ...
    notValid:
      "{{key}} is invalid. Can only contain letters, numbers, and underscores",
  ...
  variableConfig: {
    ...
    maxNumberTip:
      "Document < {{docLimit}}, image < {{imgLimit}}, audio < {{audioLimit}}, video < {{videoLimit}}",
    errorMsg: {
  ...
  datasetConfig: {
    ...
    retrieveMultiWay: {
      ...
      description:
        "Based on user intent, queries across all Knowledge, retrieves relevant text from multi-sources, and selects the best results matching the user query after reranking. ",
    },
