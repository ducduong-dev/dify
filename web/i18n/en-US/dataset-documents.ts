const translation = {
  list: {
    title: "Documents",
    desc: "All files of the Knowledge are shown here, and the entire Knowledge can be linked to IDX citations or indexed via the Chat plugin.",
    ...
    empty: {
      ...
      sync: {
        tip: "IDX will periodically download files from your Notion and complete processing.",
      },
    },
    delete: {
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "Regenerating child chunks will overwrite the current child chunks, including edited chunks and newly added chunks. The regeneration cannot be undone.",
