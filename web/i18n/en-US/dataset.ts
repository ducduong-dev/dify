const translation = {
  ...
  externalKnowledgeNamePlaceholder:
    "Please enter the name of the knowledge base",
  externalKnowledgeDescriptionPlaceholder:
    "Describe what's in this Knowledge Base (optional)",
  learnHowToWriteGoodKnowledgeDescription:
    "Learn how to write a good knowledge description",
  externalAPIPanelDescription:
    "The external knowledge API is used to connect to a knowledge base outside of IDX and retrieve knowledge from that knowledge base.",
  externalAPIPanelDocumentation:
    "Learn how to create an External Knowledge API",
  ...
  noExternalKnowledge:
    "There is no External Knowledge API yet, click here to create",
  ...
  connectDatasetIntro: {
    ...
    content: {
      front:
        "To connect to an external knowledge base, you need to create an external API first. Please read carefully and refer to",
  ...
  connectHelper: {
    helper1:
      "Connect to external knowledge bases via API and knowledge base ID. Currently, ",
  ...
  datasetUsedByApp:
    "The knowledge is being used by some apps. Apps will no longer be able to use this Knowledge, and all prompt configurations and logs will be permanently deleted.",
  datasetDeleted: "Knowledge deleted",
  datasetDeleteFailed: "Failed to delete Knowledge",
  didYouKnow: "Did you know?",
  intro1: "The Knowledge can be integrated into the IDX application ",
  intro2: "as a context",
  intro3: ",",
  intro4: "or it ",
  ...
  unavailableTip:
    "Embedding model is not available, the default embedding model needs to be configured",
  datasets: "KNOWLEDGE",
  ...
  defaultRetrievalTip:
    "Multi-path retrieval is used by default. Knowledge is retrieved from multiple knowledge bases and then re-ranked.",
  mixtureHighQualityAndEconomicTip:
    "The Rerank model is required for mixture of high quality and economical knowledge bases.",
  inconsistentEmbeddingModelTip:
    "The Rerank model is required if the Embedding models of the selected knowledge bases are inconsistent.",
  mixtureInternalAndExternalTip:
    "The Rerank model is required for mixture of internal and  external knowledge.",
  allExternalTip:
    "When using external knowledge only, the user can choose whether to enable the Rerank model. If not enabled, retrieved chunks will be sorted based on scores. When the retrieval strategies of different knowledge bases are inconsistent, it will be inaccurate.",
  ...
  nTo1RetrievalLegacy:
    "N-to-1 retrieval will be officially deprecated from September. It is recommended to use the latest Multi-path retrieval to obtain better results. ",
  nTo1RetrievalLegacyLink: "Learn more",
  nTo1RetrievalLegacyLinkText:
    " N-to-1 retrieval will be officially deprecated in September.",
  batchAction: {
    selected: "Selected",
    enable: "Enable",
    disable: "Disable",
  ...
  allKnowledgeDescription:
    "Select to display all knowledge in this workspace. Only the Workspace Owner can manage all knowledge.",
};
