const translation = {
  ...
  usagePage: {
    ...
    vectorSpaceTooltip:
      "Documents with the High Quality indexing mode will consume Knowledge Data Storage resources. When Knowledge Data Storage reaches the limit, new documents will not be uploaded.",
  },
  teamMembers: "Team Members",
  upgradeBtn: {
    plain: "View Plan",
  ...
  plansCommon: {
    ...
    documentsTooltip:
      "Quota on the number of documents imported from the Knowledge Data Source.",
    ...
    messageRequest: {
      ...
      tooltip:
        "Message invocation quotas for various plans using OpenAl models. Messages over the limit will use your OpenAI API Key.",
    },
    annotatedResponse: {
    ...
    ragAPIRequestTooltip:
      "Refers to the number of API calls invoking only the knowledge base processing capabilities of IDX.",
    receiptInfo:
  ...
  plans: {
    ...
    community: {
      ...
      description:
        "For Individual Users, Small Teams, or Non-commercial Projects",
      price: "Free",
      ...
      features: [
        ...
        "Single Workspace",
        "Complies with IDX Open Source License",
      ],
    },
    premium: {
      name: "Premium",
    ...
    enterprise: {
      ...
      description:
        "For Enterprise Require Organization-wide Security, Compliance, Scalability, Control and More Advanced Features",
      price: "Custom",
      ...
      features: [
        ...
        "SSO",
        "Negotiated SLAs by IDX Partners",
        "Advanced Security & Controls",
        "Updates and Maintenance by IDX Officially",
