const translation = {
  ...
  account: {
    ...
    langGeniusAccount: "IDX account",
    langGeniusAccountTip: "Your IDX account and associated user data.",
    editName: "Edit Name",
  ...
  members: {
    ...
    invitationSentTip:
      "Invitation sent, and they can sign in to IDX to access your team data.",
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: "The OpenAI hosting service provided by IDX allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.",
  ...
  modelProvider: {
    ...
    loadBalancingDescription:
      "Reduce pressure with multiple sets of credentials.",
  ...
  apiBasedExtension: {
    title:
      "API extensions provide centralized API management, simplifying configuration for easy use across IDX's applications.",
  ...
  about: {
    ...
    nowAvailable: "IDX {{version}} is now available.",
    latestAvailable: "IDX {{version}} is the latest version available.",
  },
  appMenus: {
    overview: "Monitoring",
