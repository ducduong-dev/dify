const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: "या मुफ्त कोटा के साथ IDX का क्लाउड संस्करण आज़माएं",
  },
  overview: {
    title: "अवलोकन",
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            "आगंतुकों को यह समझने में मदद करता है कि एप्लिकेशन कौन सा डेटा एकत्र करता है, देखें IDX की <privacyPolicyLink>गोपनीयता नीति</privacyPolicyLink>।",
          ...
          copyrightTooltip:
            "कृपया व्यावसायिक योजना या उससे ऊपर के संस्करण में अपग्रेड करें",
        },
        sso: {
          title: "वेबएप एसएसओ",
          label: "SSO प्रमाणीकरण",
          description:
            "WebApp का उपयोग करने से पहले सभी उपयोगकर्ताओं को SSO के साथ लॉगिन करना आवश्यक है",
  ...
  analysis: {
    ...
    totalConversations: {
      title: "कुल वार्तालाप",
      explanation:
        "दैनिक AI वार्तालाप की गिनती; प्रॉम्प्ट इंजीनियरिंग/डीबगिंग शामिल नहीं।",
    },
    activeUsers: {
