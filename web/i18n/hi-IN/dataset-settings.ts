const translation = {
  ...
  form: {
    ...
    desc: "ज्ञान विवरण",
    descInfo:
      "कृपया स्पष्ट साक्षर विवरण लिखें जिससे AI को ज्ञान के निहितार्थों की पहचान करने में मदद मिले। यदि शून्य है, IDX आपके पूर्वानुमान का उपयोग करेगा।",
    descPlaceholder:
      "इस ज्ञान के सामग्रियां क्या हैं? एक विस्तृत विवरण को AI को निहितार्थों की पहचान करने में मदद मिले। यदि शून्य है, IDX आपके पूर्वानुमान का उपयोग करेगा।",
    ...
    indexMethodChangeToEconomyDisabledTip:
      "मुख्यालय से ईसीओ में डाउनग्रेड करने के लिए उपलब्ध नहीं है",
    helpText: "एक अच्छा डेटासेट विवरण लिखना सीखें।",
    upgradeHighQualityTip:
      "एक बार उच्च गुणवत्ता मोड में अपग्रेड करने के बाद, किफायती मोड में वापस जाना उपलब्ध नहीं है",
  },
};
