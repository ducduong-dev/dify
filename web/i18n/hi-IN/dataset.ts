const translation = {
  ...
  datasetUsedByApp:
    "यह ज्ञान कुछ ऐप्स द्वारा उपयोग किया जा रहा है। ऐप्स अब इस ज्ञान का उपयोग नहीं कर पाएंगे, और सभी प्रॉम्प्ट कॉन्फ़िगरेशन और लॉग स्थायी रूप से हटा दिए जाएंगे।",
  datasetDeleted: "ज्ञान हटा दिया गया",
  datasetDeleteFailed: "ज्ञान हटाने में विफल",
  didYouKnow: "क्या आप जानते हैं?",
  intro1: "ज्ञान को IDX एप्लिकेशन में ",
  ...
  mixtureHighQualityAndEconomicTip:
    "उच्च गुणवत्ता और किफायती ज्ञान आधारों के मिश्रण के लिए पुनः रैंकिंग मॉडल आवश्यक है।",
  inconsistentEmbeddingModelTip:
    "यदि चयनित ज्ञान आधारों के एम्बेडिंग मॉडल असंगत हैं, तो पुनः रैंकिंग मॉडल आवश्यक है।",
  retrievalSettings: "पुनर्प्राप्ति सेटिंग्स",
  rerankSettings: "पुनः रैंकिंग सेटिंग्स",
  weightedScore: {
    title: "भारित स्कोर",
    description:
      "आवंटित भारों को समायोजित करके, यह पुनः रैंकिंग रणनीति निर्धारित करती है कि शब्दार्थ या कीवर्ड मिलान को प्राथमिकता दी जाए।",
  ...
  nTo1RetrievalLegacy:
    "N-से-1 पुनर्प्राप्ति सितंबर से आधिकारिक तौर पर बंद कर दी जाएगी। बेहतर परिणाम प्राप्त करने के लिए नवीनतम बहु-मार्ग पुनर्प्राप्ति का उपयोग करने की सिफारिश की जाती है।",
  nTo1RetrievalLegacyLink: "और जानें",
  nTo1RetrievalLegacyLinkText:
    "N-से-1 पुनर्प्राप्ति सितंबर में आधिकारिक तौर पर बंद कर दी जाएगी।",
  defaultRetrievalTip:
    "मल्टी-पाथ रिट्रीवल का उपयोग डिफ़ॉल्ट रूप से किया जाता है। ज्ञान को कई ज्ञान आधारों से पुनर्प्राप्त किया जाता है और फिर फिर से रैंक किया जाता है।",
  ...
  connectDatasetIntro: {
    content: {
      ...
      front:
        "बाहरी ज्ञानकोष से कनेक्ट करने के लिए, आपको पहले एक बाहरी API बनाना होगा। कृपया काळजीपूर्वक वाचा आणि संदर्भ घ्या",
  ...
  connectHelper: {
    ...
    helper1:
      "API और नॉलेज बेस ID के माध्यम से बाहरी नॉलेज बेस से कनेक्ट करें. वर्तमान में,",
  },
  ...
  externalAPIForm: {
    encrypted: {
      ...
      front:
        "आपका एपीआई टोकन एन्क्रिप्ट किया जाएगा और इसका उपयोग करके संग्रहीत किया जाएगा",
    },
    apiKey: "एपीआई कुंजी",
    name: "नाम",
    cancel: "रद्द करना",
  ...
  allExternalTip:
    "केवल बाहरी ज्ञान का उपयोग करते समय, उपयोगकर्ता यह चुन सकता है कि Rerank मॉडल को सक्षम करना है या नहीं। यदि सक्षम नहीं है, तो पुनर्प्राप्त किए गए विखंडू स्कोर के आधार पर क्रमबद्ध किए जाएंगे। जब विभिन्न ज्ञान आधारों की पुनर्प्राप्ति रणनीतियाँ असंगत होती हैं, तो यह गलत होगी।",
  externalKnowledgeName: "बाहरी ज्ञान का नाम",
  connectDataset: "किसी बाह्य ज्ञानकोष से कनेक्ट करना",
  mixtureInternalAndExternalTip:
    "आंतरिक और बाहरी ज्ञान के मिश्रण के लिए रीरैंक मॉडल की आवश्यकता होती है।",
  externalTag: "बाह्य",
  externalAPIPanelDescription:
    "बाहरी ज्ञान API का उपयोग IDX के बाहर नॉलेज बेस से कनेक्ट करने और उस नॉलेज बेस से ज्ञान प्राप्त करने के लिए किया जाता है।",
  ...
  externalKnowledgeDescriptionPlaceholder:
    "वर्णन करें कि इस ज्ञानकोष में क्या है (वैकल्पिक)",
  noExternalKnowledge:
    "अभी तक कोई बाहरी ज्ञान एपीआई नहीं है, बनाने के लिए यहां क्लिक करें",
  ...
  enable: "योग्य बनाना",
  documentsDisabled:
    "{{num}} दस्तावेज़ अक्षम - 30 दिनों से अधिक समय से निष्क्रिय",
  allKnowledge: "सर्व ज्ञान",
  allKnowledgeDescription:
    "इस कार्यस्थान में सभी ज्ञान प्रदर्शित करने के लिए चयन करें. केवल कार्यस्थान स्वामी ही सभी ज्ञान का प्रबंधन कर सकता है.",
};
