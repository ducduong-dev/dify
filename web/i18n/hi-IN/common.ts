const translation = {
  ...
  account: {
    ...
    langGeniusAccountTip: "आपका IDX खाता और संबंधित उपयोगकर्ता डेटा।",
    editName: "नाम संपादित करें",
    showAppLength: "{{length}} ऐप्स दिखाएं",
    deleteConfirmTip:
      "पुष्टि करने के लिए, कृपया अपने पंजीकृत ईमेल से निम्नलिखित भेजें",
    delete: "खाता हटाएं",
    deleteTip:
      "अपना खाता हटाने से आपका सारा डेटा स्थायी रूप से मिट जाएगा और इसे पुनर्प्राप्त नहीं किया जा सकता है।",
    account: "खाता",
    ...
    deletePrivacyLinkTip:
      "हम आपके डेटा को कैसे संभालते हैं, इस बारे में अधिक जानकारी के लिए, कृपया हमारा डेटा देखें",
    permanentlyDeleteButton: "खाता स्थायी रूप से हटाएं",
    verificationPlaceholder: "6-अंकीय कोड पेस्ट करें",
    deleteSuccessTip:
      "आपके खाते को हटाने का काम पूरा करने के लिए समय चाहिए. जब यह सब हो जाएगा तो हम आपको ईमेल करेंगे।",
  },
  members: {
    team: "टीम",
    invite: "जोड़ें",
    ...
    emailNotSetup:
      "ईमेल सर्वर सेट नहीं है, इसलिए आमंत्रण ईमेल नहीं भेजे जा सकते। कृपया उपयोगकर्ताओं को आमंत्रण के बाद जारी किए जाने वाले आमंत्रण लिंक के बारे में सूचित करें。",
    email: "ईमेल",
  ...
  provider: {
    ...
    anthropicHosted: {
      ...
      close: "बंद करें",
      trialQuotaTip:
        "आपका एंथ्रोपिक परीक्षण कोटा 2025/03/11 को समाप्त हो जाएगा और उसके बाद उपलब्ध नहीं रहेगा। कृपया इसका समय पर उपयोग करें।",
    },
    anthropic: {
  ...
  apiBasedExtension: {
    title:
      "एपीआई एक्सटेंशन केंद्रीकृत एपीआई प्रबंधन प्रदान करते हैं, जो IDX के अनुप्रयोगों में आसान उपयोग के लिए कॉन्फ़िगरेशन को सरल बनाते हैं।",
  ...
  fileUploader: {
    ...
    uploadFromComputerUploadError:
      "फ़ाइल अपलोड विफल रही, कृपया फिर से अपलोड करें।",
    pasteFileLinkInputPlaceholder: "URL दर्ज करें...",
    uploadFromComputerReadError:
      "फ़ाइल पढ़ना विफल रहा, कृपया पुनः प्रयास करें.",
