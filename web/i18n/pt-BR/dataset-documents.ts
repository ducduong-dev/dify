const translation = {
  list: {
    title: "Documentos",
    desc: "Todos os arquivos do Knowledge são mostrados aqui, e todo o Knowledge pode ser vinculado a citações do IDX ou indexado por meio do plugin Chat.",
    ...
    empty: {
      ...
      sync: {
        tip: "O IDX baixará periodicamente arquivos do seu Notion e concluirá o processamento.",
      },
    },
    delete: {
      title: "Tem certeza que deseja excluir?",
      content:
        "Se você precisar retomar o processamento posteriormente, continuará de onde parou",
    },
    batchModal: {
  ...
  embedding: {
    ...
    previewTip:
      "A visualização do parágrafo estará disponível após a incorporação ser concluída",
    pause: "Pausa",
  ...
  segment: {
    ...
    regenerationConfirmMessage:
      "A regeneração de partes filhas substituirá as partes filhas atuais, incluindo partes editadas e partes recém-adicionadas. A regeneração não pode ser desfeita.",
