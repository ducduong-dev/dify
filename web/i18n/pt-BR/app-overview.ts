const translation = {
  ...
  apiKeyInfo: {
    cloud: {
      trial: {
        ...
        description:
          "A cota de teste é fornecida para seu uso de teste. Antes que as chamadas de cota de teste se esgotem, configure seu próprio provedor de modelo ou compre cota adicional.",
      },
      exhausted: {
        title: "Sua cota de teste foi usada, configure sua chave de API.",
        description:
          "Sua cota de teste foi esgotada. Configure seu próprio provedor de modelo ou compre cota adicional.",
      },
    },
    selfHost: {
      title: {
    ...
    tryCloud: "Ou experimente a versão em nuvem do IDX com cota gratuita",
  },
  overview: {
    title: "Visão Geral",
    appInfo: {
      ...
      settings: {
        ...
        workflow: {
          ...
          showDesc:
            "Mostrar ou ocultar detalhes do fluxo de trabalho no WebApp",
        },
        ...
        more: {
          ...
          privacyPolicyTip:
            "Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do Dify.",
          customDisclaimer: "Aviso Legal Personalizado",
          customDisclaimerPlaceholder: "Insira o texto do aviso legal",
          customDisclaimerTip:
            "O texto do aviso legal personalizado será exibido no lado do cliente, fornecendo informações adicionais sobre o aplicativo",
          copyrightTip: "Exibir informações de direitos autorais no webapp",
          copyrightTooltip:
            "Por favor, atualize para o plano Professional ou superior",
        },
        sso: {
          tooltip:
            "Entre em contato com o administrador para habilitar o SSO do WebApp",
          label: "Autenticação SSO",
          title: "WebApp SSO",
          description:
            "Todos os usuários devem fazer login com SSO antes de usar o WebApp",
        },
      ...
      embedded: {
        ...
        explanation:
          "Escolha a maneira de incorporar o aplicativo de chat ao seu site",
        iframe:
          "Para adicionar o aplicativo de chat em qualquer lugar do seu site, adicione este iframe ao seu código HTML.",
        scripts:
          "Para adicionar um aplicativo de chat no canto inferior direito do seu site, adicione este código ao seu HTML.",
        chromePlugin: "Instalar a Extensão do Chrome IDX Chatbot",
        copied: "Copiado",
        copy: "Copiar",
      },
      qrcode: {
      ...
      customize: {
        ...
        explanation:
          "Você pode personalizar a interface do usuário do Web App para atender às suas necessidades de cenário e estilo.",
        way1: {
          ...
          step1Tip:
            "Clique aqui para fazer um fork do código-fonte na sua conta GitHub e modificar o código",
          step1Operation: "Cliente-Web-Dify",
          step2: "Implantar no Vercel",
          step2Tip:
            "Clique aqui para importar o repositório no Vercel e implantar",
  ...
  analysis: {
    ...
    totalConversations: {
      ...
      explanation:
        "Contagem diária de conversas com IA; engenharia/depuração de prompts excluída.",
    },
    activeUsers: {
      title: "Usuários Ativos",
      explanation:
        "Usuários únicos engajando em Q&A com AI; engenharia/de depuração excluída.",
    },
    tokenUsage: {
      title: "Uso de Token",
      explanation:
        "Reflete o uso diário do token do modelo de linguagem para o aplicativo, útil para fins de controle de custos.",
      consumed: "Consumido",
    },
    avgSessionInteractions: {
      title: "Média de Interações por Sessão",
      explanation:
        "Contagem de comunicação contínua entre usuário e AI; para aplicativos baseados em conversação.",
    },
    avgUserInteractions: {
      title: "Média de Interações por Usuário",
      explanation:
        "Reflete a frequência de uso diário dos usuários. Essa métrica reflete a fidelidade do usuário.",
    },
    userSatisfactionRate: {
      title: "Taxa de Satisfação do Usuário",
      explanation:
        "O número de curtidas por 1.000 mensagens. Isso indica a proporção de respostas com as quais os usuários estão altamente satisfeitos.",
    },
    avgResponseTime: {
      title: "Tempo Médio de Resposta",
      explanation:
        "Tempo (ms) para o AI processar/responder; para aplicativos baseados em texto.",
    },
    tps: {
      title: "Velocidade de Saída do Token",
      explanation:
        "Mede o desempenho do LLM. Conta a velocidade de saída de tokens do LLM desde o início da solicitação até a conclusão da saída.",
    },
  },
};
