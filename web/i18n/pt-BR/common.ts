const translation = {
  ...
  model: {
    params: {
      ...
      maxTokenSettingTip:
        "Sua configuração máxima de token é alta, limitando potencialmente o espaço para palavras de prompt, consultas e dados. Considere definir abaixo de 2/3.",
      setToCurrentModelMaxTokenTip:
        "O máximo de tokens é atualizado para 80% do máximo de token do modelo atual {{maxToken}}.",
      stop_sequences: "Sequências de parada",
      stop_sequencesTip:
        "Até quatro sequências onde a API irá parar de gerar mais tokens. O texto retornado não conterá a sequência de parada.",
  ...
  menus: {
    ...
    plugins: "Plugins",
    pluginsTips:
      "Integre plugins de terceiros ou crie plugins de IA compatíveis com o ChatGPT.",
    datasets: "Conhecimento",
    datasetsTips:
      "EM BREVE: Importe seus próprios dados de texto ou escreva dados em tempo real via Webhook para aprimoramento do contexto LLM.",
    newApp: "Novo App",
  ...
  account: {
    ...
    langGeniusAccountTip: "Sua conta IDX e dados de usuário associados.",
    ...
    deletePrivacyLinkTip:
      "Para obter mais informações sobre como lidamos com seus dados, consulte nosso",
    deletePrivacyLink: "Política de privacidade.",
    deleteSuccessTip:
      "Sua conta precisa de tempo para concluir a exclusão. Enviaremos um e-mail quando tudo estiver pronto.",
  ...
  members: {
    ...
    emailNotSetup:
      "O servidor de e-mail não está configurado, então os e-mails de convite não podem ser enviados. Por favor, notifique os usuários sobre o link de convite que será emitido após o convite.",
    email: "E-mail",
    ...
    invitationSentTip:
      "Convite enviado e eles podem fazer login no IDX para acessar os dados da sua equipe.",
  ...
  provider: {
    ...
    apiKeyExceedBill:
      "Esta CHAVE DE API não tem quota disponível, por favor, leia",
    ...
    openaiHosted: {
      ...
      desc: "O serviço de hospedagem OpenAI fornecido pela IDX permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.",
      callTimes: "Chamadas",
      usedUp:
        "Cota de teste esgotada. Adicione seu próprio Fornecedor de Modelo.",
    ...
    anthropicHosted: {
      ...
      close: "Fechar",
      trialQuotaTip:
        "Sua cota de teste do Anthropic expirará em 11/03/2025 e não estará mais disponível depois disso. Por favor, use-o a tempo.",
    },
    anthropic: {
      using: "A capacidade de incorporação está sendo utilizada",
      enableTip:
        "Para habilitar o modelo da Anthropic, você precisa vincular ao OpenAI ou ao Azure OpenAI Service primeiro.",
  ...
  modelProvider: {
    ...
    loadBalancingDescription:
      "Reduza a pressão com vários conjuntos de credenciais.",
    configLoadBalancing: "Balanceamento de carga de configuração",
    upgradeForLoadBalancing:
      "Atualize seu plano para habilitar o balanceamento de carga.",
    ...
    providerManagedDescription:
      "Use o único conjunto de credenciais fornecido pelo provedor de modelo.",
    apiKey: "CHAVE DE API",
    loadBalancingLeastKeyWarning:
      "Para habilitar o balanceamento de carga, pelo menos 2 chaves devem estar habilitadas.",
    editConfig: "Editar configuração",
    defaultConfig: "Configuração padrão",
    modelHasBeenDeprecated: "Este modelo foi preterido",
    loadBalancingInfo:
      "Por padrão, o balanceamento de carga usa a estratégia Round-robin. Se a limitação de taxa for acionada, um período de espera de 1 minuto será aplicado.",
    apiKeyRateLimit:
      "O limite de taxa foi atingido, disponível após {{seconds}}s",
  ...
  apiBasedExtension: {
    title:
      "As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da Dify.",
  ...
  promptEditor: {
    placeholder:
      "Escreva sua palavra de incentivo aqui, digite '{' para inserir uma variável, digite '/' para inserir um bloco de conteúdo de incentivo",
    context: {
      item: {
        title: "Contexto",
  ...
  imageUploader: {
    ...
    uploadFromComputerReadError:
      "Falha ao ler a imagem, por favor, tente novamente.",
    uploadFromComputerUploadError:
      "Falha ao enviar a imagem, por favor, envie novamente.",
  ...
  fileUploader: {
    ...
    uploadFromComputerReadError:
      "Falha na leitura do arquivo, tente novamente.",
    uploadFromComputerLimit: "Carregar arquivo não pode exceder {{size}}",
    uploadFromComputerUploadError:
      "Falha no upload do arquivo, faça o upload novamente.",
  },
  license: {
