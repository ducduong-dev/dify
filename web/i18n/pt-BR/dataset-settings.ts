const translation = {
  ...
  form: {
    ...
    descInfo:
      "Por favor, escreva uma descrição textual clara para delinear o conteúdo do conhecimento. Esta descrição será usada como base para a correspondência ao selecionar entre vários conhecimentos para inferência.",
    descPlaceholder:
      "Descreva o que está neste conhecimento. Uma descrição detalhada permite que a IA acesse o conteúdo do conhecimento de forma oportuna. Se estiver vazio, o IDX usará a estratégia de correspondência padrão.",
    ...
    indexMethodHighQualityTip:
      "Invocar o modelo de Embedding para processamento para fornecer maior precisão nas consultas dos usuários.",
    ...
    retrievalSetting: {
      ...
      longDescription:
        " sobre o método de recuperação, você pode alterar isso a qualquer momento nas configurações do conhecimento.",
    },
    save: "Salvar",
    ...
    indexMethodChangeToEconomyDisabledTip:
      "Não disponível para rebaixamento de HQ para ECO",
    helpText: "Aprenda a escrever uma boa descrição do conjunto de dados.",
    upgradeHighQualityTip:
      "Depois de atualizar para o modo de alta qualidade, reverter para o modo econômico não está disponível",
  },
};
