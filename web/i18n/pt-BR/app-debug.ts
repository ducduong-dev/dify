const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title:
        "Você mudou para o Modo Especialista e, uma vez que você modifique o PROMPT, NÃO poderá retornar ao modo básico.",
    ...
    contextMissing:
      "Componente de contexto ausente, a eficácia do prompt pode não ser boa.",
  },
  operation: {
  ...
  notSetAPIKey: {
    ...
    description:
      "A chave do provedor LLM não foi definida e precisa ser definida antes da depuração.",
  ...
  feature: {
    groupChat: {
      ...
      description:
        "Adicione configurações pré-conversa para aplicativos que podem melhorar a experiência do usuário.",
    },
    groupExperience: {
    ...
    conversationOpener: {
      ...
      description:
        "Em um aplicativo de chat, a primeira frase que a IA fala ativamente para o usuário geralmente é usada como uma saudação.",
    },
    suggestedQuestionsAfterAnswer: {
      title: "Perguntas de Acompanhamento",
      description:
        "Configurar sugestões de próximas perguntas pode proporcionar um melhor chat aos usuários.",
    ...
    moreLikeThis: {
      ...
      description:
        "Gere vários textos de uma vez e, em seguida, edite e continue a gerar",
    ...
    citation: {
      ...
      description:
        "Uma vez ativado, mostra o documento de origem e a seção atribuída do conteúdo gerado.",
      resDes: "Citações e Atribuições estão ativadas",
    },
    annotation: {
      title: "Resposta de Anotação",
      description:
        "Você pode adicionar manualmente uma resposta de alta qualidade ao cache para correspondência prioritária com perguntas semelhantes do usuário.",
      resDes: "Resposta de Anotação está ativada",
      scoreThreshold: {
        title: "Limiar de Pontuação",
        description:
          "Usado para definir o limiar de similaridade para resposta de anotação.",
    ...
    dataSet: {
      ...
      queryVariable: {
        ...
        unableToQueryDataSetTip:
          "Não é possível consultar o Conhecimento com sucesso, por favor escolha uma variável de consulta de contexto na seção de contexto.",
        ok: "OK",
        contextVarNotEmpty:
          "variável de consulta de contexto não pode estar vazia",
        deleteContextVarTitle: 'Excluir variável "{{varName}}"?',
        deleteContextVarTip:
          "Esta variável foi definida como uma variável de consulta de contexto e removê-la afetará o uso normal do Conhecimento. Se você ainda precisa excluí-la, por favor, selecione-a novamente na seção de contexto.",
      },
    },
    tools: {
      title: "Tools",
    ...
    moderation: {
      ...
      modal: {
        ...
        provider: {
          ...
          openaiTip: {
            prefix:
              "A Moderação OpenAI requer uma chave de API da OpenAI configurada em ",
            suffix: ".",
          },
        ...
        content: {
          ...
          condition:
            "Moderar Conteúdo de ENTRADA e SAÍDA habilitado pelo menos uma",
  ...
  automatic: {
    ...
    description:
      "Descreva o seu cenário, o IDX irá orquestrar um aplicativo para você.",
    intendedAudience: "Qual é o público-alvo?",
    intendedAudiencePlaceHolder: "ex: Estudante",
    solveProblem:
      "Quais problemas eles esperam que a IA possa resolver para eles?",
    ...
    noData:
      "Descreva o seu caso de uso à esquerda, a visualização da orquestração será exibida aqui.",
    loading: "Orquestrando o aplicativo para você...",
    overwriteTitle: "Substituir configuração existente?",
    overwriteMessage:
      "Aplicar esta orquestração irá substituir a configuração existente.",
  },
  resetConfig: {
  ...
  notSetVar:
    'As variáveis permitem que os usuários introduzam palavras de solicitação ou observações iniciais ao preencher formulários. Você pode tentar digitar "{{input}}" nas palavras de solicitação.',
  autoAddVar:
    "Variáveis indefinidas referenciadas na pré-solicitação, você deseja adicioná-las no formulário de entrada do usuário?",
  variableTable: {
  ...
  varKeyError: {
    ...
    notValid:
      "{{key}} é inválida. Pode conter apenas letras, números e sublinhados",
  ...
  vision: {
    name: "Visão",
    description:
      "Habilitar a Visão permite que o modelo receba imagens e responda perguntas sobre elas.",
  ...
  openingStatement: {
    ...
    placeholder:
      "Escreva sua mensagem de abertura aqui, você pode usar variáveis, tente digitar {{variável}}.",
    ...
    tooShort:
      "São necessárias pelo menos 20 palavras de prompt inicial para gerar observações de abertura para a conversa.",
    notIncludeKey:
  ...
  datasetConfig: {
    ...
    retrieveOneWay: {
      ...
      description:
        "Com base na intenção do usuário e nas descrições do Conhecimento, o Agente seleciona autonomamente o melhor Conhecimento para consulta. Melhor para aplicativos com Conhecimento distinto e limitado.",
    },
    retrieveMultiWay: {
    ...
    top_k: "Top K",
    top_kTip:
      "Usado para filtrar os trechos mais semelhantes às perguntas do usuário. O sistema também ajustará dinamicamente o valor de Top K, de acordo com max_tokens do modelo selecionado.",
  ...
  assistantType: {
    ...
    chatAssistant: {
      ...
      description:
        "Construa um assistente baseado em chat usando um Modelo de Linguagem Grande",
    },
    agentAssistant: {
      name: "Assistente de Agente",
      description:
        "Construa um Agente inteligente que pode escolher autonomamente ferramentas para concluir as tarefas",
    },
  },
  agent: {
    ...
    setting: {
      ...
      description:
        "As configurações do Assistente de Agente permitem definir o modo do agente e recursos avançados como prompts incorporados, disponíveis apenas no tipo de Agente.",
      maximumIterations: {
        name: "Número Máximo de Iterações",
        description:
          "Limite o número de iterações que um assistente de agente pode executar",
      },
    },
    ...
    tools: {
      name: "Ferramentas",
      description:
        "O uso de ferramentas pode ampliar as capacidades do LLM, como pesquisar na internet ou realizar cálculos científicos",
      enabled: "Habilitado",
    },
  },
};
