const translation = {
  ...
  setAdminAccountDesc:
    "Privilégios máximos para a conta de administrador, que pode ser usada para criar aplicativos e gerenciar provedores LLM, etc.",
  createAndSignIn: "Criar e entrar",
  oneMoreStep: "Mais um passo",
  createSample:
    "Com base nessas informações, criaremos um aplicativo de exemplo para você",
  ...
  go: "Ir para o Dify",
  sendUsMail:
    "Envie-nos um e-mail com sua introdução e cuidaremos do pedido de convite.",
  ...
  rightDesc:
    "Crie aplicativos de IA visualmente cativantes, operáveis e aprimoráveis sem esforço.",
  tos: "Termos de Serviço",
  pp: "Política de Privacidade",
  tosDesc: "Ao se inscrever, você concorda com nossos",
  goToInit:
    "Se você não inicializou a conta, vá para a página de inicialização",
  dontHave: "Não tem?",
  ...
  forgotPasswordDesc:
    "Por favor, insira seu endereço de e-mail para redefinir sua senha. Enviaremos um e-mail com instruções sobre como redefinir sua senha.",
  checkEmailForResetLink:
    "Verifique seu e-mail para um link para redefinir sua senha. Se não aparecer dentro de alguns minutos, verifique sua pasta de spam.",
  ...
  error: {
    ...
    passwordInvalid:
      "A senha deve conter letras e números e ter um comprimento maior que 8",
    passwordLengthInValid: "A senha deve ter pelo menos 8 caracteres",
    registrationNotAllowed:
      "Conta não encontrada. Entre em contato com o administrador do sistema para se registrar.",
  },
  license: {
  ...
  noLoginMethodTip:
    "Entre em contato com o administrador do sistema para adicionar um método de autenticação.",
  ...
  resetPasswordDesc:
    "Digite o e-mail que você usou para se inscrever no IDX e enviaremos um e-mail de redefinição de senha.",
  sendVerificationCode: "Enviar código de verificação",
  usePassword: "Usar senha",
  licenseInactiveTip:
    "A licença do IDX Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Dify.",
  licenseLostTip:
    "Falha ao conectar o servidor de licenças Dify. Entre em contato com o administrador para continuar usando o Dify.",
  licenseExpired: "Licença expirada",
  licenseLost: "Licença perdida",
  licenseInactive: "Licença inativa",
  licenseExpiredTip:
    "A licença do IDX Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Dify.",
};
