const translation = {
  ...
  createDatasetIntro:
    "Importe seus próprios dados de texto ou escreva dados em tempo real via Webhook para aprimoramento de contexto LLM.",
  ...
  datasetUsedByApp:
    "O conhecimento está sendo usado por alguns aplicativos. Os aplicativos não poderão mais usar esse Conhecimento, e todas as configurações de prompt e logs serão excluídos permanentemente.",
  datasetDeleted: "Conhecimento excluído",
  datasetDeleteFailed: "Falha ao excluir o Conhecimento",
  didYouKnow: "Você sabia?",
  intro1: "O Conhecimento pode ser integrado ao aplicativo IDX ",
  ...
  unavailableTip:
    "O modelo de incorporação não está disponível, o modelo de incorporação padrão precisa ser configurado",
  ...
  retrieval: {
    semantic_search: {
      ...
      description:
        "Gere incorporações de consulta e pesquise o trecho de texto mais semelhante à sua representação vetorial.",
    },
    full_text_search: {
      title: "Pesquisa de Texto Completo",
      description:
        "Indexe todos os termos no documento, permitindo que os usuários pesquisem qualquer termo e recuperem trechos de texto relevantes contendo esses termos.",
    },
    hybrid_search: {
      title: "Pesquisa Híbrida",
      description:
        "Execute pesquisas de texto completo e pesquisas vetoriais simultaneamente, reclassifique para selecionar a melhor correspondência para a consulta do usuário. A configuração da API do modelo de reclassificação é necessária.",
      recommend: "Recomendar",
    },
    invertedIndex: {
      title: "Índice Invertido",
      description:
        "O Índice Invertido é uma estrutura usada para recuperação eficiente. Organizado por termos, cada termo aponta para documentos ou páginas da web que o contêm.",
    },
    change: "Alterar",
  ...
  mixtureHighQualityAndEconomicTip:
    "O modelo de reclassificação é necessário para a mistura de bases de conhecimento de alta qualidade e econômicas.",
  inconsistentEmbeddingModelTip:
    "O modelo de reclassificação é necessário se os modelos de incorporação das bases de conhecimento selecionadas forem inconsistentes.",
  retrievalSettings: "Configurações de Recuperação",
  rerankSettings: "Configurações de Reclassificação",
  weightedScore: {
    title: "Pontuação Ponderada",
    description:
      "Ao ajustar os pesos atribuídos, esta estratégia de reclassificação determina se deve priorizar a correspondência semântica ou por palavras-chave.",
  ...
  nTo1RetrievalLegacy:
    "A recuperação N-para-1 será oficialmente descontinuada a partir de setembro. Recomenda-se usar a recuperação de múltiplos caminhos mais recente para obter melhores resultados.",
  nTo1RetrievalLegacyLink: "Saiba mais",
  nTo1RetrievalLegacyLinkText:
    "A recuperação N-para-1 será oficialmente descontinuada em setembro.",
  intro6: "como um plug-in de índice ChatGPT autônomo para publicar",
  defaultRetrievalTip:
    "A recuperação de vários caminhos é usada por padrão. O conhecimento é recuperado de várias bases de dados de conhecimento e, em seguida, reclassificado.",
  ...
  connectDatasetIntro: {
    content: {
      front:
        "Para se conectar a uma base de dados de conhecimento externa, você precisa primeiro criar uma API externa. Por favor, leia com atenção e consulte",
  ...
  connectHelper: {
    ...
    helper1:
      "Conecte-se a bases de conhecimento externas por meio da API e do ID da base de conhecimento. Atualmente,",
  },
  ...
  noExternalKnowledge:
    "Ainda não existe uma API de conhecimento externo, clique aqui para criar",
  externalAPIPanelDescription:
    "A API de conhecimento externo é usada para se conectar a uma base de conhecimento fora do IDX e recuperar o conhecimento dessa base de conhecimento.",
  externalKnowledgeIdPlaceholder: "Insira o ID de conhecimento",
  externalKnowledgeDescriptionPlaceholder:
    "Descreva o que há nesta Base de Dados de Conhecimento (opcional)",
  ...
  mixtureInternalAndExternalTip:
    "O modelo de Reclassificação é necessário para a mistura de conhecimento interno e externo.",
  learnHowToWriteGoodKnowledgeDescription:
    "Aprenda a escrever uma boa descrição de conhecimento",
  externalAPIPanelDocumentation:
    "Saiba como criar uma API de conhecimento externo",
  ...
  documentsDisabled:
    "{{num}} documentos desativados - inativos por mais de 30 dias",
  enable: "Habilitar",
  preprocessDocument: "{{num}} Documentos de pré-processamento",
  localDocs: "Documentos locais",
  allKnowledgeDescription:
    "Selecione para exibir todo o conhecimento neste espaço de trabalho. Somente o proprietário do espaço de trabalho pode gerenciar todo o conhecimento.",
